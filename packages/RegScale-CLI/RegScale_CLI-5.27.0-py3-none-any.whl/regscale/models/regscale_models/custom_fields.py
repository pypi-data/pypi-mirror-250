...
class CustomFields(RegScaleModel):
    ...
    @classmethod
    def get_list_by_module_id(cls, module_id: int) -> List["CustomFields"]:
        """
        ...
        if response and response.ok:
            for custom_field in response.json():
                custom_fields.append(CustomFields(**custom_field))
        return custom_fields

    @classmethod
    def get_custom_fields_by_module_id(cls, parent_module_id: int):
        custom_fields = CustomFields.get_list_by_module_id(
...
class CustomFieldsData(RegScaleModel):
    ...
    field: Optional[CustomFields] = None
    ...
    def get_list_by_parent_id_and_module_id(
        ...
        :param int module_id: The ID of the module
        :return List[CustomFieldsData]: A list of custom field datas
        """
        response = cls._model_api_handler.get(
            endpoint=cls.get_endpoint("get_custom_fields_data_get").format(
                model_slug=cls._model_slug, parentID=parent_id, moduleID=module_id
...
class CustomFieldsSelectItems(RegScaleModel):
