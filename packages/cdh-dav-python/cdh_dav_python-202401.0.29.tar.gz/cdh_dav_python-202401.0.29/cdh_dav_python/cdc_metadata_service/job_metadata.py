...
import cdh_dav_python.databricks_service.repo_core as davt_repo_core
...
class JobMetaData:
                ...
                for row in data_collect:
                    ...
                    if execute_flag is None:
                        ...
                        if pipeline_type == "databricks_sql":
                            ...
                            cdh_databricks_cluster = config.get(
    ...
    @classmethod
    def run_job_name(
        cls, obj_env, spark, job_name, config, dbutils, config_jobs_path=None
    ) -> str:
        """
