...
class LoggerSingleton:
    ...
    def instance(calling_namespace_name: str, calling_service_name: str):
        ...
        if LoggerSingleton._instance is None:
            LoggerSingleton(calling_namespace_name, calling_service_name)
    ...
    def error_with_exception(self, message, exc_info):
        ...
        try:
            ...
            print(
                f"Unable to log: An error occurred while handling an exception: {str(e)}"
            )
        ...
        try:
            ...
            with open(LOG_FILENAME, "r") as file:
                ...
                if lines is not None:
                    ...
                    lines.sort(
                        key=lambda entry: self.get_datetime(entry),
                        reverse=True,
                    )
