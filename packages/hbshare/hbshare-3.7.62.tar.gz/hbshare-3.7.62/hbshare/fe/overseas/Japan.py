...
overseas_index_daily_k = HBDB().get_overseas_index_daily_k_given_indexs(['TPX Index', 'NKY Index', 'MXJP Index'])
overseas_index_daily_k = overseas_index_daily_k[['bzzsdm', 'jyrq', 'px_last', 'cur_mkt_cap', 'indx_traded_val']]
overseas_index_best = HBDB().get_overseas_index_best_given_indexs(['TPX Index', 'NKY Index', 'MXJP Index'])
