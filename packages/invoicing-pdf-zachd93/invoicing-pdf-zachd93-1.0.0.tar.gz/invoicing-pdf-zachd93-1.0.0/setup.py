...
setup(
  name = 'invoicing-pdf-zachd93',         #* Your package will have this name
  ...
  author = 'Zach DeBolt',                   # Your name
  author_email = 'zachdebolt1993@gmail.com',  # Your email
  url = 'https://github.com/zachd93',              # Homepage of your library (e.g. github or your website)
