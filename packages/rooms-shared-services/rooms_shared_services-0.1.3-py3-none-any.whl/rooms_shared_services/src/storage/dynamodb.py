...
class DynamodbStorageClient(AbstractStorageClient):
    def __init__(self, tablename: str, region_name: str = "us-east-1", endpoint_url: str | None = None):
        ...
        self.table: Table = boto3.resource("dynamodb", **resource_params).Table(tablename)
    ...
    def create(self, table_item: dict, **call_params) -> dict:
        return self.table.put_item(Item=table_item, **call_params)
    ...
    def update(self, key: dict, attribute_updates: dict, **call_params) -> dict:
        ...
        return self.table.update_item(
            Key=key, UpdateExpression=update_expression, ExpressionAttributeValues=expression_attribute_values, **call_params,
        )

    def delete(self, key: {}, **call_params) -> dict:
        return self.table.delete_item(Key=key, **call_params)
