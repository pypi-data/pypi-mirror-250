import pprint,time, platform, os, pathlib
...
AVX512_EXE = (TOOLS_DIR/'cpu-avx512.exe').resolve() 

avx512 = False # whether support avx512
if platform.system() == 'Windows':
    ret = os.system(str(AVX512_EXE))
    if ret == 8: # exit code is 8 if cpu support avx512
        avx512 = True
...
class OCR_Paddle(OCR):
    ...
    def __init__(self, model_version=4 if avx512 else 2, **kargs):
        from paddleocr import PaddleOCR

        model_version = f'PP-OCRv{model_version}'
        ...
        # 使用 v2 还是 v4， 有一个大坑 ，
        # 参考 https://github.com/PaddlePaddle/PaddleOCR/issues/10346#issuecomment-1887063370
        ...
        # PaddleOCR 存在一个奇怪的bug，至少PP-OCRv4 是这样
    ...
    def setOcrEngine(self, name:str='fast'):
        ...
        if name == 'fast':
            ...
            self.ocrEngine =  self.ocrEngine_fast # now only use 'fast'
        else:
            return 
