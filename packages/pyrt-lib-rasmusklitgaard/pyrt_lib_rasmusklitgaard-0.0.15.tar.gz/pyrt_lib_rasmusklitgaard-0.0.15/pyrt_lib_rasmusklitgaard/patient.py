...
class Patient():
	...
	def dvh_above_let_value(self, let_value, organ, pydicom_rtdose="this", relative_volume=True, dose_is_let = False):
		import time
		t00 = time.time()
	...
	def set_structure_indices(self): # sets rectum and bladder structures
		...
		PTV  = self.get_indices_in_structure(self.actual_structure_names["PTV"])
		...
		indices[self.actual_structure_names["PTV"]] = PTV
