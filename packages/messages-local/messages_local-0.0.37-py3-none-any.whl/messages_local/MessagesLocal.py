...
from message_local.ChannelProviderConstants import (
    AWS_EMAIL, AWS_SMS_MESSAGE_PROVIDER_ID, INFORU_MESSAGE_PROVIDER_ID,
    VONAGE_MESSAGE_PROVIDER_ID)
    ...
    def send_sync(self, message_id: int, campaign_id: int,
        ...
        for recipient in to_recipients:
            ...
            if (message_recipient_channel == MessageChannel.SMS and
                ...
                init_kwargs = {"subject": message_local.get_subject_after_html_template()}
            ...
            message_local.send(body=body, to_recipients=[recipient], **send_kwargs)  # noqa, calling the son's send
