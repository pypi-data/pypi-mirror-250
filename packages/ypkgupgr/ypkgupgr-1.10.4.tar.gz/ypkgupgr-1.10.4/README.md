...
## What's Changed
* Pip project dependencies now install properly by @yesseruser in https://github.com/Yesser-Studios/ypkgupgr/pull/26


**Full Changelog**: https://github.com/Yesser-Studios/ypkgupgr/compare/1.10.3...1.10.4
