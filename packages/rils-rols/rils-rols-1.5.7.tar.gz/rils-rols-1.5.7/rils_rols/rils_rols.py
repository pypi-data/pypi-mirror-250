...
class RILSROLSBase(BaseEstimator):
    ...
    def __init__(self, classification=None, max_fit_calls=100000, max_seconds=100, complexity_penalty=0.001, max_complexity=50, sample_size=0.1, verbose=False, random_state=0):
