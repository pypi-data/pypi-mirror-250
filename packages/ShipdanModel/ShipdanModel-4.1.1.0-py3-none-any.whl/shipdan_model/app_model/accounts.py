...
class CurrentAddress(models.Model):
    ...
    emdNm = models.CharField(max_length=20, verbose_name='읍면동명')
    emdNo = models.CharField(max_length=20, verbose_name='읍면동일련번호')
    liNm = models.CharField(max_length=20, default='', verbose_name='법정리명', blank=True, null=True)
    roadAddr = models.CharField(max_length=50, verbose_name='전체 도로명주소')
    roadAddrPart1 = models.CharField(max_length=50, verbose_name='도로명주소(참고항목 제외)')
    ...
    jibunAddr = models.CharField(max_length=50, verbose_name='지번 정보')
