...
class CurrentAddress(models.Model):
    ''' 유저의 현재 위치를 기반으로 한 주소 '''

    user = models.OneToOneField(User, on_delete=models.CASCADE, related_name='current_address')

    zipNo = models.CharField(max_length=10, verbose_name='우편번호')
    siNm = models.CharField(max_length=10, verbose_name='시도명')
    sggNm = models.CharField(max_length=10, verbose_name='시군구명', blank=True, default='')
    emdNm = models.CharField(max_length=20, default='', verbose_name='읍면동명', blank=True)
    emdNo = models.CharField(max_length=20, default='', verbose_name='읍면동일련번호', blank=True)
    liNm = models.CharField(max_length=20, default='', verbose_name='법정리명', blank=True, null=True)
    roadAddr = models.CharField(max_length=50, default='', verbose_name='전체 도로명주소', blank=True, )
    roadAddrPart1 = models.CharField(max_length=50, default='', verbose_name='도로명주소(참고항목 제외)', blank=True)
    roadAddrPart2 = models.CharField(max_length=50, default='', verbose_name='도로명주소 참고항목', blank=True)
    bdNm = models.CharField(max_length=50, default='', verbose_name='건물명', blank=True)
    jibunAddress = models.CharField(max_length=50, default='', verbose_name='지번 정보')
