def main():
    ...
    # python3 /data/project/Alzheimer/YSscript/cle/TOOL/CLEMENT/CLEMENT/CLEMENT.py	--INPUT_TSV "/data/project/Alzheimer/YSscript/cle/TOOL/CLEMENT/example/1.SimData/SimData_1D/n500_125x/lump/0.0/clone_4/1/1.txt"  --CLEMENT_DIR "/data/project/Alzheimer/YSscript/cle/TOOL/CLEMENT/example/1.SimData/SimData_1D/n500_125x/lump/0.0/clone_4/1"   --NUM_CLONE_TRIAL_START 1 --NUM_CLONE_TRIAL_END 5 
    # python3 /data/project/Alzheimer/YSscript/cle/TOOL/CLEMENT/CLEMENT/CLEMENT.py	--INPUT_TSV "/data/project/Alzheimer/YSscript/cle/TOOL/CLEMENT/example/2.CellData/MRS_2D/M1-8_M2-4/M1-8_M2-4_input.txt"  --CLEMENT_DIR "/data/project/Alzheimer/YSscript/cle/TOOL/CLEMENT/example/2.CellData/MRS_2D/M1-8_M2-4"   --NUM_CLONE_TRIAL_START 3 		--NUM_CLONE_TRIAL_END 6  --RANDOM_PICK 500 --SCORING True --NUM_PARENT  1
