...
Refer to the Terraform Registry for docs: [`aws_opensearch_vpc_endpoint`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/opensearch_vpc_endpoint).
'''
import abc
import builtins
import datetime
