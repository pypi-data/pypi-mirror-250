...
Refer to the Terraform Registry for docs: [`aws_lb_cookie_stickiness_policy`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/lb_cookie_stickiness_policy).
'''
import abc
import builtins
import datetime
