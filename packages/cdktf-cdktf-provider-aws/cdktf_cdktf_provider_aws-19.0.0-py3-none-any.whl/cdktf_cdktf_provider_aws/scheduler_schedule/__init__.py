...
Refer to the Terraform Registry for docs: [`aws_scheduler_schedule`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/scheduler_schedule).
'''
import abc
import builtins
import datetime
