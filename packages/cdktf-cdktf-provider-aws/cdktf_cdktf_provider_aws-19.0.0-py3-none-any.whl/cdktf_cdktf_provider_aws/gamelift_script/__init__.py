...
Refer to the Terraform Registry for docs: [`aws_gamelift_script`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/gamelift_script).
'''
import abc
import builtins
import datetime
