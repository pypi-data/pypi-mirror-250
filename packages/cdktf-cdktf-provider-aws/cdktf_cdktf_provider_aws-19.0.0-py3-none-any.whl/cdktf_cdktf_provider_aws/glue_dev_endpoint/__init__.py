...
Refer to the Terraform Registry for docs: [`aws_glue_dev_endpoint`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/glue_dev_endpoint).
'''
import abc
import builtins
import datetime
