...
Refer to the Terraform Registry for docs: [`data_aws_appmesh_gateway_route`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/appmesh_gateway_route).
'''
import abc
import builtins
import datetime
