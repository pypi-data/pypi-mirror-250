...
Refer to the Terraform Registry for docs: [`data_aws_quicksight_user`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/quicksight_user).
'''
import abc
import builtins
import datetime
