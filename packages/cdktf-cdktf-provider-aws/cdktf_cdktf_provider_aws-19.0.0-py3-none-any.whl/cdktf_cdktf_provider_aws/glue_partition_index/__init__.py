...
Refer to the Terraform Registry for docs: [`aws_glue_partition_index`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/glue_partition_index).
'''
import abc
import builtins
import datetime
