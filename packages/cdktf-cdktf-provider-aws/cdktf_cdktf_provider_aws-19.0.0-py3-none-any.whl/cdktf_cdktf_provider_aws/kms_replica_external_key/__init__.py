...
Refer to the Terraform Registry for docs: [`aws_kms_replica_external_key`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/kms_replica_external_key).
'''
import abc
import builtins
import datetime
