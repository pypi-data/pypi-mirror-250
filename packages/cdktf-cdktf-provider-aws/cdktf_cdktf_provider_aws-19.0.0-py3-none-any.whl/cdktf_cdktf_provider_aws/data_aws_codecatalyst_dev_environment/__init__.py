...
Refer to the Terraform Registry for docs: [`data_aws_codecatalyst_dev_environment`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/codecatalyst_dev_environment).
'''
import abc
import builtins
import datetime
