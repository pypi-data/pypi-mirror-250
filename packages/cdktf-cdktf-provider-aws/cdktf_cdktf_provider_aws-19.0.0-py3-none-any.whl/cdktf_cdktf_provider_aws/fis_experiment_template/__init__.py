...
Refer to the Terraform Registry for docs: [`aws_fis_experiment_template`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/fis_experiment_template).
'''
import abc
import builtins
import datetime
