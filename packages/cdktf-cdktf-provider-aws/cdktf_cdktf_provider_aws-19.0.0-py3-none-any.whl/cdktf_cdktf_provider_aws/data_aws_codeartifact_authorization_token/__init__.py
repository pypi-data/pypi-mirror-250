...
Refer to the Terraform Registry for docs: [`data_aws_codeartifact_authorization_token`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/codeartifact_authorization_token).
'''
import abc
import builtins
import datetime
