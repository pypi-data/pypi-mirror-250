...
Refer to the Terraform Registry for docs: [`data_aws_imagebuilder_image_pipeline`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/imagebuilder_image_pipeline).
'''
import abc
import builtins
import datetime
