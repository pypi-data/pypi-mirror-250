...
Refer to the Terraform Registry for docs: [`data_aws_mq_broker_instance_type_offerings`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/mq_broker_instance_type_offerings).
'''
import abc
import builtins
import datetime
