...
Refer to the Terraform Registry for docs: [`aws_glue_ml_transform`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/glue_ml_transform).
'''
import abc
import builtins
import datetime
