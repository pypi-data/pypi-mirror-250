...
Refer to the Terraform Registry for docs: [`aws_devicefarm_device_pool`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/devicefarm_device_pool).
'''
import abc
import builtins
import datetime
