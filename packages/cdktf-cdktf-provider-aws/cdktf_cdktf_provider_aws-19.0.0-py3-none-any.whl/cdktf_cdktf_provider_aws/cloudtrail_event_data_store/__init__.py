...
Refer to the Terraform Registry for docs: [`aws_cloudtrail_event_data_store`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/cloudtrail_event_data_store).
'''
import abc
import builtins
import datetime
