...
Refer to the Terraform Registry for docs: [`data_aws_dx_router_configuration`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/dx_router_configuration).
'''
import abc
import builtins
import datetime
