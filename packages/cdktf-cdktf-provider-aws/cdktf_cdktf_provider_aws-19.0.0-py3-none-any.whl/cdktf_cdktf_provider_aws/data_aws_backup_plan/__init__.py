...
Refer to the Terraform Registry for docs: [`data_aws_backup_plan`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/backup_plan).
'''
import abc
import builtins
import datetime
