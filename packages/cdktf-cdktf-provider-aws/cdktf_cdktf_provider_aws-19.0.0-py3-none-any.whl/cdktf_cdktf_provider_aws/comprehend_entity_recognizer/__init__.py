...
Refer to the Terraform Registry for docs: [`aws_comprehend_entity_recognizer`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/comprehend_entity_recognizer).
'''
import abc
import builtins
import datetime
