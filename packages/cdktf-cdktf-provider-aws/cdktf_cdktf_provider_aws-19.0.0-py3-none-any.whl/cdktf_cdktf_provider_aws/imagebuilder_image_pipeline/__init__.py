...
Refer to the Terraform Registry for docs: [`aws_imagebuilder_image_pipeline`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/imagebuilder_image_pipeline).
'''
import abc
import builtins
import datetime
