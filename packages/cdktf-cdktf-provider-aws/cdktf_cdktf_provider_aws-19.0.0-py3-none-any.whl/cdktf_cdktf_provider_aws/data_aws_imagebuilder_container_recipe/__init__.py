...
Refer to the Terraform Registry for docs: [`data_aws_imagebuilder_container_recipe`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/imagebuilder_container_recipe).
'''
import abc
import builtins
import datetime
