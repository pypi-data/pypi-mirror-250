...
Refer to the Terraform Registry for docs: [`aws_networkmanager_device`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/networkmanager_device).
'''
import abc
import builtins
import datetime
