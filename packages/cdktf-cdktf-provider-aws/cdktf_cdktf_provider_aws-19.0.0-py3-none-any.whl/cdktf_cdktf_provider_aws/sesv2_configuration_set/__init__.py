...
Refer to the Terraform Registry for docs: [`aws_sesv2_configuration_set`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/sesv2_configuration_set).
'''
import abc
import builtins
import datetime
