...
Refer to the Terraform Registry for docs: [`data_aws_workspaces_directory`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/workspaces_directory).
'''
import abc
import builtins
import datetime
