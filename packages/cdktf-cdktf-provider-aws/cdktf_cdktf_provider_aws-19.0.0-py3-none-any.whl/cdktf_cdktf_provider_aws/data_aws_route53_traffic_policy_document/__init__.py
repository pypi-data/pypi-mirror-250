...
Refer to the Terraform Registry for docs: [`data_aws_route53_traffic_policy_document`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/route53_traffic_policy_document).
'''
import abc
import builtins
import datetime
