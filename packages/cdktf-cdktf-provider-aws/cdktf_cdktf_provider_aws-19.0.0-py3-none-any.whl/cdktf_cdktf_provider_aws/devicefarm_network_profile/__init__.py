...
Refer to the Terraform Registry for docs: [`aws_devicefarm_network_profile`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/devicefarm_network_profile).
'''
import abc
import builtins
import datetime
