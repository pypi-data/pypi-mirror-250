...
Refer to the Terraform Registry for docs: [`data_aws_ssmincidents_response_plan`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/ssmincidents_response_plan).
'''
import abc
import builtins
import datetime
