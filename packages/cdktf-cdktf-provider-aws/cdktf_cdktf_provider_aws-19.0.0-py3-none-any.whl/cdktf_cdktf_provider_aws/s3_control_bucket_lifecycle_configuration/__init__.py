...
Refer to the Terraform Registry for docs: [`aws_s3control_bucket_lifecycle_configuration`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/s3control_bucket_lifecycle_configuration).
'''
import abc
import builtins
import datetime
