...
Refer to the Terraform Registry for docs: [`data_aws_neptune_engine_version`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/neptune_engine_version).
'''
import abc
import builtins
import datetime
