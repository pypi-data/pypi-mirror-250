...
Refer to the Terraform Registry for docs: [`aws_config_conformance_pack`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/config_conformance_pack).
'''
import abc
import builtins
import datetime
