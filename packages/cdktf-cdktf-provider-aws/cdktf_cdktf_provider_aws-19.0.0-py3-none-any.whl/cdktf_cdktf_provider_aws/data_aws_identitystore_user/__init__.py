...
Refer to the Terraform Registry for docs: [`data_aws_identitystore_user`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/identitystore_user).
'''
import abc
import builtins
import datetime
