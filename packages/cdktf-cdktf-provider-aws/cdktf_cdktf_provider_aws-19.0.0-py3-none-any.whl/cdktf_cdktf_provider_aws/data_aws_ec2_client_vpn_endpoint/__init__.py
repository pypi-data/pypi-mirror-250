...
Refer to the Terraform Registry for docs: [`data_aws_ec2_client_vpn_endpoint`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/ec2_client_vpn_endpoint).
'''
import abc
import builtins
import datetime
