...
Refer to the Terraform Registry for docs: [`aws_ssoadmin_permission_set`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/ssoadmin_permission_set).
'''
import abc
import builtins
import datetime
