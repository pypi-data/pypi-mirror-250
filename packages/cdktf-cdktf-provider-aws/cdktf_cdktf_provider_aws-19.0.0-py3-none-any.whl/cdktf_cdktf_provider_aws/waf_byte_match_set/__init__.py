...
Refer to the Terraform Registry for docs: [`aws_waf_byte_match_set`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/waf_byte_match_set).
'''
import abc
import builtins
import datetime
