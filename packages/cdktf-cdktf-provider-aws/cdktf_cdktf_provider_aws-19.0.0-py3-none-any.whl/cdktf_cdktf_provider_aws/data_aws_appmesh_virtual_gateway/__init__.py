...
Refer to the Terraform Registry for docs: [`data_aws_appmesh_virtual_gateway`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/appmesh_virtual_gateway).
'''
import abc
import builtins
import datetime
