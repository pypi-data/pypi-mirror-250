...
Refer to the Terraform Registry for docs: [`aws_eip_association`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/eip_association).
'''
import abc
import builtins
import datetime
