...
Refer to the Terraform Registry for docs: [`aws_emr_instance_fleet`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/emr_instance_fleet).
'''
import abc
import builtins
import datetime
