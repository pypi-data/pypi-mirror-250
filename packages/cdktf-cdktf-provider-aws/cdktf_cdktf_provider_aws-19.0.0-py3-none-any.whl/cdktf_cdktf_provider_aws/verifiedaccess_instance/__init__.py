...
Refer to the Terraform Registry for docs: [`aws_verifiedaccess_instance`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/verifiedaccess_instance).
'''
import abc
import builtins
import datetime
