...
Refer to the Terraform Registry for docs: [`aws_ec2_transit_gateway_multicast_domain`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/ec2_transit_gateway_multicast_domain).
'''
import abc
import builtins
import datetime
