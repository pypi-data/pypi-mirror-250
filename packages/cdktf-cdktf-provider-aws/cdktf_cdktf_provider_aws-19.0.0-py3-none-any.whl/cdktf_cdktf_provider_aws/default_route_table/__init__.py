...
Refer to the Terraform Registry for docs: [`aws_default_route_table`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/default_route_table).
'''
import abc
import builtins
import datetime
