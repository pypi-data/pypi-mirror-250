...
Refer to the Terraform Registry for docs: [`aws_cognito_user_pool`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/cognito_user_pool).
'''
import abc
import builtins
import datetime
