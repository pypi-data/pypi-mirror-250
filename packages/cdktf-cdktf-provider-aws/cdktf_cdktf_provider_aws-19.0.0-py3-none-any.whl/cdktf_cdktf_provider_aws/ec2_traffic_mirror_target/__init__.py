...
Refer to the Terraform Registry for docs: [`aws_ec2_traffic_mirror_target`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/ec2_traffic_mirror_target).
'''
import abc
import builtins
import datetime
