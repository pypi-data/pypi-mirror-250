...
Refer to the Terraform Registry for docs: [`aws_ses_identity_notification_topic`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/ses_identity_notification_topic).
'''
import abc
import builtins
import datetime
