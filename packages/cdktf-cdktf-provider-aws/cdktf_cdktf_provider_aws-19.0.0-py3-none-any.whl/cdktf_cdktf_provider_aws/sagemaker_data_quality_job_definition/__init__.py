...
Refer to the Terraform Registry for docs: [`aws_sagemaker_data_quality_job_definition`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/sagemaker_data_quality_job_definition).
'''
import abc
import builtins
import datetime
