...
Refer to the Terraform Registry for docs: [`aws_signer_signing_job`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/signer_signing_job).
'''
import abc
import builtins
import datetime
