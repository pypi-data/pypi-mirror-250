...
Refer to the Terraform Registry for docs: [`aws_elasticsearch_domain_policy`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/elasticsearch_domain_policy).
'''
import abc
import builtins
import datetime
