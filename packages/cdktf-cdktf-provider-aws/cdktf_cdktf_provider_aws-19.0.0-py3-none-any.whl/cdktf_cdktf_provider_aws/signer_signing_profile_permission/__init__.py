...
Refer to the Terraform Registry for docs: [`aws_signer_signing_profile_permission`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/signer_signing_profile_permission).
'''
import abc
import builtins
import datetime
