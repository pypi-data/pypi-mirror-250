...
Refer to the Terraform Registry for docs: [`aws_sesv2_account_vdm_attributes`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/sesv2_account_vdm_attributes).
'''
import abc
import builtins
import datetime
