...
Refer to the Terraform Registry for docs: [`aws_wafregional_rate_based_rule`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/wafregional_rate_based_rule).
'''
import abc
import builtins
import datetime
