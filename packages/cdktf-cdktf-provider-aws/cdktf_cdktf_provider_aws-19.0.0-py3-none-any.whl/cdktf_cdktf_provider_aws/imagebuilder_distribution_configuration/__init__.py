...
Refer to the Terraform Registry for docs: [`aws_imagebuilder_distribution_configuration`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/imagebuilder_distribution_configuration).
'''
import abc
import builtins
import datetime
