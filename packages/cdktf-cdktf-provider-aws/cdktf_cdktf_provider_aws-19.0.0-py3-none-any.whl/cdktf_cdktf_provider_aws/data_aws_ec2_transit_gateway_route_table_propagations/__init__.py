...
Refer to the Terraform Registry for docs: [`data_aws_ec2_transit_gateway_route_table_propagations`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/ec2_transit_gateway_route_table_propagations).
'''
import abc
import builtins
import datetime
