...
Refer to the Terraform Registry for docs: [`aws_macie2_classification_job`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/macie2_classification_job).
'''
import abc
import builtins
import datetime
