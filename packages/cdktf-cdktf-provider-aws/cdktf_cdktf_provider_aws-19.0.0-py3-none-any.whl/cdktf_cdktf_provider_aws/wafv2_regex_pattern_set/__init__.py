...
Refer to the Terraform Registry for docs: [`aws_wafv2_regex_pattern_set`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/wafv2_regex_pattern_set).
'''
import abc
import builtins
import datetime
