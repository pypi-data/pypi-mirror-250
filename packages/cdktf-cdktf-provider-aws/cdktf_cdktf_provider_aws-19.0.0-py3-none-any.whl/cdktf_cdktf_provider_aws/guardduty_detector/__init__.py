...
Refer to the Terraform Registry for docs: [`aws_guardduty_detector`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/guardduty_detector).
'''
import abc
import builtins
import datetime
