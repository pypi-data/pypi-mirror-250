...
Refer to the Terraform Registry for docs: [`aws_signer_signing_profile`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/signer_signing_profile).
'''
import abc
import builtins
import datetime
