...
Refer to the Terraform Registry for docs: [`aws_chimesdkvoice_sip_media_application`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/chimesdkvoice_sip_media_application).
'''
import abc
import builtins
import datetime
