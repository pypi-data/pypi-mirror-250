...
Refer to the Terraform Registry for docs: [`aws_resourcegroups_resource`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/resourcegroups_resource).
'''
import abc
import builtins
import datetime
