...
Refer to the Terraform Registry for docs: [`aws_vpc_network_performance_metric_subscription`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/vpc_network_performance_metric_subscription).
'''
import abc
import builtins
import datetime
