...
Refer to the Terraform Registry for docs: [`data_aws_redshiftserverless_workgroup`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/redshiftserverless_workgroup).
'''
import abc
import builtins
import datetime
