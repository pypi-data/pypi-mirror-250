...
Refer to the Terraform Registry for docs: [`aws_opensearchserverless_collection`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/opensearchserverless_collection).
'''
import abc
import builtins
import datetime
