...
Refer to the Terraform Registry for docs: [`data_aws_ram_resource_share`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/ram_resource_share).
'''
import abc
import builtins
import datetime
