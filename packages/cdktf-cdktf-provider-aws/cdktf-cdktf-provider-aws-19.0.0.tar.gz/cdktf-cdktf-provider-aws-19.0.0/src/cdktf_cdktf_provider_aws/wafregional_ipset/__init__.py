...
Refer to the Terraform Registry for docs: [`aws_wafregional_ipset`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/wafregional_ipset).
'''
import abc
import builtins
import datetime
