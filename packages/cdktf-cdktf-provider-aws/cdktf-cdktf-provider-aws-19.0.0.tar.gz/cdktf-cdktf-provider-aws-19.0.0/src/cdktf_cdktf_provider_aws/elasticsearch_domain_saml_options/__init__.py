...
Refer to the Terraform Registry for docs: [`aws_elasticsearch_domain_saml_options`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/elasticsearch_domain_saml_options).
'''
import abc
import builtins
import datetime
