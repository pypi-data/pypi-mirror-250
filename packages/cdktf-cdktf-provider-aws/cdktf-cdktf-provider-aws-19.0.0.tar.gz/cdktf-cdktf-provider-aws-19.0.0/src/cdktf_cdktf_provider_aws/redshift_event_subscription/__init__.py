...
Refer to the Terraform Registry for docs: [`aws_redshift_event_subscription`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/redshift_event_subscription).
'''
import abc
import builtins
import datetime
