...
Refer to the Terraform Registry for docs: [`data_aws_lakeformation_permissions`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/lakeformation_permissions).
'''
import abc
import builtins
import datetime
