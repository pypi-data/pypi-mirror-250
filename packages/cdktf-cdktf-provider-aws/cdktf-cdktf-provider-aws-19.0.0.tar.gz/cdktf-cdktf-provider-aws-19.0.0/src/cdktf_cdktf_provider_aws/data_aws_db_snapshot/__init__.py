...
Refer to the Terraform Registry for docs: [`data_aws_db_snapshot`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/db_snapshot).
'''
import abc
import builtins
import datetime
