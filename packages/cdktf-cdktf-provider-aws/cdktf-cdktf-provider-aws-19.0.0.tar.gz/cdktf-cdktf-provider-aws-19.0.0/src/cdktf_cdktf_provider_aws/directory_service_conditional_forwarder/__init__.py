...
Refer to the Terraform Registry for docs: [`aws_directory_service_conditional_forwarder`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/directory_service_conditional_forwarder).
'''
import abc
import builtins
import datetime
