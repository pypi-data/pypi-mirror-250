...
Refer to the Terraform Registry for docs: [`data_aws_ec2_local_gateway_route_table`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/ec2_local_gateway_route_table).
'''
import abc
import builtins
import datetime
