...
Refer to the Terraform Registry for docs: [`aws_lexv2models_bot`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/lexv2models_bot).
'''
import abc
import builtins
import datetime
