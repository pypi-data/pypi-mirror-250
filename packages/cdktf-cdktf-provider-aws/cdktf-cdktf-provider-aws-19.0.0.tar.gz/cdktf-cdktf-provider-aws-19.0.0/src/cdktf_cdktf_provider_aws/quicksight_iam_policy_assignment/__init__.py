...
Refer to the Terraform Registry for docs: [`aws_quicksight_iam_policy_assignment`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/quicksight_iam_policy_assignment).
'''
import abc
import builtins
import datetime
