...
Refer to the Terraform Registry for docs: [`aws_wafregional_web_acl`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/wafregional_web_acl).
'''
import abc
import builtins
import datetime
