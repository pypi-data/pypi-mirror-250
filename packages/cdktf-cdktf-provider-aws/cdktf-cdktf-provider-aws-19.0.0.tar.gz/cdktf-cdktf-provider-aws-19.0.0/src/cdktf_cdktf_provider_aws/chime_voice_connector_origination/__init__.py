...
Refer to the Terraform Registry for docs: [`aws_chime_voice_connector_origination`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/chime_voice_connector_origination).
'''
import abc
import builtins
import datetime
