...
Refer to the Terraform Registry for docs: [`aws_efs_mount_target`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/efs_mount_target).
'''
import abc
import builtins
import datetime
