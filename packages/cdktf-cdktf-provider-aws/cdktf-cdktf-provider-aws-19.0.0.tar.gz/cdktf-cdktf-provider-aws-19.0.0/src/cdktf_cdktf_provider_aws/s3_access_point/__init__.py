...
Refer to the Terraform Registry for docs: [`aws_s3_access_point`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/s3_access_point).
'''
import abc
import builtins
import datetime
