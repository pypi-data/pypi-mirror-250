...
Refer to the Terraform Registry for docs: [`aws_vpclattice_target_group`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/vpclattice_target_group).
'''
import abc
import builtins
import datetime
