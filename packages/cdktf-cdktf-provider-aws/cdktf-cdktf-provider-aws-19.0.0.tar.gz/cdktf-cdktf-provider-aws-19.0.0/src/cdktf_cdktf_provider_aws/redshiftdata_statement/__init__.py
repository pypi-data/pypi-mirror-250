...
Refer to the Terraform Registry for docs: [`aws_redshiftdata_statement`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/redshiftdata_statement).
'''
import abc
import builtins
import datetime
