...
Refer to the Terraform Registry for docs: [`aws_storagegateway_stored_iscsi_volume`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/storagegateway_stored_iscsi_volume).
'''
import abc
import builtins
import datetime
