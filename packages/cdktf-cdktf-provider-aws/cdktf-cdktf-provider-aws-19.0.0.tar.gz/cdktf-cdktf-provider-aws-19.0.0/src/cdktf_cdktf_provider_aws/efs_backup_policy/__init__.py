...
Refer to the Terraform Registry for docs: [`aws_efs_backup_policy`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/efs_backup_policy).
'''
import abc
import builtins
import datetime
