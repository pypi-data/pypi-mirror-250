...
Refer to the Terraform Registry for docs: [`aws_securitylake_data_lake`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/securitylake_data_lake).
'''
import abc
import builtins
import datetime
