...
Refer to the Terraform Registry for docs: [`aws_servicecatalog_service_action`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/servicecatalog_service_action).
'''
import abc
import builtins
import datetime
