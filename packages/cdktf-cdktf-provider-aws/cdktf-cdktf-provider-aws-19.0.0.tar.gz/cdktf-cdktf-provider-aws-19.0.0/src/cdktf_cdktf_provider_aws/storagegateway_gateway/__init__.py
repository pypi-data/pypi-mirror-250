...
Refer to the Terraform Registry for docs: [`aws_storagegateway_gateway`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/storagegateway_gateway).
'''
import abc
import builtins
import datetime
