...
Refer to the Terraform Registry for docs: [`aws_sesv2_dedicated_ip_pool`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/sesv2_dedicated_ip_pool).
'''
import abc
import builtins
import datetime
