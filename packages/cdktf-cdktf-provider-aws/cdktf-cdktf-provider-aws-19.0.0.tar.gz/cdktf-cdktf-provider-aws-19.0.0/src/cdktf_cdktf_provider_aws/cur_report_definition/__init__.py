...
Refer to the Terraform Registry for docs: [`aws_cur_report_definition`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/cur_report_definition).
'''
import abc
import builtins
import datetime
