...
Refer to the Terraform Registry for docs: [`data_aws_ec2_instance_type_offering`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/ec2_instance_type_offering).
'''
import abc
import builtins
import datetime
