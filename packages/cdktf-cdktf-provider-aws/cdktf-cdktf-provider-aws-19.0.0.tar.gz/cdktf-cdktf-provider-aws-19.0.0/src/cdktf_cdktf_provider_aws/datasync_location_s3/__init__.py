...
Refer to the Terraform Registry for docs: [`aws_datasync_location_s3`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/datasync_location_s3).
'''
import abc
import builtins
import datetime
