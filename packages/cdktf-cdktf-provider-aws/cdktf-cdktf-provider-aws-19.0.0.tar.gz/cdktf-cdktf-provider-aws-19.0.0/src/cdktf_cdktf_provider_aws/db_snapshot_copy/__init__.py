...
Refer to the Terraform Registry for docs: [`aws_db_snapshot_copy`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/db_snapshot_copy).
'''
import abc
import builtins
import datetime
