...
Refer to the Terraform Registry for docs: [`data_aws_outposts_outposts`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/outposts_outposts).
'''
import abc
import builtins
import datetime
