...
Refer to the Terraform Registry for docs: [`aws_ssoadmin_managed_policy_attachment`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/ssoadmin_managed_policy_attachment).
'''
import abc
import builtins
import datetime
