...
Refer to the Terraform Registry for docs: [`aws_quicksight_account_subscription`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/quicksight_account_subscription).
'''
import abc
import builtins
import datetime
