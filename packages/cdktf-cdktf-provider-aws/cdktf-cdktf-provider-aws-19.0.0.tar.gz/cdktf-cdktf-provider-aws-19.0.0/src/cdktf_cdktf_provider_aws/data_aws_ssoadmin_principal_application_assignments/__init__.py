...
Refer to the Terraform Registry for docs: [`data_aws_ssoadmin_principal_application_assignments`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/ssoadmin_principal_application_assignments).
'''
import abc
import builtins
import datetime
