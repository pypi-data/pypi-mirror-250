...
Refer to the Terraform Registry for docs: [`aws_sagemaker_notebook_instance`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/sagemaker_notebook_instance).
'''
import abc
import builtins
import datetime
