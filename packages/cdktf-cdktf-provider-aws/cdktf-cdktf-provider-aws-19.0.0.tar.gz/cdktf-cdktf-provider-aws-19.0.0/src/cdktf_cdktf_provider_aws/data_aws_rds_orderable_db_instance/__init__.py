...
Refer to the Terraform Registry for docs: [`data_aws_rds_orderable_db_instance`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/rds_orderable_db_instance).
'''
import abc
import builtins
import datetime
