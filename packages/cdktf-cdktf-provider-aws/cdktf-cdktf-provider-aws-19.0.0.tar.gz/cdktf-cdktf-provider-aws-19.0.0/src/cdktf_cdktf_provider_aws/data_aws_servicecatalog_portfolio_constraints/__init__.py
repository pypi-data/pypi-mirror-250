...
Refer to the Terraform Registry for docs: [`data_aws_servicecatalog_portfolio_constraints`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/servicecatalog_portfolio_constraints).
'''
import abc
import builtins
import datetime
