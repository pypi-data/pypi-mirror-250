...
Refer to the Terraform Registry for docs: [`aws_iot_indexing_configuration`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/iot_indexing_configuration).
'''
import abc
import builtins
import datetime
