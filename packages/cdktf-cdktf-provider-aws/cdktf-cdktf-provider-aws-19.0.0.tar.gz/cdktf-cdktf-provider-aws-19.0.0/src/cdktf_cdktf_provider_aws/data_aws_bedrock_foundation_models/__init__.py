...
Refer to the Terraform Registry for docs: [`data_aws_bedrock_foundation_models`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/bedrock_foundation_models).
'''
import abc
import builtins
import datetime
