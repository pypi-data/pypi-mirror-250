...
Refer to the Terraform Registry for docs: [`aws_lightsail_instance_public_ports`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/lightsail_instance_public_ports).
'''
import abc
import builtins
import datetime
