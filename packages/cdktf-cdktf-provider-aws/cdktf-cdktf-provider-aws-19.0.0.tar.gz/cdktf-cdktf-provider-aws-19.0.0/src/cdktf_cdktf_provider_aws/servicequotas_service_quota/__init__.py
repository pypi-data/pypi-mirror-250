...
Refer to the Terraform Registry for docs: [`aws_servicequotas_service_quota`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/servicequotas_service_quota).
'''
import abc
import builtins
import datetime
