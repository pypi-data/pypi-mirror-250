...
Refer to the Terraform Registry for docs: [`data_aws_opensearch_domain`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/opensearch_domain).
'''
import abc
import builtins
import datetime
