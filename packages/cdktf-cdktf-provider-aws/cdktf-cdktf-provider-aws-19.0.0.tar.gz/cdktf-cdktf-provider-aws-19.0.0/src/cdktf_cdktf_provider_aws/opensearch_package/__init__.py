...
Refer to the Terraform Registry for docs: [`aws_opensearch_package`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/opensearch_package).
'''
import abc
import builtins
import datetime
