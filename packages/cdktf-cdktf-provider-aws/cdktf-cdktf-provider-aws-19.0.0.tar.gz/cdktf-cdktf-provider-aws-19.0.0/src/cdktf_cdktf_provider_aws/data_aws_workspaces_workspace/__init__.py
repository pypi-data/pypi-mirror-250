...
Refer to the Terraform Registry for docs: [`data_aws_workspaces_workspace`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/workspaces_workspace).
'''
import abc
import builtins
import datetime
