...
Refer to the Terraform Registry for docs: [`aws_quicksight_folder_membership`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/quicksight_folder_membership).
'''
import abc
import builtins
import datetime
