...
Refer to the Terraform Registry for docs: [`aws_location_place_index`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/location_place_index).
'''
import abc
import builtins
import datetime
