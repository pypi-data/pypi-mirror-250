...
Refer to the Terraform Registry for docs: [`aws_finspace_kx_user`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/finspace_kx_user).
'''
import abc
import builtins
import datetime
