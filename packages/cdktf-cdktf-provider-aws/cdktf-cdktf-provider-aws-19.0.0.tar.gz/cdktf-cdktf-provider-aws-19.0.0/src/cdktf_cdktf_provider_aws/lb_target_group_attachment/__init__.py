...
Refer to the Terraform Registry for docs: [`aws_lb_target_group_attachment`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/lb_target_group_attachment).
'''
import abc
import builtins
import datetime
