...
Refer to the Terraform Registry for docs: [`aws_guardduty_invite_accepter`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/guardduty_invite_accepter).
'''
import abc
import builtins
import datetime
