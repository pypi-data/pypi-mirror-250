...
Refer to the Terraform Registry for docs: [`aws_kms_custom_key_store`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/kms_custom_key_store).
'''
import abc
import builtins
import datetime
