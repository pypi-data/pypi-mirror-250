...
Refer to the Terraform Registry for docs: [`aws_elasticache_cluster`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/elasticache_cluster).
'''
import abc
import builtins
import datetime
