...
Refer to the Terraform Registry for docs: [`aws_datasync_location_fsx_windows_file_system`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/datasync_location_fsx_windows_file_system).
'''
import abc
import builtins
import datetime
