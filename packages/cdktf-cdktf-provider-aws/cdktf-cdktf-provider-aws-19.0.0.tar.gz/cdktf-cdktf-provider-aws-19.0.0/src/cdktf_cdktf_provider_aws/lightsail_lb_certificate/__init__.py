...
Refer to the Terraform Registry for docs: [`aws_lightsail_lb_certificate`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/lightsail_lb_certificate).
'''
import abc
import builtins
import datetime
