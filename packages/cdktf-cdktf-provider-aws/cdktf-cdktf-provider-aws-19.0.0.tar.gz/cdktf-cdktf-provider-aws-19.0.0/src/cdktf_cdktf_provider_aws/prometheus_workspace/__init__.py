...
Refer to the Terraform Registry for docs: [`aws_prometheus_workspace`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/prometheus_workspace).
'''
import abc
import builtins
import datetime
