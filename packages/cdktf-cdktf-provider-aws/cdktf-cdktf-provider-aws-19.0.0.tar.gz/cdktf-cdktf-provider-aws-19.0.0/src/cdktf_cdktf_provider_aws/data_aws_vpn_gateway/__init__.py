...
Refer to the Terraform Registry for docs: [`data_aws_vpn_gateway`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/data-sources/vpn_gateway).
'''
import abc
import builtins
import datetime
