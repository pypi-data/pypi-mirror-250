...
Refer to the Terraform Registry for docs: [`aws_kendra_thesaurus`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/kendra_thesaurus).
'''
import abc
import builtins
import datetime
