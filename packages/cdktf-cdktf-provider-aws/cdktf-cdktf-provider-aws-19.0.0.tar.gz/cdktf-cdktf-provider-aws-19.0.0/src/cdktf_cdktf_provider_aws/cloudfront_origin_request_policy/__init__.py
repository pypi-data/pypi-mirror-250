...
Refer to the Terraform Registry for docs: [`aws_cloudfront_origin_request_policy`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/cloudfront_origin_request_policy).
'''
import abc
import builtins
import datetime
