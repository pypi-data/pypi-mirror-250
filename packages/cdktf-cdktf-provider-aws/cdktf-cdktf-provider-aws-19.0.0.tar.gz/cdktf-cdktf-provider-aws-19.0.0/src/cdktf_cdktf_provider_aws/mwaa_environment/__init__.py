...
Refer to the Terraform Registry for docs: [`aws_mwaa_environment`](https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/mwaa_environment).
'''
import abc
import builtins
import datetime
