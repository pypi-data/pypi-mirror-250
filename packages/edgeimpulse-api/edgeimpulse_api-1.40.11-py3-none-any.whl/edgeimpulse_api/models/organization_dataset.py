...
class OrganizationDataset(BaseModel):
    ...
    type: StrictStr = ...
    __properties = ["dataset", "lastFileCreated", "totalFileSize", "totalFileCount", "totalItemCount", "totalItemCountChecklistOK", "totalItemCountChecklistFailed", "tags", "category", "bucket", "type"]
