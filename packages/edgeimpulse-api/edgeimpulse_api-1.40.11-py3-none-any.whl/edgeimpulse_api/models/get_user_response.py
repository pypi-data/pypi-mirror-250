...
class GetUserResponse(BaseModel):
    ...
    __properties = ["success", "error", "id", "username", "name", "email", "photo", "created", "lastSeen", "staffInfo", "pending", "lastTosAcceptanceDate", "jobTitle", "permissions", "companyName", "activated", "organizations", "projects", "experiments", "evaluation", "ambassador", "tier", "whitelabels", "suspended", "notifications"]
