...
class DSPGroupItem(BaseModel):
    ...
    __properties = ["name", "value", "defaultValue", "type", "help", "param", "selectOptions", "readonly", "shouldShow", "showIf", "invalidText", "section"]
    ...
    def section_validate_enum(cls, v):
        ...
        if v not in ('advanced'):
            raise ValueError("must validate the enum values ('advanced')")
        return v
