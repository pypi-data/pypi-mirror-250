...
class OrganizationGetCreateProjectsResponseAllOfJobs(BaseModel):
    ...
    transformation_operates_on: Optional[StrictStr] = Field(None, alias="transformationOperatesOn")
    created: datetime = ...
    ...
    @validator('transformation_operates_on')
    def transformation_operates_on_validate_enum(cls, v):
        if v is None:
            return v
