...
class ListPortalFilesInFolderRequest(BaseModel):
    ...
    only_fetch_folders: Optional[StrictBool] = Field(None, alias="onlyFetchFolders", description="If set, then only fetch folders - no files")
    ...
    __properties = ["prefix", "onlyFetchFolders", "continuationToken"]
