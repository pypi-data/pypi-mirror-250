...
class OrganizationDspBlock(BaseModel):
    ...
    __properties = ["id", "name", "dockerContainer", "dockerContainerManagedByEdgeImpulse", "created", "createdByUser", "lastUpdated", "lastUpdatedByUser", "userId", "userName", "description", "requestsCpu", "requestsMemory", "limitsCpu", "limitsMemory", "port", "isConnected", "error"]
