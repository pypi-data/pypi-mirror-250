...
class AdminApiUser(BaseModel):
    ...
    __properties = ["id", "username", "name", "email", "photo", "created", "lastSeen", "staffInfo", "pending", "lastTosAcceptanceDate", "jobTitle", "permissions", "companyName", "activated", "organizations", "projects", "experiments", "evaluation", "ambassador", "tier", "suspended", "trials"]
