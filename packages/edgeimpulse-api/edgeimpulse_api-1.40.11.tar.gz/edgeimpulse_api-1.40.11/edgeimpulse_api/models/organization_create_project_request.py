...
class OrganizationCreateProjectRequest(BaseModel):
    ...
    __properties = ["name", "filter", "uploadType", "projectId", "projectVisibility", "newProjectName", "projectApiKey", "projectHmacKey", "transformationBlockId", "builtinTransformationBlock", "category", "outputDatasetName", "outputDatasetBucketId", "outputDatasetBucketPath", "label", "emailRecipientUids", "transformationParallel", "extraCliArguments", "parameters"]
