...
class KerasResponse(BaseModel):
    ...
    use_velo: Optional[StrictBool] = Field(None, alias="useVelo", description="Use VeLO to select optimizer and find learning rate automatically.")
    ...
    __properties = ["success", "error", "dependencies", "trained", "name", "type", "script", "minimumConfidenceRating", "selectedModelType", "mode", "visualLayers", "trainingCycles", "learningRate", "batchSize", "defaultBatchSize", "shape", "trainTestSplit", "autoClassWeights", "findLearningRate", "useVelo", "augmentationPolicyImage", "augmentationPolicySpectrogram", "transferLearningModels", "profileInt8", "skipEmbeddingsAndMemory", "akidaEdgeLearningConfig", "customValidationMetadataKey", "showAdvancedTrainingSettings", "customParameters", "anomalyCapacity", "lastShownModelVariant"]
