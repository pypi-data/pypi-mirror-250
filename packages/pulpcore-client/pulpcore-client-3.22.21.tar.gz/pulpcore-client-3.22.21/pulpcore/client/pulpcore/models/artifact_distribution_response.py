...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, base_url=None, pulp_href=None, pulp_labels=None, pulp_created=None, content_guard=None, name=None, local_vars_configuration=None):  # noqa: E501
