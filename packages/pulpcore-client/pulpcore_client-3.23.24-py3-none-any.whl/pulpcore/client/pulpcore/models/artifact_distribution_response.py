...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, base_path=None, base_url=None, pulp_created=None, pulp_labels=None, content_guard=None, name=None, local_vars_configuration=None):  # noqa: E501
