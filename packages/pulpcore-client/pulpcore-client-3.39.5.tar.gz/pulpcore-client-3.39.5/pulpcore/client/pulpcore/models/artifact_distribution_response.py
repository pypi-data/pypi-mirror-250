...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, name=None, hidden=False, pulp_created=None, base_path=None, pulp_href=None, pulp_labels=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
