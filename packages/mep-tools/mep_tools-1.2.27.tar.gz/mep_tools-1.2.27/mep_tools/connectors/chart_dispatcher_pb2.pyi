...
class ChartDispatcherCreateRequest(_message.Message):
    __slots__ = ["chart_uuid", "configuration"]
    CHART_UUID_FIELD_NUMBER: _ClassVar[int]
    CONFIGURATION_FIELD_NUMBER: _ClassVar[int]
    chart_uuid: str
    configuration: _any_pb2.Any
    def __init__(self, chart_uuid: _Optional[str] = ..., configuration: _Optional[_Union[_any_pb2.Any, _Mapping]] = ...) -> None: ...
...
class ChartDispatcherResponse(_message.Message):
    __slots__ = ["operation", "success", "chart_uuid", "configuration", "created_at", "updated_at"]
    ...
    def __init__(self, operation: _Optional[_Union[OperationEnum, str]] = ..., success: bool = ..., chart_uuid: _Optional[str] = ..., configuration: _Optional[_Union[_any_pb2.Any, _Mapping]] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
