...
class BlueprintGetRequest(_message.Message):
    ...
    blueprint_uuid: str
    type: TypeEnum
    def __init__(self, blueprint_uuid: _Optional[str] = ..., type: _Optional[_Union[TypeEnum, str]] = ...) -> None: ...
...
class BlueprintResponse(_message.Message):
    ...
    def __init__(self, operation: _Optional[_Union[OperationEnum, str]] = ..., success: bool = ..., uuid: _Optional[str] = ..., key: _Optional[str] = ..., name: _Optional[str] = ..., type: _Optional[_Union[TypeEnum, str]] = ..., icon: _Optional[str] = ..., configuration: _Optional[_Union[_any_pb2.Any, _Mapping]] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
