...
class CreateFineTuningJobProductRequest(object):
    ...
    def __init__(self, training_file=None, validation_file=None, hyperparameters=None, model=None, suffix=None, cloud_id=None, version=None, instance_type=None, local_vars_configuration=None):  # noqa: E501
