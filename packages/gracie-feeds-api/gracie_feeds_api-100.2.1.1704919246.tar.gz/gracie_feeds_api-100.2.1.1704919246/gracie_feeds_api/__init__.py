...
if server_type == 'feeds':
    from gracie_feeds_api.GracieAuth import GracieKeycloakAuth
    ...
    from gracie_dictionary_api.GracieAuth import GracieKeycloakAuth
...
class GracieBaseAPI(GracieAPIResponseError, GracieError, GracieAuthError, GracieKeycloakAuth):
    _session = None
...
class GracieAPI(GracieBaseAPI, GracieApiClassLoader):
    ...
    def __init__(self, host, keycloak_host, port, login_name, login_password,
                 require_ssl=True,
                 verify_ssl=False,
        ...
        GracieKeycloakAuth.__init__(self, keycloak_host, login_name, login_password, verify_ssl)
