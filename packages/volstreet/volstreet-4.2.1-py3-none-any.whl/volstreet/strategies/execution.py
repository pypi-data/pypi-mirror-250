...
class Client:
    ...
    def __init__(
        self, user: str, pin: str, apikey: str, authkey: str, websockets: bool = False
    ):
        self.user = user
        self.pin = pin
        self.apikey = apikey
    ...
    def continuously_handle_open_orders(self):
        ...
        while not self.session_terminated:
            ...
            if (
                LiveFeeds.order_feed_connected()
                and current_time() - last_order_book_fetched_at < timedelta(seconds=5)
            ):
            ...
            open_orders = get_open_orders(order_book)
