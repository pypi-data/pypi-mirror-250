...
class DeltaBackTest(IntradayBackTest):
    ...
    def process_segment(
        ...
        # og_call_delta = entry_data["call_ratio"].mul(entry_data["call_delta"]).sum()
        # og_put_delta = entry_data["put_ratio"].mul(entry_data["put_delta"]).sum()
        # main_net_delta = og_call_delta + og_put_delta
