...
class CreateEvaluationResultLogRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["log_id", "datapoint_id", "evaluator_id", "result", "error", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["log_id", "datapoint_id", "evaluator_id", "result", "error", ], str]):
