...
CLI_MAIN_INTRODUCTION = f"[bold]Safety CLI 3[/bold]\n\n" \
"Secure Python and Javascript projects and environmnets against dependency security vulnerabilities and malicious packages. Secure development, CI/CD, and production systems by leveraging the most comprehensive security data available.\n\n" \
...
CLI_SYSTEM_SCAN_COMMAND_HELP = "Run a comprehensive scan for packages and vulnerabilities across your entire machine/environment."\
