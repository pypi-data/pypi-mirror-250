...
MSG_FAIL_LOGIN_AUTHED = '[green]You are already authenticated as[/green] {email}. [green]If you would like to log in to a different account please first "logout by entering: `safety auth logout` and then log in again.[/green]'
