...
from boulderopal._validation.basic import validate_enum
from boulderopal._validation.exceptions import Checker
from boulderopal._validation.graph import validate_output_node_names
...
def execute_graph(
    ...
    for operation in graph.operations.values():
        Checker.VALUE(
            not PRIMARY_NODE_REGISTRY.is_optimization_node(operation),
