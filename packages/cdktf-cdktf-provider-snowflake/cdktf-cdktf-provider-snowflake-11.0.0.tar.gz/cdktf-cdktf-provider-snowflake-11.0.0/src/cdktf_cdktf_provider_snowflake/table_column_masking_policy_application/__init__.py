...
Refer to the Terraform Registry for docs: [`snowflake_table_column_masking_policy_application`](https://registry.terraform.io/providers/snowflake-labs/snowflake/0.82.0/docs/resources/table_column_masking_policy_application).
'''
import abc
import builtins
import datetime
