...
Refer to the Terraform Registry for docs: [`snowflake_network_policy_attachment`](https://registry.terraform.io/providers/snowflake-labs/snowflake/0.82.0/docs/resources/network_policy_attachment).
'''
import abc
import builtins
import datetime
