...
class SummaryProbesApi(object):
    ...
    def summary_probes_checkid_get(self, checkid, _from, **kwargs):  # noqa: E501
        """Get a list of probes that performed tests  # noqa: E501

        Get a list of probes that performed tests for a specified check during a specified period.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.summary_probes_checkid_get(checkid, _from, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SummaryProbesCheckid checkid: (required)
        :param SummaryProbesFrom _from: Start time of period. Format is UNIX timestamp (required)
        :param SummaryProbesTo to: End time of period. Format is UNIX timestamp. The defualt value is current time.
        ...
        if kwargs.get('async_req'):
            return self.summary_probes_checkid_get_with_http_info(checkid, _from, **kwargs)  # noqa: E501
        else:
            (data) = self.summary_probes_checkid_get_with_http_info(checkid, _from, **kwargs)  # noqa: E501
            return data

    def summary_probes_checkid_get_with_http_info(self, checkid, _from, **kwargs):  # noqa: E501
        """Get a list of probes that performed tests  # noqa: E501

        Get a list of probes that performed tests for a specified check during a specified period.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.summary_probes_checkid_get_with_http_info(checkid, _from, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['checkid', '_from', 'to']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method summary_probes_checkid_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('checkid' not in params or
            ...
            raise ValueError("Missing the required parameter `checkid` when calling `summary_probes_checkid_get`")  # noqa: E501
        # verify the required parameter '_from' is set
        if ('_from' not in params or
                params['_from'] is None):
            raise ValueError("Missing the required parameter `_from` when calling `summary_probes_checkid_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='SummaryProbesRespAttrs',  # noqa: E501
