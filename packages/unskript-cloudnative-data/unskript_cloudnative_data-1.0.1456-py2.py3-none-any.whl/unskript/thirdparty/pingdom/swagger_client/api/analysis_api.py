...
class AnalysisApi(object):
    ...
    def analysis_checkid_analysisid_get(self, checkid, analysisid, **kwargs):  # noqa: E501
        """Returns the raw result for a specified analysis.  # noqa: E501

        Returns the raw result for a specified error analysis. This data is primarily intended for internal use, but you might be interested in it as well. However, there is no real documentation for this data at the moment. In the future, we may add a new API method that provides a more user-friendly format.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.analysis_checkid_analysisid_get(checkid, analysisid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AnalysisCheckid checkid: (required)
        :param AnalysisAnalysisid analysisid: (required)
        :return: None
        ...
        if kwargs.get('async_req'):
            return self.analysis_checkid_analysisid_get_with_http_info(checkid, analysisid, **kwargs)  # noqa: E501
        else:
            (data) = self.analysis_checkid_analysisid_get_with_http_info(checkid, analysisid, **kwargs)  # noqa: E501
            return data

    def analysis_checkid_analysisid_get_with_http_info(self, checkid, analysisid, **kwargs):  # noqa: E501
        """Returns the raw result for a specified analysis.  # noqa: E501

        Returns the raw result for a specified error analysis. This data is primarily intended for internal use, but you might be interested in it as well. However, there is no real documentation for this data at the moment. In the future, we may add a new API method that provides a more user-friendly format.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.analysis_checkid_analysisid_get_with_http_info(checkid, analysisid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['checkid', 'analysisid']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method analysis_checkid_analysisid_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('checkid' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `checkid` when calling `analysis_checkid_analysisid_get`")  # noqa: E501
        # verify the required parameter 'analysisid' is set
        if ('analysisid' not in params or
            params['analysisid'] is None):
            raise ValueError(
                "Missing the required parameter `analysisid` when calling `analysis_checkid_analysisid_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/analysis/{checkid}/{analysisid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def analysis_checkid_get(self, checkid, **kwargs):  # noqa: E501
        """Returns a list of the latest root cause analysis  # noqa: E501

        Returns a list of the latest root cause analysis results for a specified check.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.analysis_checkid_get(checkid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AnalysisCheckid checkid: (required)
        :param AnalysisLimit limit: Limits the number of returned results to the specified quantity.
        :param AnalysisOffset offset: Offset for listing. (Requires limit.)
        :param AnalysisFrom _from: Return only results with timestamp of first test greater or equal to this value. Format is UNIX timestamp.
        :param AnalysisTo to: Return only results with timestamp of first test less or equal to this value. Format is UNIX timestamp. Default: current timestamp
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.analysis_checkid_get_with_http_info(checkid, **kwargs)  # noqa: E501
        else:
            (data) = self.analysis_checkid_get_with_http_info(checkid, **kwargs)  # noqa: E501
            return data

    def analysis_checkid_get_with_http_info(self, checkid, **kwargs):  # noqa: E501
        """Returns a list of the latest root cause analysis  # noqa: E501

        Returns a list of the latest root cause analysis results for a specified check.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.analysis_checkid_get_with_http_info(checkid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['checkid', 'limit', 'offset', '_from', 'to']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method analysis_checkid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'checkid' is set
        if ('checkid' not in params or
            params['checkid'] is None):
            raise ValueError(
                "Missing the required parameter `checkid` when calling `analysis_checkid_get`")  # noqa: E501
        ...
        if '_from' in params and params['_from'] != None:
            query_params.append(('from', params['_from']))  # noqa: E501
        if 'to' in params and params['to'] != None:
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='AnalysisRespAttrs',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
