...
class TeamsApi(object):
    ...
    def alerting_teams_get(self, **kwargs):  # noqa: E501
        """alerting_teams_get  # noqa: E501

        Returns a list of all teams and their members  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_teams_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.alerting_teams_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.alerting_teams_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def alerting_teams_get_with_http_info(self, **kwargs):  # noqa: E501
        """alerting_teams_get  # noqa: E501

        Returns a list of all teams and their members  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_teams_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method alerting_teams_get" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def alerting_teams_post(self, body, **kwargs):  # noqa: E501
        """Creates a new team  # noqa: E501

        Creates a new team with or without members  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_teams_post(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.alerting_teams_post_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.alerting_teams_post_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def alerting_teams_post_with_http_info(self, body, **kwargs):  # noqa: E501
        """Creates a new team  # noqa: E501

        Creates a new team with or without members  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_teams_post_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method alerting_teams_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `alerting_teams_post`")  # noqa: E501
    ...
    def alerting_teams_teamid_delete(self, teamid, **kwargs):  # noqa: E501
        """alerting_teams_teamid_delete  # noqa: E501

        Deletes a team  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_teams_teamid_delete(teamid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int teamid: ID of the team to be deleted (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.alerting_teams_teamid_delete_with_http_info(teamid, **kwargs)  # noqa: E501
        else:
            (data) = self.alerting_teams_teamid_delete_with_http_info(teamid, **kwargs)  # noqa: E501
            return data

    def alerting_teams_teamid_delete_with_http_info(self, teamid, **kwargs):  # noqa: E501
        """alerting_teams_teamid_delete  # noqa: E501

        Deletes a team  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_teams_teamid_delete_with_http_info(teamid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method alerting_teams_teamid_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('teamid' not in params or
            ...
            raise ValueError("Missing the required parameter `teamid` when calling `alerting_teams_teamid_delete`")  # noqa: E501
    ...
    def alerting_teams_teamid_get(self, teamid, **kwargs):  # noqa: E501
        """alerting_teams_teamid_get  # noqa: E501

        Returns a team with its members  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_teams_teamid_get(teamid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int teamid: ID of the team to be retrieved (required)
        :return: TeamID
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.alerting_teams_teamid_get_with_http_info(teamid, **kwargs)  # noqa: E501
        else:
            (data) = self.alerting_teams_teamid_get_with_http_info(teamid, **kwargs)  # noqa: E501
            return data

    def alerting_teams_teamid_get_with_http_info(self, teamid, **kwargs):  # noqa: E501
        """alerting_teams_teamid_get  # noqa: E501

        Returns a team with its members  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_teams_teamid_get_with_http_info(teamid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method alerting_teams_teamid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'teamid' is set
        if ('teamid' not in params or
                params['teamid'] is None):
            raise ValueError("Missing the required parameter `teamid` when calling `alerting_teams_teamid_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TeamID',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def alerting_teams_teamid_put(self, body, teamid, **kwargs):  # noqa: E501
        """alerting_teams_teamid_put  # noqa: E501

        Updates a team  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_teams_teamid_put(body, teamid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.alerting_teams_teamid_put_with_http_info(body, teamid, **kwargs)  # noqa: E501
        else:
            (data) = self.alerting_teams_teamid_put_with_http_info(body, teamid, **kwargs)  # noqa: E501
            return data

    def alerting_teams_teamid_put_with_http_info(self, body, teamid, **kwargs):  # noqa: E501
        """alerting_teams_teamid_put  # noqa: E501

        Updates a team  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_teams_teamid_put_with_http_info(body, teamid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'teamid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method alerting_teams_teamid_put" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `alerting_teams_teamid_put`")  # noqa: E501
        # verify the required parameter 'teamid' is set
        if ('teamid' not in params or
                params['teamid'] is None):
            raise ValueError("Missing the required parameter `teamid` when calling `alerting_teams_teamid_put`")  # noqa: E501
