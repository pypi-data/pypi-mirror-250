...
class ResultsApi(object):
    ...
    def results_checkid_get(self, checkid, **kwargs):  # noqa: E501
        """Return a list of raw test results  # noqa: E501

        Return a list of raw test results for a specified check  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.results_checkid_get(checkid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ResultsCheckid checkid: (required)
        :param ResultsTo to: End of period. Format is UNIX timestamp. Default value is current timestamp.
        :param ResultsFrom _from: Start of period. Format is UNIX timestamp. Default value is 1 day prior to `to`.
        :param ResultsProbes probes: Filter to only show results from a list of probes. Format is a comma separated list of probe identifiers
        :param ResultsStatus status: Filter to only show results with specified statuses. Format is a comma separated list of (`down`, `up`, `unconfirmed`, `unknown`)
        :param ResultsLimit limit: Number of results to show (Will be set to 1000 if the provided value is greater than 1000)
        :param ResultsOffset offset: Number of results to skip (Max value is `43200`)
        :param ResultsIncludeanalysis includeanalysis: Attach available root cause analysis identifiers to corresponding results
        :param ResultsMaxresponse maxresponse: Maximum response time (ms). If set, specified interval must not be larger than 31 days.
        :param ResultsMinresponse minresponse: Minimum response time (ms). If set, specified interval must not be larger than 31 days.
        ...
        if kwargs.get('async_req'):
            return self.results_checkid_get_with_http_info(checkid, **kwargs)  # noqa: E501
        else:
            (data) = self.results_checkid_get_with_http_info(checkid, **kwargs)  # noqa: E501
            return data

    def results_checkid_get_with_http_info(self, checkid, **kwargs):  # noqa: E501
        """Return a list of raw test results  # noqa: E501

        Return a list of raw test results for a specified check  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.results_checkid_get_with_http_info(checkid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['checkid', 'to', '_from', 'probes', 'status', 'limit', 'offset', 'includeanalysis', 'maxresponse', 'minresponse']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method results_checkid_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('checkid' not in params or
            ...
            raise ValueError("Missing the required parameter `checkid` when calling `results_checkid_get`")  # noqa: E501
        ...
        if 'includeanalysis' in params:
            query_params.append(('includeanalysis', params['includeanalysis']))  # noqa: E501
        if 'maxresponse' in params:
            query_params.append(('maxresponse', params['maxresponse']))  # noqa: E501
        if 'minresponse' in params:
            query_params.append(('minresponse', params['minresponse']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ResultsRespAttrs',  # noqa: E501
