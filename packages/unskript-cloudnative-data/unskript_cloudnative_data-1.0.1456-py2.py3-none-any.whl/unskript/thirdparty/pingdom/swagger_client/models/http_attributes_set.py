...
import six
from unskript.thirdparty.pingdom.swagger_client.models.http_attributes_base import HttpAttributesBase  # noqa: F401,E501

class HttpAttributesSet(HttpAttributesBase):
    ...
    if hasattr(HttpAttributesBase, "swagger_types"):
        swagger_types.update(HttpAttributesBase.swagger_types)
    ...
    if hasattr(HttpAttributesBase, "attribute_map"):
        attribute_map.update(HttpAttributesBase.attribute_map)

    def __init__(self, verify_certificate=True, ssl_down_days_before=0, auth=None, *args, **kwargs):  # noqa: E501
        """HttpAttributesSet - a model defined in Swagger"""  # noqa: E501
        ...
        if auth is not None:
            self.auth = auth
        HttpAttributesBase.__init__(self, *args, **kwargs)

    @property
    def verify_certificate(self):
        """Gets the verify_certificate of this HttpAttributesSet.  # noqa: E501

        Treat target site as down if an invalid/unverifiable certificate is found.  # noqa: E501

        :return: The verify_certificate of this HttpAttributesSet.  # noqa: E501
        :rtype: bool
        """
    ...
    def verify_certificate(self, verify_certificate):
        """Sets the verify_certificate of this HttpAttributesSet.

        Treat target site as down if an invalid/unverifiable certificate is found.  # noqa: E501

        :param verify_certificate: The verify_certificate of this HttpAttributesSet.  # noqa: E501
        :type: bool
        """
    ...
    def ssl_down_days_before(self):
        """Gets the ssl_down_days_before of this HttpAttributesSet.  # noqa: E501
        ...
        :return: The ssl_down_days_before of this HttpAttributesSet.  # noqa: E501
        :rtype: int
        """
    ...
    def ssl_down_days_before(self, ssl_down_days_before):
        """Sets the ssl_down_days_before of this HttpAttributesSet.

        Treat the target site as down if a certificate expires within the given number of days. This parameter will be ignored if `verify_certificate` is set to `false`.  # noqa: E501

        :param ssl_down_days_before: The ssl_down_days_before of this HttpAttributesSet.  # noqa: E501
        :type: int
        """
    ...
    @property
    def auth(self):
        """Gets the auth of this HttpAttributesSet.  # noqa: E501

        Username and password, colon separated.  # noqa: E501

        :return: The auth of this HttpAttributesSet.  # noqa: E501
        :rtype: str
        """
        return self._auth
    ...
    @auth.setter
    def auth(self, auth):
        """Sets the auth of this HttpAttributesSet.

        Username and password, colon separated.  # noqa: E501

        :param auth: The auth of this HttpAttributesSet.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HttpAttributesSet, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HttpAttributesSet):
            return False
