...
class DetailedCheckImap(object):
    ...
    """
    swagger_types = {
        'check': 'AllOfDetailedCheckImapCheck'
    }
    ...
    def __init__(self, check=None):  # noqa: E501
        """DetailedCheckImap - a model defined in Swagger"""  # noqa: E501
        self._check = None
    ...
    @property
    def check(self):
        """Gets the check of this DetailedCheckImap.  # noqa: E501


        :return: The check of this DetailedCheckImap.  # noqa: E501
        :rtype: AllOfDetailedCheckImapCheck
        """
        return self._check

    @check.setter
    def check(self, check):
        """Sets the check of this DetailedCheckImap.


        :param check: The check of this DetailedCheckImap.  # noqa: E501
        :type: AllOfDetailedCheckImapCheck
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DetailedCheckImap, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetailedCheckImap):
            return False
