...
class Check(object):
    ...
    attribute_map = {
        ...
        'lastdownstart': 'lastdownstart',
        'lastdownend': 'lastdownend',
        'status': 'status',
    ...
    def __init__(self, id=None, name=None, lasterrortime=None, lasttesttime=None, lastresponsetime=None, lastdownstart=None, lastdownend=None, status=None, resolution=None, hostname=None, created=None, tags=None, ipv6=None):  # noqa: E501
        """Check - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
        self._lasterrortime = None
        self._lasttesttime = None
        self._lastresponsetime = None
        self._lastdownstart = None
        self._lastdownend = None
        self._status = None
        ...
        if name is not None:
            self.name = name
        if lasterrortime is not None:
            self.lasterrortime = lasterrortime
        if lasttesttime is not None:
            self.lasttesttime = lasttesttime
        if lastresponsetime is not None:
            self.lastresponsetime = lastresponsetime
        if lastdownstart is not None:
            self.lastdownstart = lastdownstart
        if lastdownend is not None:
            self.lastdownend = lastdownend
    ...
    @property
    def lasterrortime(self):
        """Gets the lasterrortime of this Check.  # noqa: E501

        Timestamp of last error (if any). Format is UNIX timestamp  # noqa: E501

        :return: The lasterrortime of this Check.  # noqa: E501
        :rtype: int
        """
        return self._lasterrortime

    @lasterrortime.setter
    def lasterrortime(self, lasterrortime):
        """Sets the lasterrortime of this Check.

        Timestamp of last error (if any). Format is UNIX timestamp  # noqa: E501

        :param lasterrortime: The lasterrortime of this Check.  # noqa: E501
        :type: int
        """

        self._lasterrortime = lasterrortime

    @property
    def lasttesttime(self):
        """Gets the lasttesttime of this Check.  # noqa: E501

        Timestamp of last test (if any). Format is UNIX timestamp  # noqa: E501

        :return: The lasttesttime of this Check.  # noqa: E501
        :rtype: int
        """
        return self._lasttesttime

    @lasttesttime.setter
    def lasttesttime(self, lasttesttime):
        """Sets the lasttesttime of this Check.

        Timestamp of last test (if any). Format is UNIX timestamp  # noqa: E501

        :param lasttesttime: The lasttesttime of this Check.  # noqa: E501
        :type: int
        """

        self._lasttesttime = lasttesttime

    @property
    def lastresponsetime(self):
        """Gets the lastresponsetime of this Check.  # noqa: E501

        Response time (in milliseconds) of last test.  # noqa: E501

        :return: The lastresponsetime of this Check.  # noqa: E501
        :rtype: int
        """
        return self._lastresponsetime

    @lastresponsetime.setter
    def lastresponsetime(self, lastresponsetime):
        """Sets the lastresponsetime of this Check.

        Response time (in milliseconds) of last test.  # noqa: E501

        :param lastresponsetime: The lastresponsetime of this Check.  # noqa: E501
        :type: int
        """
    ...
    @property
    def lastdownstart(self):
        """Gets the lastdownstart of this Check.  # noqa: E501

        Timestamp of start of last check down (if any). Format is UNIX timestamp.  # noqa: E501

        :return: The lastdownstart of this Check.  # noqa: E501
        :rtype: int
        """
        return self._lastdownstart

    @lastdownstart.setter
    def lastdownstart(self, lastdownstart):
        """Sets the lastdownstart of this Check.

        Timestamp of start of last check down (if any). Format is UNIX timestamp.  # noqa: E501

        :param lastdownstart: The lastdownstart of this Check.  # noqa: E501
        :type: int
        """

        self._lastdownstart = lastdownstart

    @property
    def lastdownend(self):
        """Gets the lastdownend of this Check.  # noqa: E501

        Timestamp of end of last check down (if any). Format is UNIX timestamp. During a downtime it will be lasttesttime.  # noqa: E501

        :return: The lastdownend of this Check.  # noqa: E501
        :rtype: int
        """
        return self._lastdownend

    @lastdownend.setter
    def lastdownend(self, lastdownend):
        """Sets the lastdownend of this Check.

        Timestamp of end of last check down (if any). Format is UNIX timestamp. During a downtime it will be lasttesttime.  # noqa: E501

        :param lastdownend: The lastdownend of this Check.  # noqa: E501
        :type: int
        """

        self._lastdownend = lastdownend
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["up", "down", "unconfirmed_down", "unknown", "paused"]  # noqa: E501
    ...
    @property
    def resolution(self):
        """Gets the resolution of this Check.  # noqa: E501

        How often should the check be tested? (minutes)  # noqa: E501

        :return: The resolution of this Check.  # noqa: E501
        :rtype: int
        """
    ...
    def resolution(self, resolution):
        """Sets the resolution of this Check.

        How often should the check be tested? (minutes)  # noqa: E501

        :param resolution: The resolution of this Check.  # noqa: E501
        :type: int
        """
    ...
    @property
    def hostname(self):
        """Gets the hostname of this Check.  # noqa: E501

        Target host  # noqa: E501

        :return: The hostname of this Check.  # noqa: E501
        :rtype: str
        """
    ...
    def hostname(self, hostname):
        """Sets the hostname of this Check.

        Target host  # noqa: E501

        :param hostname: The hostname of this Check.  # noqa: E501
        :type: str
        """
    ...
    @property
    def created(self):
        """Gets the created of this Check.  # noqa: E501

        Creating time. Format is UNIX timestamp  # noqa: E501

        :return: The created of this Check.  # noqa: E501
        :rtype: int
        """
    ...
    def created(self, created):
        """Sets the created of this Check.

        Creating time. Format is UNIX timestamp  # noqa: E501

        :param created: The created of this Check.  # noqa: E501
        :type: int
        """
    ...
    def tags(self):
        ...
        List of tags for check  # noqa: E501
    ...
    @property
    def ipv6(self):
        """Gets the ipv6 of this Check.  # noqa: E501

        Use ipv6 instead of ipv4  # noqa: E501

        :return: The ipv6 of this Check.  # noqa: E501
        :rtype: bool
        """
        return self._ipv6
    ...
    def ipv6(self, ipv6):
        ...
        :param ipv6: The ipv6 of this Check.  # noqa: E501
        :type: bool
        """
