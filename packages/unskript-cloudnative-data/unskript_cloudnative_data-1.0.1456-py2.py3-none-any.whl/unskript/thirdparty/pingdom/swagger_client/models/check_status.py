...
class CheckStatus(object):
    ...
    def __init__(self, check_id=None, name=None, states=None):  # noqa: E501
    ...
    @property
    def check_id(self):
        """Gets the check_id of this CheckStatus.  # noqa: E501


        :return: The check_id of this CheckStatus.  # noqa: E501
    ...
    def check_id(self, check_id):
        """Sets the check_id of this CheckStatus.


        :param check_id: The check_id of this CheckStatus.  # noqa: E501
    ...
    @property
    def states(self):
        """Gets the states of this CheckStatus.  # noqa: E501

        Intervals when the check had a specific status (`up`/`down`).  # noqa: E501

        :return: The states of this CheckStatus.  # noqa: E501
        :rtype: list[State]
        """
        return self._states
    ...
    def states(self, states):
        """Sets the states of this CheckStatus.

        Intervals when the check had a specific status (`up`/`down`).  # noqa: E501

        :param states: The states of this CheckStatus.  # noqa: E501
        :type: list[State]
        """
