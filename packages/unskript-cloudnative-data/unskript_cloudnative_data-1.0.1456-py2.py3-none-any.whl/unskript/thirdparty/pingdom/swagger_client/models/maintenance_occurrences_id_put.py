...
class MaintenanceOccurrencesIdPut(object):
    ...
    def __init__(self, _from=None, to=None):  # noqa: E501
        """MaintenanceOccurrencesIdPut - a model defined in Swagger"""  # noqa: E501
        self.__from = None
        self._to = None
    ...
    @property
    def _from(self):
        """Gets the _from of this MaintenanceOccurrencesIdPut.  # noqa: E501

        Beginning of the maintenance occurrence. Format UNIX time. (Only future allowed. Use 1 for the current timestamp.)  # noqa: E501

        :return: The _from of this MaintenanceOccurrencesIdPut.  # noqa: E501
        :rtype: int
        """
        return self.__from
    ...
    def _from(self, _from):
        """Sets the _from of this MaintenanceOccurrencesIdPut.

        Beginning of the maintenance occurrence. Format UNIX time. (Only future allowed. Use 1 for the current timestamp.)  # noqa: E501

        :param _from: The _from of this MaintenanceOccurrencesIdPut.  # noqa: E501
        :type: int
        """
    ...
    @property
    def to(self):
        """Gets the to of this MaintenanceOccurrencesIdPut.  # noqa: E501

        End of the maintenance occurrence. Format UNIX time. (Only future allowed. Use 1 for the current timestamp.)  # noqa: E501

        :return: The to of this MaintenanceOccurrencesIdPut.  # noqa: E501
        :rtype: int
        """
        return self._to
    ...
    @to.setter
    def to(self, to):
        """Sets the to of this MaintenanceOccurrencesIdPut.

        End of the maintenance occurrence. Format UNIX time. (Only future allowed. Use 1 for the current timestamp.)  # noqa: E501

        :param to: The to of this MaintenanceOccurrencesIdPut.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MaintenanceOccurrencesIdPut, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MaintenanceOccurrencesIdPut):
            return False
