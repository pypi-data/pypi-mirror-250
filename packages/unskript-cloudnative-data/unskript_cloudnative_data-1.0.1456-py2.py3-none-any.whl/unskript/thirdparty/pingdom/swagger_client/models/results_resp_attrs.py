...
class ResultsRespAttrs(object):
    ...
    """
    swagger_types = {
        'results': 'list[ResultsRespAttrsResults]',
        'activeprobes': 'list[float]'
    }
    ...
    def __init__(self, results=None, activeprobes=None):  # noqa: E501
        """ResultsRespAttrs - a model defined in Swagger"""  # noqa: E501
        self._results = None
        self._activeprobes = None
        self.discriminator = None
        if results is not None:
            self.results = results
        if activeprobes is not None:
            self.activeprobes = activeprobes

    @property
    def results(self):
        """Gets the results of this ResultsRespAttrs.  # noqa: E501


        :return: The results of this ResultsRespAttrs.  # noqa: E501
        :rtype: list[ResultsRespAttrsResults]
        """
        return self._results

    @results.setter
    def results(self, results):
        """Sets the results of this ResultsRespAttrs.


        :param results: The results of this ResultsRespAttrs.  # noqa: E501
        :type: list[ResultsRespAttrsResults]
        """

        self._results = results

    @property
    def activeprobes(self):
        """Gets the activeprobes of this ResultsRespAttrs.  # noqa: E501

        For your convenience, a list of used probes that produced the showed results  # noqa: E501

        :return: The activeprobes of this ResultsRespAttrs.  # noqa: E501
        :rtype: list[float]
        """
        return self._activeprobes

    @activeprobes.setter
    def activeprobes(self, activeprobes):
        """Sets the activeprobes of this ResultsRespAttrs.

        For your convenience, a list of used probes that produced the showed results  # noqa: E501

        :param activeprobes: The activeprobes of this ResultsRespAttrs.  # noqa: E501
        :type: list[float]
        """

        self._activeprobes = activeprobes
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResultsRespAttrs, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResultsRespAttrs):
            return False
