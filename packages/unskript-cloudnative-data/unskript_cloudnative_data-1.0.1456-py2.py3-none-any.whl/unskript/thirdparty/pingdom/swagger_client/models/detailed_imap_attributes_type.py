...
class DetailedImapAttributesType(object):
    ...
    def __init__(self, imap=None):  # noqa: E501
        """DetailedImapAttributesType - a model defined in Swagger"""  # noqa: E501
        self._imap = None
    ...
    @property
    def imap(self):
        """Gets the imap of this DetailedImapAttributesType.  # noqa: E501


        :return: The imap of this DetailedImapAttributesType.  # noqa: E501
        :rtype: ImapAttributes
        """
        return self._imap

    @imap.setter
    def imap(self, imap):
        """Sets the imap of this DetailedImapAttributesType.


        :param imap: The imap of this DetailedImapAttributesType.  # noqa: E501
        :type: ImapAttributes
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DetailedImapAttributesType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetailedImapAttributesType):
            return False
