...
class CheckSimple(object):
    ...
    def __init__(self, id=None, name=None):  # noqa: E501
        """CheckSimple - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
    ...
    @property
    def id(self):
        """Gets the id of this CheckSimple.  # noqa: E501

        Id of the check  # noqa: E501

        :return: The id of this CheckSimple.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CheckSimple.

        Id of the check  # noqa: E501

        :param id: The id of this CheckSimple.  # noqa: E501
        :type: int
        """
    ...
    @property
    def name(self):
        """Gets the name of this CheckSimple.  # noqa: E501

        Name of the check  # noqa: E501

        :return: The name of this CheckSimple.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CheckSimple.

        Name of the check  # noqa: E501

        :param name: The name of this CheckSimple.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CheckSimple, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckSimple):
            return False
