...
class MaintenanceOccurrencesDelete(object):
    ...
    def __init__(self, occurrenceids=None):  # noqa: E501
        """MaintenanceOccurrencesDelete - a model defined in Swagger"""  # noqa: E501
        self._occurrenceids = None
        self.discriminator = None
        self.occurrenceids = occurrenceids

    @property
    def occurrenceids(self):
        """Gets the occurrenceids of this MaintenanceOccurrencesDelete.  # noqa: E501

        Comma-separated list of identifiers of maintenance occurrences to delete.  # noqa: E501

        :return: The occurrenceids of this MaintenanceOccurrencesDelete.  # noqa: E501
        :rtype: list[int]
        """
        return self._occurrenceids

    @occurrenceids.setter
    def occurrenceids(self, occurrenceids):
        """Sets the occurrenceids of this MaintenanceOccurrencesDelete.

        Comma-separated list of identifiers of maintenance occurrences to delete.  # noqa: E501

        :param occurrenceids: The occurrenceids of this MaintenanceOccurrencesDelete.  # noqa: E501
        :type: list[int]
        """
        if occurrenceids is None:
            raise ValueError("Invalid value for `occurrenceids`, must not be `None`")  # noqa: E501

        self._occurrenceids = occurrenceids
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MaintenanceOccurrencesDelete, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MaintenanceOccurrencesDelete):
            return False
