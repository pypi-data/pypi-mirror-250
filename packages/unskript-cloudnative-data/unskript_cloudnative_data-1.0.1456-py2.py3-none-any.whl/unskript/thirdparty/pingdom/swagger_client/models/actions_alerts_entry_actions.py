...
class ActionsAlertsEntryActions(object):
    ...
    """
    swagger_types = {
        'alerts': 'list[ActionsAlertsEntryActionsAlerts]'
    }
    ...
    def __init__(self, alerts=None):  # noqa: E501
        """ActionsAlertsEntryActions - a model defined in Swagger"""  # noqa: E501
        self._alerts = None
    ...
    @property
    def alerts(self):
        """Gets the alerts of this ActionsAlertsEntryActions.  # noqa: E501

        Alert entry  # noqa: E501

        :return: The alerts of this ActionsAlertsEntryActions.  # noqa: E501
        :rtype: list[ActionsAlertsEntryActionsAlerts]
        """
        return self._alerts

    @alerts.setter
    def alerts(self, alerts):
        """Sets the alerts of this ActionsAlertsEntryActions.

        Alert entry  # noqa: E501

        :param alerts: The alerts of this ActionsAlertsEntryActions.  # noqa: E501
        :type: list[ActionsAlertsEntryActionsAlerts]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ActionsAlertsEntryActions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ActionsAlertsEntryActions):
            return False
