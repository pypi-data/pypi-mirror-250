...
class MaintenanceRespAttrs(object):
    ...
    """
    swagger_types = {
        'maintenance': 'list[MaintenanceRespAttrsMaintenance]'
    }
    ...
    def __init__(self, maintenance=None):  # noqa: E501
        """MaintenanceRespAttrs - a model defined in Swagger"""  # noqa: E501
    ...
    def maintenance(self):
        """Gets the maintenance of this MaintenanceRespAttrs.  # noqa: E501

        A list of maintenance windows  # noqa: E501

        :return: The maintenance of this MaintenanceRespAttrs.  # noqa: E501
        :rtype: list[MaintenanceRespAttrsMaintenance]
        """
        return self._maintenance

    @maintenance.setter
    def maintenance(self, maintenance):
        """Sets the maintenance of this MaintenanceRespAttrs.

        A list of maintenance windows  # noqa: E501

        :param maintenance: The maintenance of this MaintenanceRespAttrs.  # noqa: E501
        :type: list[MaintenanceRespAttrsMaintenance]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MaintenanceRespAttrs, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MaintenanceRespAttrs):
            return False
