...
class SummaryHoursofdayRespAttrsHoursofday(object):
    ...
    def __init__(self, hour=None, avgresponse=None):  # noqa: E501
        """SummaryHoursofdayRespAttrsHoursofday - a model defined in Swagger"""  # noqa: E501
        self._hour = None
    ...
    @property
    def hour(self):
        """Gets the hour of this SummaryHoursofdayRespAttrsHoursofday.  # noqa: E501

        Hour of day (0-23). Please note that if data is missing for an individual hour, it's entry will not be included in the result.  # noqa: E501

        :return: The hour of this SummaryHoursofdayRespAttrsHoursofday.  # noqa: E501
        :rtype: float
        """
        return self._hour
    ...
    @hour.setter
    def hour(self, hour):
        """Sets the hour of this SummaryHoursofdayRespAttrsHoursofday.

        Hour of day (0-23). Please note that if data is missing for an individual hour, it's entry will not be included in the result.  # noqa: E501

        :param hour: The hour of this SummaryHoursofdayRespAttrsHoursofday.  # noqa: E501
        :type: float
        """
    ...
    def avgresponse(self):
        """Gets the avgresponse of this SummaryHoursofdayRespAttrsHoursofday.  # noqa: E501

        Average response time (in milliseconds) for this hour of the day  # noqa: E501

        :return: The avgresponse of this SummaryHoursofdayRespAttrsHoursofday.  # noqa: E501
        :rtype: float
        """
    ...
    def avgresponse(self, avgresponse):
        """Sets the avgresponse of this SummaryHoursofdayRespAttrsHoursofday.

        Average response time (in milliseconds) for this hour of the day  # noqa: E501

        :param avgresponse: The avgresponse of this SummaryHoursofdayRespAttrsHoursofday.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SummaryHoursofdayRespAttrsHoursofday, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SummaryHoursofdayRespAttrsHoursofday):
            return False
