...
class Members(object):
    ...
    @property
    def name(self):
        """Gets the name of this Members.  # noqa: E501

        The team member’s name  # noqa: E501

        :return: The name of this Members.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this Members.

        The team member’s name  # noqa: E501

        :param name: The name of this Members.  # noqa: E501
        :type: str
        """
    ...
    def type(self):
        ...
        Type defines whether the member is a user (login user) or a contact only  # noqa: E501
