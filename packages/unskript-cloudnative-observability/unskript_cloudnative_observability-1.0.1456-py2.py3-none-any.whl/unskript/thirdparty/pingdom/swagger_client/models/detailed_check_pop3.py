...
class DetailedCheckPop3(object):
    ...
    """
    swagger_types = {
        'check': 'AllOfDetailedCheckPop3Check'
    }
    ...
    def __init__(self, check=None):  # noqa: E501
        """DetailedCheckPop3 - a model defined in Swagger"""  # noqa: E501
        self._check = None
    ...
    @property
    def check(self):
        """Gets the check of this DetailedCheckPop3.  # noqa: E501


        :return: The check of this DetailedCheckPop3.  # noqa: E501
        :rtype: AllOfDetailedCheckPop3Check
        """
        return self._check

    @check.setter
    def check(self, check):
        """Sets the check of this DetailedCheckPop3.


        :param check: The check of this DetailedCheckPop3.  # noqa: E501
        :type: AllOfDetailedCheckPop3Check
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DetailedCheckPop3, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetailedCheckPop3):
            return False
