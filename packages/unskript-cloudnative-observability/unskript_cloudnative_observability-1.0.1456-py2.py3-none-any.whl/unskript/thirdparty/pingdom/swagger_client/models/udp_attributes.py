...
class UdpAttributes(object):
    ...
    def __init__(self, port=None, stringtosend=None, stringtoexpect=None):  # noqa: E501
        """UdpAttributes - a model defined in Swagger"""  # noqa: E501
        self._port = None
    ...
    @property
    def port(self):
        """Gets the port of this UdpAttributes.  # noqa: E501

        Target port  # noqa: E501

        :return: The port of this UdpAttributes.  # noqa: E501
        :rtype: int
        """
        return self._port
    ...
    @port.setter
    def port(self, port):
        """Sets the port of this UdpAttributes.

        Target port  # noqa: E501

        :param port: The port of this UdpAttributes.  # noqa: E501
        :type: int
        """
        if port is None:
    ...
    def stringtosend(self):
        """Gets the stringtosend of this UdpAttributes.  # noqa: E501

        String to send  # noqa: E501

        :return: The stringtosend of this UdpAttributes.  # noqa: E501
        :rtype: str
        """
    ...
    def stringtosend(self, stringtosend):
        """Sets the stringtosend of this UdpAttributes.

        String to send  # noqa: E501

        :param stringtosend: The stringtosend of this UdpAttributes.  # noqa: E501
        :type: str
        """
        if stringtosend is None:
            raise ValueError("Invalid value for `stringtosend`, must not be `None`")  # noqa: E501

        self._stringtosend = stringtosend

    @property
    def stringtoexpect(self):
        """Gets the stringtoexpect of this UdpAttributes.  # noqa: E501

        String to expect in response  # noqa: E501

        :return: The stringtoexpect of this UdpAttributes.  # noqa: E501
        :rtype: str
        """
    ...
    def stringtoexpect(self, stringtoexpect):
        """Sets the stringtoexpect of this UdpAttributes.

        String to expect in response  # noqa: E501

        :param stringtoexpect: The stringtoexpect of this UdpAttributes.  # noqa: E501
        :type: str
        """
        if stringtoexpect is None:
            raise ValueError("Invalid value for `stringtoexpect`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UdpAttributes, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UdpAttributes):
            return False
