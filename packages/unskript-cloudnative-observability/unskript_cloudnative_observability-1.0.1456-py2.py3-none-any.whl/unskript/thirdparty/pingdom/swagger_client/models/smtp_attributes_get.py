...
import six
from unskript.thirdparty.pingdom.swagger_client.models.smtp_attributes_base import SmtpAttributesBase  # noqa: F401,E501

class SmtpAttributesGet(SmtpAttributesBase):
    ...
    if hasattr(SmtpAttributesBase, "swagger_types"):
        swagger_types.update(SmtpAttributesBase.swagger_types)

    attribute_map = {
        'username': 'username',
        'password': 'password'
    }
    if hasattr(SmtpAttributesBase, "attribute_map"):
        attribute_map.update(SmtpAttributesBase.attribute_map)

    def __init__(self, username=None, password=None, *args, **kwargs):  # noqa: E501
        """SmtpAttributesGet - a model defined in Swagger"""  # noqa: E501
        self._username = None
        self._password = None
        ...
        SmtpAttributesBase.__init__(self, *args, **kwargs)

    @property
    def username(self):
        """Gets the username of this SmtpAttributesGet.  # noqa: E501

        Username for target SMTP authentication  # noqa: E501

        :return: The username of this SmtpAttributesGet.  # noqa: E501
        :rtype: str
        """
    ...
    def username(self, username):
        """Sets the username of this SmtpAttributesGet.

        Username for target SMTP authentication  # noqa: E501

        :param username: The username of this SmtpAttributesGet.  # noqa: E501
        :type: str
        """
    ...
    @property
    def password(self):
        """Gets the password of this SmtpAttributesGet.  # noqa: E501

        Password for target SMTP authentication  # noqa: E501

        :return: The password of this SmtpAttributesGet.  # noqa: E501
        :rtype: str
        """
    ...
    def password(self, password):
        """Sets the password of this SmtpAttributesGet.

        Password for target SMTP authentication  # noqa: E501

        :param password: The password of this SmtpAttributesGet.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SmtpAttributesGet, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SmtpAttributesGet):
            return False
