...
class DetailedCheckHttp(object):
    ...
    """
    swagger_types = {
        'check': 'AllOfDetailedCheckHttpCheck'
    }
    ...
    def __init__(self, check=None):  # noqa: E501
        """DetailedCheckHttp - a model defined in Swagger"""  # noqa: E501
        self._check = None
    ...
    @property
    def check(self):
        """Gets the check of this DetailedCheckHttp.  # noqa: E501


        :return: The check of this DetailedCheckHttp.  # noqa: E501
        :rtype: AllOfDetailedCheckHttpCheck
        """
        return self._check

    @check.setter
    def check(self, check):
        """Sets the check of this DetailedCheckHttp.


        :param check: The check of this DetailedCheckHttp.  # noqa: E501
        :type: AllOfDetailedCheckHttpCheck
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DetailedCheckHttp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetailedCheckHttp):
            return False
