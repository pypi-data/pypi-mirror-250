...
class DetailedCheckSmtp(object):
    ...
    """
    swagger_types = {
        'check': 'AllOfDetailedCheckSmtpCheck'
    }
    ...
    def __init__(self, check=None):  # noqa: E501
        """DetailedCheckSmtp - a model defined in Swagger"""  # noqa: E501
        self._check = None
    ...
    @property
    def check(self):
        """Gets the check of this DetailedCheckSmtp.  # noqa: E501


        :return: The check of this DetailedCheckSmtp.  # noqa: E501
        :rtype: AllOfDetailedCheckSmtpCheck
        """
        return self._check

    @check.setter
    def check(self, check):
        """Sets the check of this DetailedCheckSmtp.


        :param check: The check of this DetailedCheckSmtp.  # noqa: E501
        :type: AllOfDetailedCheckSmtpCheck
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DetailedCheckSmtp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetailedCheckSmtp):
            return False
