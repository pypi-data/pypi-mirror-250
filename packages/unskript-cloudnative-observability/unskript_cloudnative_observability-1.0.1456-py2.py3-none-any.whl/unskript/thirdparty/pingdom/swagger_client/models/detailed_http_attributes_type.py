...
class DetailedHttpAttributesType(object):
    ...
    def __init__(self, http=None):  # noqa: E501
        """DetailedHttpAttributesType - a model defined in Swagger"""  # noqa: E501
        self._http = None
    ...
    @property
    def http(self):
        """Gets the http of this DetailedHttpAttributesType.  # noqa: E501


        :return: The http of this DetailedHttpAttributesType.  # noqa: E501
        :rtype: HttpAttributesGet
        """
        return self._http

    @http.setter
    def http(self, http):
        """Sets the http of this DetailedHttpAttributesType.


        :param http: The http of this DetailedHttpAttributesType.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DetailedHttpAttributesType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetailedHttpAttributesType):
            return False
