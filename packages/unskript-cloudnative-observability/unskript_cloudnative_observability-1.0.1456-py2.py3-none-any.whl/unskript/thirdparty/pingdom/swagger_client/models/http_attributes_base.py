...
class HttpAttributesBase(object):
    ...
    def __init__(self, url=None, encryption=None, port=None, shouldcontain=None, shouldnotcontain=None, postdata=None, requestheaders=None):  # noqa: E501
        """HttpAttributesBase - a model defined in Swagger"""  # noqa: E501
        self._url = None
    ...
    @property
    def url(self):
        """Gets the url of this HttpAttributesBase.  # noqa: E501

        Path to target on server  # noqa: E501

        :return: The url of this HttpAttributesBase.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this HttpAttributesBase.

        Path to target on server  # noqa: E501

        :param url: The url of this HttpAttributesBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def encryption(self):
        """Gets the encryption of this HttpAttributesBase.  # noqa: E501

        Connection encryption  # noqa: E501

        :return: The encryption of this HttpAttributesBase.  # noqa: E501
        :rtype: bool
        """
    ...
    def encryption(self, encryption):
        """Sets the encryption of this HttpAttributesBase.

        Connection encryption  # noqa: E501

        :param encryption: The encryption of this HttpAttributesBase.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def port(self):
        """Gets the port of this HttpAttributesBase.  # noqa: E501

        Target port  # noqa: E501

        :return: The port of this HttpAttributesBase.  # noqa: E501
        :rtype: int
        """
        return self._port
    ...
    @port.setter
    def port(self, port):
        """Sets the port of this HttpAttributesBase.

        Target port  # noqa: E501

        :param port: The port of this HttpAttributesBase.  # noqa: E501
        :type: int
        """
    ...
    def shouldcontain(self):
        """Gets the shouldcontain of this HttpAttributesBase.  # noqa: E501

        Target site should contain this string. Note! This parameter cannot be used together with the parameter “shouldnotcontain”, use only one of them in your request.  # noqa: E501

        :return: The shouldcontain of this HttpAttributesBase.  # noqa: E501
        :rtype: str
        """
    ...
    def shouldcontain(self, shouldcontain):
        """Sets the shouldcontain of this HttpAttributesBase.

        Target site should contain this string. Note! This parameter cannot be used together with the parameter “shouldnotcontain”, use only one of them in your request.  # noqa: E501

        :param shouldcontain: The shouldcontain of this HttpAttributesBase.  # noqa: E501
        :type: str
        """
    ...
    def shouldnotcontain(self):
        """Gets the shouldnotcontain of this HttpAttributesBase.  # noqa: E501

        Target site should NOT contain this string. Note! This parameter cannot be used together with the parameter “shouldcontain”, use only one of them in your request.  # noqa: E501

        :return: The shouldnotcontain of this HttpAttributesBase.  # noqa: E501
        :rtype: str
        """
    ...
    def shouldnotcontain(self, shouldnotcontain):
        """Sets the shouldnotcontain of this HttpAttributesBase.

        Target site should NOT contain this string. Note! This parameter cannot be used together with the parameter “shouldcontain”, use only one of them in your request.  # noqa: E501

        :param shouldnotcontain: The shouldnotcontain of this HttpAttributesBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def postdata(self):
        """Gets the postdata of this HttpAttributesBase.  # noqa: E501

        Data that should be posted to the web page, for example submission data for a sign-up or login form. The data needs to be formatted in the same way as a web browser would send it to the web server  # noqa: E501

        :return: The postdata of this HttpAttributesBase.  # noqa: E501
        :rtype: str
        """
    ...
    def postdata(self, postdata):
        """Sets the postdata of this HttpAttributesBase.

        Data that should be posted to the web page, for example submission data for a sign-up or login form. The data needs to be formatted in the same way as a web browser would send it to the web server  # noqa: E501

        :param postdata: The postdata of this HttpAttributesBase.  # noqa: E501
        :type: str
        """
    ...
    def requestheaders(self):
        """Gets the requestheaders of this HttpAttributesBase.  # noqa: E501

        Custom HTTP header. The entry value should contain a one-element string array. The element should contain `headerName` and `headerValue` colon-separated. To add more than one header send other parameters named `requestheaders{number}`.  # noqa: E501

        :return: The requestheaders of this HttpAttributesBase.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def requestheaders(self, requestheaders):
        """Sets the requestheaders of this HttpAttributesBase.

        Custom HTTP header. The entry value should contain a one-element string array. The element should contain `headerName` and `headerValue` colon-separated. To add more than one header send other parameters named `requestheaders{number}`.  # noqa: E501

        :param requestheaders: The requestheaders of this HttpAttributesBase.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HttpAttributesBase, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HttpAttributesBase):
            return False
