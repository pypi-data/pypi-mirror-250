...
class SingleApi(object):
    ...
    def single_get(self, **kwargs):  # noqa: E501
        """Performs a single check.  # noqa: E501

        Performs a single test using a specified Pingdom probe against a specified target. Please note that this method is meant to be used sparingly, not to set up your own monitoring solution.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.single_get(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param QueryParameters query_parameters: Query Parameters to chose
        :return: SingleResp
        ...
        if kwargs.get('async_req'):
            return self.single_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.single_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def single_get_with_http_info(self, **kwargs):  # noqa: E501
        """Performs a single check.  # noqa: E501

        Performs a single test using a specified Pingdom probe against a specified target. Please note that this method is meant to be used sparingly, not to set up your own monitoring solution.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.single_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['query_parameters', 'host', 'type']  # noqa: E501
        ...
        query_params = []
        if 'query_parameters' in params:
            query_params.append(('Query Parameters', params['query_parameters']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='SingleResp',  # noqa: E501
