...
class SummaryAverageApi(object):
    ...
    def summary_average_checkid_get(self, checkid, **kwargs):  # noqa: E501
        """Get the average time/uptime value for a specified  # noqa: E501

        Get the average time / uptime value for a specified check and time period.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.summary_average_checkid_get(checkid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SummaryAverageCheckid checkid: (required)
        :param SummaryAverageFrom _from: Start time of period. Format is UNIX timestamp
        :param SummaryAverageTo to: End time of period. Format is UNIX timestamp. Default is the current time
        :param SummaryAverageProbes probes: Filter to only use results from a list of probes. Format is a comma separated list of probe identifiers. By default result from all probes are shown.
        :param SummaryAverageIncludeuptime includeuptime: Include uptime information
        :param SummaryAverageBycountry bycountry: Split response times into country groups
        :param SummaryAverageByprobe byprobe: Split response times into probe groups
        ...
        if kwargs.get('async_req'):
            return self.summary_average_checkid_get_with_http_info(checkid, **kwargs)  # noqa: E501
        else:
            (data) = self.summary_average_checkid_get_with_http_info(checkid, **kwargs)  # noqa: E501
            return data

    def summary_average_checkid_get_with_http_info(self, checkid, **kwargs):  # noqa: E501
        """Get the average time/uptime value for a specified  # noqa: E501

        Get the average time / uptime value for a specified check and time period.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.summary_average_checkid_get_with_http_info(checkid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['checkid', '_from', 'to', 'probes', 'includeuptime', 'bycountry', 'byprobe']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method summary_average_checkid_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('checkid' not in params or
            ...
            raise ValueError("Missing the required parameter `checkid` when calling `summary_average_checkid_get`")  # noqa: E501
        ...
        if 'bycountry' in params:
            query_params.append(('bycountry', params['bycountry']))  # noqa: E501
        if 'byprobe' in params:
            query_params.append(('byprobe', params['byprobe']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='SummaryRespAttrs',  # noqa: E501
