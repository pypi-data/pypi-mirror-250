...
class SummaryOutageApi(object):
    ...
    def summary_outage_checkid_get(self, checkid, **kwargs):  # noqa: E501
        """Get a list of status changes for a specified check  # noqa: E501

        Get a list of status changes for a specified check and time period. If order is speficied to descending, the list is ordered by newest first. (Default is ordered by oldest first.)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.summary_outage_checkid_get(checkid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SummaryOutageCheckid checkid: (required)
        :param SummaryOutageFrom _from: Start time of period. Format is UNIX timestamp. Default value is one week earlier than `to`.
        :param SummaryOutageTo to: End time of period. Format is UNIX timestamp. Default value is the current time.
        :param SummaryOutageOrder order: Sorting order of outages. Ascending or descending.
        ...
        if kwargs.get('async_req'):
            return self.summary_outage_checkid_get_with_http_info(checkid, **kwargs)  # noqa: E501
        else:
            (data) = self.summary_outage_checkid_get_with_http_info(checkid, **kwargs)  # noqa: E501
            return data

    def summary_outage_checkid_get_with_http_info(self, checkid, **kwargs):  # noqa: E501
        """Get a list of status changes for a specified check  # noqa: E501

        Get a list of status changes for a specified check and time period. If order is speficied to descending, the list is ordered by newest first. (Default is ordered by oldest first.)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.summary_outage_checkid_get_with_http_info(checkid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['checkid', '_from', 'to', 'order']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method summary_outage_checkid_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('checkid' not in params or
            ...
            raise ValueError("Missing the required parameter `checkid` when calling `summary_outage_checkid_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='SummaryOutageRespAttrs',  # noqa: E501
