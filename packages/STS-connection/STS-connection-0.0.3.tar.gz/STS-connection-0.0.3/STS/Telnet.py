...
class Telnet:
    def __init__(self, host,username, password,  port=23, device_name=None, device_type=None, receive_callback=None):
        self.host = host
    ...
    def login(self):
        ...
        self.send_cmd('')
        self.send_cmd(f'{self.username}\n')
        self.send_cmd(f'{self.password}\n')
