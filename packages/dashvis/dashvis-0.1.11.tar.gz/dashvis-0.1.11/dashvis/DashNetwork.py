...
- clusterByConnections (dict; optional):
    Function call. Returns nothing. This method looks at the provided
    nodes IDs and makes a cluster for all of them. The behaviour can
    be customized by proving the options object. All options of this
    object are explained below. The joinCondition is only presented
