...
if __name__ == "__main__":
    ...
    for mm in models:
        ...
        if os.path.isfile(file_model_data):
            ...
            model_data.Quench_Protection.ESC.t_trigger = [99999.0]
            model_data.Quench_Protection.ESC.U0 = [0.0]
            model_data.Quench_Protection.ESC.C = [0.0]
            model_data.Quench_Protection.ESC.R_unit = [0.0]
            model_data.Quench_Protection.ESC.R_leads = [0.0]
            model_data.Quench_Protection.ESC.Ud_Diode = [0.0]
