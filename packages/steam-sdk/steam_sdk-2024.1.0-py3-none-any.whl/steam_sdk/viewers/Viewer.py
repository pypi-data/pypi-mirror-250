...
class Viewer:
    ...
    def plot_signal(self, event_label: str, meas_label: str, sim_label: str, fig_options: dict, flag_display: bool = True, full_path_figure_to_save: str = None, figure_types: Union[List[str], str] = 'png'):
        ...
        # if fig_range_x_relative_to_t_PC_off and measurement_signal_time_shift is specified, this intervall is used to zoom around the x axis
        if (len(fig_range_x_relative_to_t_PC_off) == 2 and 'measurement_signal_time_shift' in self.dict_events and
                all(item is not None for item in fig_range_x_relative_to_t_PC_off)):
            t_PC_off = self.dict_events['measurement_signal_time_shift']
