...
from steam_sdk.analyses.AnalysisEvent import find_n_magnets_in_circuit, find_IPQ_circuit_type_from_IPQ_parameters_table, \
    ...
    get_t_PC_off_from_PSPICE_netlist_data
...
class TestAnalysisEvent(unittest.TestCase):
    ...
    def test_get_circuit_type(self):
        ...
        library_path = os.path.join(os.getcwd(),"input","dummy_circuit_library")

        test_scenarios = [
            {'circuit_name': "RCBH123", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RCB"},
            {'circuit_name': "RD123", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RD1"},
            {'circuit_name': "RQX123", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RQX"},
            {'circuit_name': "RQ4.ABC", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RQ4"},
            {'circuit_name': "RQT12.ABCD", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RQT_12_13"},
            {'circuit_name': "RQTL9.ABCD", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RQTL9"},
            {'circuit_name': "RQTD.ABCD", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RQT"},
            {'circuit_name': "RQSX3.ABCD", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RQSX3"},
            {'circuit_name': "RQS.ABCD", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RQS"},
            {'circuit_name': "RCS123", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RCS"},
            {'circuit_name': "RB123", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RB"},
            {'circuit_name': "RCBX123", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RCBX"},
            {'circuit_name': "RCBC123", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RCBC"},
            {'circuit_name': "RCBY123", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RCBY"},
            {'circuit_name': "RSS123", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RSS"},
            {'circuit_name': "RQ.A23", 'library_path': library_path, 'simulation_name': None,
             'target_circuit_type': "RQ_51magnets"},
            {'circuit_name': "RCD123", 'library_path': library_path, 'simulation_name': "RCD",
             'target_circuit_type': "RCD"},
            {'circuit_name': "RCO123", 'library_path': library_path, 'simulation_name': "RCO",
             'target_circuit_type': "RCO"}
        ]
        ...
        for scenario in test_scenarios:
            ...
            # Act
            circuit_type = get_circuit_type(circuit_name, library_path, simulation_name)

            # Assert
            self.assertEqual(circuit_type, target_circuit_type)
            print(f"Checked circuit name: {circuit_name}, with library path {library_path}, and simulation name {simulation_name}")
