...
class _Function(modal.object._Object):
    ...
    def from_parametrized(self, obj, from_other_workspace: bool, args: typing.Iterable[typing.Any], kwargs: typing.Dict[str, typing.Any]) -> _Function:
        ...
...
class Function(modal.object.Object):
    ...
    def from_parametrized(self, obj, from_other_workspace: bool, args: typing.Iterable[typing.Any], kwargs: typing.Dict[str, typing.Any]) -> Function:
        ...
