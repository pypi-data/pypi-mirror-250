...
class _Cls(modal.object._Object):
    ...
    @classmethod
    def from_name(cls: typing.Type[_Cls], app_name: str, tag: typing.Union[str, None] = None, namespace=1, environment_name: typing.Union[str, None] = None) -> _Cls:
        ...

    @classmethod
    async def lookup(cls: typing.Type[_Cls], app_name: str, tag: typing.Union[str, None] = None, namespace=1, client: typing.Union[modal.client._Client, None] = None, environment_name: typing.Union[str, None] = None) -> _Cls:
        ...
...
class Cls(modal.object.Object):
    ...
    @classmethod
    def from_name(cls: typing.Type[Cls], app_name: str, tag: typing.Union[str, None] = None, namespace=1, environment_name: typing.Union[str, None] = None) -> Cls:
        ...

    @classmethod
    def lookup(cls: typing.Type[Cls], app_name: str, tag: typing.Union[str, None] = None, namespace=1, client: typing.Union[modal.client.Client, None] = None, environment_name: typing.Union[str, None] = None) -> Cls:
        ...
