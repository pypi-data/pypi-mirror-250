...
import database.hbase.thrift_hbase.ttypes
import logging
import sys
from thrift.transport import TTransport
from typing import Any, Callable, Dict, List, Never, Optional, Tuple, Type

TAppend: Type[database.hbase.thrift_hbase.ttypes.TAppend]
TApplicationException: Any
TAuthorization: Type[database.hbase.thrift_hbase.ttypes.TAuthorization]
TBloomFilterType: Type[database.hbase.thrift_hbase.ttypes.TBloomFilterType]
TCellVisibility: Type[database.hbase.thrift_hbase.ttypes.TCellVisibility]
TColumn: Type[database.hbase.thrift_hbase.ttypes.TColumn]
TColumnFamilyDescriptor: Type[database.hbase.thrift_hbase.ttypes.TColumnFamilyDescriptor]
TColumnIncrement: Type[database.hbase.thrift_hbase.ttypes.TColumnIncrement]
TColumnValue: Type[database.hbase.thrift_hbase.ttypes.TColumnValue]
TCompareOperator: Type[database.hbase.thrift_hbase.ttypes.TCompareOperator]
TCompressionAlgorithm: Type[database.hbase.thrift_hbase.ttypes.TCompressionAlgorithm]
TConsistency: Type[database.hbase.thrift_hbase.ttypes.TConsistency]
TDataBlockEncoding: Type[database.hbase.thrift_hbase.ttypes.TDataBlockEncoding]
TDelete: Type[database.hbase.thrift_hbase.ttypes.TDelete]
TDeleteType: Type[database.hbase.thrift_hbase.ttypes.TDeleteType]
TDurability: Type[database.hbase.thrift_hbase.ttypes.TDurability]
TException: Any
TFilterByOperator: Type[database.hbase.thrift_hbase.ttypes.TFilterByOperator]
TFrozenDict: Any
TGet: Type[database.hbase.thrift_hbase.ttypes.TGet]
THRegionInfo: Type[database.hbase.thrift_hbase.ttypes.THRegionInfo]
THRegionLocation: Type[database.hbase.thrift_hbase.ttypes.THRegionLocation]
TIOError: Type[database.hbase.thrift_hbase.ttypes.TIOError]
TIllegalArgument: Type[database.hbase.thrift_hbase.ttypes.TIllegalArgument]
TIncrement: Type[database.hbase.thrift_hbase.ttypes.TIncrement]
TKeepDeletedCells: Type[database.hbase.thrift_hbase.ttypes.TKeepDeletedCells]
TLogQueryFilter: Type[database.hbase.thrift_hbase.ttypes.TLogQueryFilter]
TLogType: Type[database.hbase.thrift_hbase.ttypes.TLogType]
TMessageType: Any
TMutation: Type[database.hbase.thrift_hbase.ttypes.TMutation]
TNamespaceDescriptor: Type[database.hbase.thrift_hbase.ttypes.TNamespaceDescriptor]
TOnlineLogRecord: Type[database.hbase.thrift_hbase.ttypes.TOnlineLogRecord]
TProcessor: Any
TProtocolException: Any
TPut: Type[database.hbase.thrift_hbase.ttypes.TPut]
TReadType: Type[database.hbase.thrift_hbase.ttypes.TReadType]
TResult: Type[database.hbase.thrift_hbase.ttypes.TResult]
TRowMutations: Type[database.hbase.thrift_hbase.ttypes.TRowMutations]
TScan: Type[database.hbase.thrift_hbase.ttypes.TScan]
TServerName: Type[database.hbase.thrift_hbase.ttypes.TServerName]
TTableDescriptor: Type[database.hbase.thrift_hbase.ttypes.TTableDescriptor]
TTableName: Type[database.hbase.thrift_hbase.ttypes.TTableName]
TThriftServerType: Type[database.hbase.thrift_hbase.ttypes.TThriftServerType]
TTimeRange: Type[database.hbase.thrift_hbase.ttypes.TTimeRange]
TType: Any
all_structs: Any
fix_spec: Any
...
class Client(Iface):
    ...
    def recv_append(self) -> database.hbase.thrift_hbase.ttypes.TResult: ...
    ...
    def recv_deleteMultiple(self) -> List[database.hbase.thrift_hbase.ttypes.TDelete]: ...
    ...
    def recv_get(self) -> database.hbase.thrift_hbase.ttypes.TResult: ...
    def recv_getAllRegionLocations(self) -> List[database.hbase.thrift_hbase.ttypes.THRegionLocation]: ...
    def recv_getClusterId(self) -> Any: ...
    def recv_getMultiple(self) -> List[database.hbase.thrift_hbase.ttypes.TResult]: ...
    def recv_getNamespaceDescriptor(self) -> database.hbase.thrift_hbase.ttypes.TNamespaceDescriptor: ...
    def recv_getRegionLocation(self) -> database.hbase.thrift_hbase.ttypes.THRegionLocation: ...
    def recv_getScannerResults(self) -> List[database.hbase.thrift_hbase.ttypes.TResult]: ...
    def recv_getScannerRows(self) -> List[database.hbase.thrift_hbase.ttypes.TResult]: ...
    def recv_getSlowLogResponses(self) -> List[database.hbase.thrift_hbase.ttypes.TOnlineLogRecord]: ...
    def recv_getTableDescriptor(self) -> database.hbase.thrift_hbase.ttypes.TTableDescriptor: ...
    def recv_getTableDescriptors(self) -> List[database.hbase.thrift_hbase.ttypes.TTableDescriptor]: ...
    def recv_getTableDescriptorsByNamespace(self) -> List[database.hbase.thrift_hbase.ttypes.TTableDescriptor]: ...
    def recv_getTableDescriptorsByPattern(self) -> List[database.hbase.thrift_hbase.ttypes.TTableDescriptor]: ...
    def recv_getTableNamesByNamespace(self) -> List[database.hbase.thrift_hbase.ttypes.TTableName]: ...
    def recv_getTableNamesByPattern(self) -> List[database.hbase.thrift_hbase.ttypes.TTableName]: ...
    def recv_getThriftServerType(self) -> Any: ...
    def recv_increment(self) -> database.hbase.thrift_hbase.ttypes.TResult: ...
    ...
    def recv_listNamespaceDescriptors(self) -> List[database.hbase.thrift_hbase.ttypes.TNamespaceDescriptor]: ...
...
class addColumnFamily_args:
    ...
    column: Any
    tableName: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TTableName]]], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TColumnFamilyDescriptor]]], None]]
...
class addColumnFamily_result:
    __doc__: str
    io: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
...
class append_args:
    ...
    table: Any
    tappend: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, str, None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TAppend]]], None]]
    def __eq__(self, other) -> bool: ...
...
class append_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TResult]]], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
...
class checkAndDelete_args:
    ...
    table: Any
    tdelete: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, str, None], Tuple[int, Any, str, str, None], Tuple[int, Any, str, str, None], Tuple[int, Any, str, str, None], Tuple[int, Any, str, str, None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TDelete]]], None]]
    value: Any
    def __eq__(self, other) -> bool: ...
...
class checkAndDelete_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, None, None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
    def __init__(self, success = ..., io = ...) -> None: ...
    def __ne__(self, other) -> bool: ...
    def __repr__(self) -> str: ...
...
class checkAndMutate_args:
    ...
    rowMutations: Any
    table: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, str, None], Tuple[int, Any, str, str, None], Tuple[int, Any, str, str, None], Tuple[int, Any, str, str, None], Tuple[int, Any, str, None, None], Tuple[int, Any, str, str, None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TRowMutations]]], None]]
    value: Any
    def __eq__(self, other) -> bool: ...
...
class checkAndPut_args:
    ...
    row: Any
    table: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, str, None], Tuple[int, Any, str, str, None], Tuple[int, Any, str, str, None], Tuple[int, Any, str, str, None], Tuple[int, Any, str, str, None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TPut]]], None]]
    tput: Any
    value: Any
    def __eq__(self, other) -> bool: ...
...
class clearSlowLogResponses_args:
    __doc__: str
    serverNames: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, Tuple[Any, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TServerName]]], bool], None]]
    def __eq__(self, other) -> bool: ...
...
class clearSlowLogResponses_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, Tuple[Any, None, bool], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
    def __init__(self, success = ..., io = ...) -> None: ...
    def __ne__(self, other) -> bool: ...
    def __repr__(self) -> str: ...
...
class closeScanner_result:
    ...
    ia: Any
    io: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIllegalArgument]]], None]]
    def __eq__(self, other) -> bool: ...
...
class createNamespace_args:
    __doc__: str
    namespaceDesc: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TNamespaceDescriptor]]], None]]
    def __eq__(self, other) -> bool: ...
...
class createTable_args:
    ...
    desc: Any
    splitKeys: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TTableDescriptor]]], None], Tuple[int, Any, str, Tuple[Any, str, bool], None]]
    def __eq__(self, other) -> bool: ...
...
class deleteColumnFamily_args:
    ...
    column: Any
    tableName: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TTableName]]], None], Tuple[int, Any, str, str, None]]
    def __eq__(self, other) -> bool: ...
    def __init__(self, tableName = ..., column = ...) -> None: ...
    def __ne__(self, other) -> bool: ...
    def __repr__(self) -> str: ...
...
class deleteMultiple_args:
    ...
    table: Any
    tdeletes: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, str, None], Tuple[int, Any, str, Tuple[Any, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TDelete]]], bool], None]]
    def __eq__(self, other) -> bool: ...
...
class deleteMultiple_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, Tuple[Any, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TDelete]]], bool], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
    def __init__(self, success = ..., io = ...) -> None: ...
    def __ne__(self, other) -> bool: ...
    def __repr__(self) -> str: ...
...
class deleteSingle_args:
    ...
    table: Any
    tdelete: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, str, None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TDelete]]], None]]
    def __eq__(self, other) -> bool: ...
...
class deleteTable_args:
    __doc__: str
    tableName: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TTableName]]], None]]
    def __eq__(self, other) -> bool: ...
...
class existsAll_args:
    ...
    table: Any
    tgets: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, str, None], Tuple[int, Any, str, Tuple[Any, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TGet]]], bool], None]]
    def __eq__(self, other) -> bool: ...
...
class exists_args:
    ...
    table: Any
    tget: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, str, None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TGet]]], None]]
    def __eq__(self, other) -> bool: ...
...
class getAllRegionLocations_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, Tuple[Any, List[Optional[Type[database.hbase.thrift_hbase.ttypes.THRegionLocation]]], bool], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
    def __init__(self, success = ..., io = ...) -> None: ...
    def __ne__(self, other) -> bool: ...
    def __repr__(self) -> str: ...
...
class getMultiple_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, Tuple[Any, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TResult]]], bool], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
    def __init__(self, success = ..., io = ...) -> None: ...
    def __ne__(self, other) -> bool: ...
    def __repr__(self) -> str: ...
...
class getNamespaceDescriptor_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TNamespaceDescriptor]]], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
    def __init__(self, success = ..., io = ...) -> None: ...
    def __ne__(self, other) -> bool: ...
    def __repr__(self) -> str: ...
...
class getRegionLocation_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.THRegionLocation]]], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
    def __init__(self, success = ..., io = ...) -> None: ...
    def __ne__(self, other) -> bool: ...
    def __repr__(self) -> str: ...
...
class getScannerResults_args:
    ...
    numRows: Any
    table: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, str, None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TScan]]], None], Tuple[int, Any, str, None, int]]
    tscan: Any
    def __eq__(self, other) -> bool: ...
...
class getScannerRows_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, Tuple[Any, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TResult]]], bool], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIllegalArgument]]], None]]
    def __eq__(self, other) -> bool: ...
...
class getSlowLogResponses_args:
    ...
    logQueryFilter: Any
    serverNames: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, Tuple[Any, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TServerName]]], bool], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TLogQueryFilter]]], None]]
    def __eq__(self, other) -> bool: ...
...
class getSlowLogResponses_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, Tuple[Any, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TOnlineLogRecord]]], bool], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
    def __init__(self, success = ..., io = ...) -> None: ...
    def __ne__(self, other) -> bool: ...
    def __repr__(self) -> str: ...
...
class getTableDescriptor_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TTableDescriptor]]], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
    def __init__(self, success = ..., io = ...) -> None: ...
    def __ne__(self, other) -> bool: ...
    def __repr__(self) -> str: ...
...
class getTableDescriptorsByNamespace_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, Tuple[Any, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TTableDescriptor]]], bool], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
    def __init__(self, success = ..., io = ...) -> None: ...
    def __ne__(self, other) -> bool: ...
    def __repr__(self) -> str: ...
...
class getTableDescriptors_args:
    __doc__: str
    tables: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, Tuple[Any, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TTableName]]], bool], None]]
    def __eq__(self, other) -> bool: ...
...
class getTableNamesByNamespace_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, Tuple[Any, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TTableName]]], bool], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
    def __init__(self, success = ..., io = ...) -> None: ...
    def __ne__(self, other) -> bool: ...
    def __repr__(self) -> str: ...
...
class increment_args:
    __doc__: str
    table: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, str, None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIncrement]]], None]]
    tincrement: Any
    def __eq__(self, other) -> bool: ...
...
class isTableAvailableWithSplit_args:
    ...
    splitKeys: Any
    tableName: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TTableName]]], None], Tuple[int, Any, str, Tuple[Any, str, bool], None]]
    def __eq__(self, other) -> bool: ...
...
class listNamespaceDescriptors_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, Tuple[Any, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TNamespaceDescriptor]]], bool], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
    def __init__(self, success = ..., io = ...) -> None: ...
    def __ne__(self, other) -> bool: ...
    def __repr__(self) -> str: ...
...
class listNamespaces_result:
    ...
    io: Any
    success: Any
    thrift_spec: Tuple[Tuple[int, Any, str, Tuple[Any, str, bool], None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TIOError]]], None]]
    def __eq__(self, other) -> bool: ...
    def __init__(self, success = ..., io = ...) -> None: ...
    def __ne__(self, other) -> bool: ...
    def __repr__(self) -> str: ...
...
class modifyTable_args:
    __doc__: str
    desc: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TTableDescriptor]]], None]]
    def __eq__(self, other) -> bool: ...
...
class mutateRow_args:
    __doc__: str
    table: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, str, None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TRowMutations]]], None]]
    trowMutations: Any
    def __eq__(self, other) -> bool: ...
...
class openScanner_args:
    __doc__: str
    table: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, str, None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TScan]]], None]]
    tscan: Any
    def __eq__(self, other) -> bool: ...
...
class putMultiple_args:
    __doc__: str
    table: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, str, None], Tuple[int, Any, str, Tuple[Any, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TPut]]], bool], None]]
    tputs: Any
    def __eq__(self, other) -> bool: ...
...
class put_args:
    __doc__: str
    table: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, str, None], Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TPut]]], None]]
    tput: Any
    def __eq__(self, other) -> bool: ...
...
class truncateTable_args:
    ...
    preserveSplits: Any
    tableName: Any
    thrift_spec: Tuple[None, Tuple[int, Any, str, List[Optional[Type[database.hbase.thrift_hbase.ttypes.TTableName]]], None], Tuple[int, Any, str, None, None]]
    def __eq__(self, other) -> bool: ...
