...
class MultiSubmitRulesRequest(google.protobuf.message.Message):
    ...
    @property
    def rules(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CheckSequenceRuleRequest]: ...
    def __init__(
        self,
        *,
        rules: collections.abc.Iterable[global___CheckSequenceRuleRequest] | None = ...,
    ) -> None: ...
...
class MultiSubmitRulesResponse(google.protobuf.message.Message):
    ...
    @property
    def responses(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CheckSequenceRuleResponse]: ...
    def __init__(
        self,
        *,
        responses: collections.abc.Iterable[global___CheckSequenceRuleResponse] | None = ...,
    ) -> None: ...
