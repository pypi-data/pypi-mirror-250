...
def get_class(user_query, table, column, enum, description):
    ...
    description += " " + "'"+column+"_class' column provides whether the content in the '"+column+"' column satisfies the conditions listed in the user query ('True'/'False');"
