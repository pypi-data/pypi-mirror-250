...
TV_Dropout_T = TypeVar("TV_Dropout_T", _atypes.Float32, _atypes.Float64, _atypes.Half)
TV_Dropout_Tseed = TypeVar("TV_Dropout_Tseed", _atypes.Int32, _atypes.Int64)

@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('dropout')
def dropout(input: _atypes.TensorFuzzingAnnotation[TV_Dropout_T], rate: _atypes.TensorFuzzingAnnotation[TV_Dropout_T], noise_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int32], seed1: _atypes.TensorFuzzingAnnotation[TV_Dropout_Tseed], seed2: _atypes.TensorFuzzingAnnotation[TV_Dropout_Tseed], name=None):
...
TV_DropoutGrad_T = TypeVar("TV_DropoutGrad_T", _atypes.Float32, _atypes.Float64, _atypes.Half)
...
TV_Gelu_T = TypeVar("TV_Gelu_T", _atypes.BFloat16, _atypes.Float32, _atypes.Float64, _atypes.Half)

@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('gelu')
def gelu(features: _atypes.TensorFuzzingAnnotation[TV_Gelu_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Gelu_T]:
  r"""TODO: add doc.
...
TV_GeluGrad_T = TypeVar("TV_GeluGrad_T", _atypes.BFloat16, _atypes.Float32, _atypes.Float64, _atypes.Half)
