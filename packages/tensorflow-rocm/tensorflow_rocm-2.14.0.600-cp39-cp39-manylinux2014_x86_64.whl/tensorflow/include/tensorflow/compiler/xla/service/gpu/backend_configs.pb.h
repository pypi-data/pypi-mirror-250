...
class CudnnConvBackendConfig final :
 ...
 public:
  ...
  // string call_context = 10;
  void clear_call_context();
  const std::string& call_context() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_call_context(ArgT0&& arg0, ArgT... args);
  std::string* mutable_call_context();
  PROTOBUF_NODISCARD std::string* release_call_context();
  void set_allocated_call_context(std::string* call_context);
  private:
  const std::string& _internal_call_context() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_call_context(const std::string& value);
  std::string* _internal_mutable_call_context();
  public:
...
inline void CudnnConvBackendConfig::clear_call_context() {
  _impl_.call_context_.ClearToEmpty();
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CudnnConvBackendConfig::set_call_context(ArgT0&& arg0, ArgT... args) {
 
 _impl_.call_context_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* CudnnConvBackendConfig::mutable_call_context() {
  std::string* _s = _internal_mutable_call_context();
  // @@protoc_insertion_point(field_mutable:xla.gpu.CudnnConvBackendConfig.call_context)
  return _s;
}
inline const std::string& CudnnConvBackendConfig::_internal_call_context() const {
  return _impl_.call_context_.Get();
}
inline void CudnnConvBackendConfig::_internal_set_call_context(const std::string& value) {
  
  _impl_.call_context_.Set(value, GetArenaForAllocation());
}
inline std::string* CudnnConvBackendConfig::_internal_mutable_call_context() {
  
  return _impl_.call_context_.Mutable(GetArenaForAllocation());
}
inline std::string* CudnnConvBackendConfig::release_call_context() {
  ...
  return _impl_.call_context_.Release();
}
inline void CudnnConvBackendConfig::set_allocated_call_context(std::string* call_context) {
  ...
  _impl_.call_context_.SetAllocated(call_context, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.call_context_.IsDefault()) {
    _impl_.call_context_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
