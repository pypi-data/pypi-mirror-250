...
class ConvInstructionLog final :
 ...
 public:
  ...
  uint64_t result_address() const;
  void set_result_address(uint64_t value);
  private:
  uint64_t _internal_result_address() const;
  void _internal_set_result_address(uint64_t value);
  public:
...
inline void ConvInstructionLog::clear_result_address() {
  _impl_.result_address_ = uint64_t{0u};
}
inline uint64_t ConvInstructionLog::_internal_result_address() const {
  return _impl_.result_address_;
}
inline uint64_t ConvInstructionLog::result_address() const {
  // @@protoc_insertion_point(field_get:xla.gpu.ConvInstructionLog.result_address)
  return _internal_result_address();
}
inline void ConvInstructionLog::_internal_set_result_address(uint64_t value) {
  
  _impl_.result_address_ = value;
}
inline void ConvInstructionLog::set_result_address(uint64_t value) {
  _internal_set_result_address(value);
