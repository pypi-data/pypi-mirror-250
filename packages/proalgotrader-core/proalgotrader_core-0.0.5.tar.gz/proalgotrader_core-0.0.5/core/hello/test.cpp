...
#define __Pyx_MODULE_NAME "core.hello"
extern int __pyx_module_is_main_core__hello;
int __pyx_module_is_main_core__hello = 0;
...
static const char __pyx_k_core_hello[] = "core.hello";
...
typedef struct {
  ...
  PyObject *__pyx_kp_u_core_hello;
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_kp_u_core_hello);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_kp_u_core_hello);
...
#define __pyx_kp_u_core_hello __pyx_mstate_global->__pyx_kp_u_core_hello
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_kp_u_core_hello, __pyx_k_core_hello, sizeof(__pyx_k_core_hello), 0, 1, 0, 0},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_core__hello) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_kp_u_core_hello) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
