...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "language": "c++",
        "name": "core.hello.__init__",
        "sources": [
            "core/hello/__init__.py"
        ]
    },
    "module_name": "core.hello.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__core__hello
#define __PYX_HAVE_API__core__hello
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "core.hello" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "core.hello.__init__"
extern int __pyx_module_is_main_core__hello____init__;
int __pyx_module_is_main_core__hello____init__ = 0;

/* Implementation of "core.hello" */
...
static const char __pyx_k_core_hello___init[] = "core.hello.__init__";
...
typedef struct {
  ...
  PyObject *__pyx_kp_u_core_hello___init;
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_kp_u_core_hello___init);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_kp_u_core_hello___init);
...
#define __pyx_kp_u_core_hello___init __pyx_mstate_global->__pyx_kp_u_core_hello___init
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_kp_u_core_hello___init, __pyx_k_core_hello___init, sizeof(__pyx_k_core_hello___init), 0, 1, 0, 0},
...
__Pyx_PyMODINIT_FUNC init__init__(void) { inithello(); }
#endif
__Pyx_PyMODINIT_FUNC inithello(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_hello(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_hello(); }
#endif
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_core__hello____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_kp_u_core_hello___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "core.hello")) {
      if (unlikely((PyDict_SetItemString(modules, "core.hello", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init core.hello", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init core.hello");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
