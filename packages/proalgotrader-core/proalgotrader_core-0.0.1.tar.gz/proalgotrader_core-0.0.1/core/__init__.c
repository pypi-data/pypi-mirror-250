...
typedef struct {
  ...
  PyObject *__pyx_kp_u_core___init;
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_kp_u_core___init);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_kp_u_core___init);
...
#define __pyx_kp_u_core___init __pyx_mstate_global->__pyx_kp_u_core___init
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_kp_u_core___init, __pyx_k_core___init, sizeof(__pyx_k_core___init), 0, 1, 0, 0},
...
if (!__Pyx_RefNanny) {
  ...
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_kp_u_core___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
