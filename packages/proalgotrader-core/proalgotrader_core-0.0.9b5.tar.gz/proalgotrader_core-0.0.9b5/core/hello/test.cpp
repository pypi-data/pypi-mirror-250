...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "language": "c++",
        "name": "core.hello.test",
        "sources": [
            "core/hello/test.py"
        ]
    },
    "module_name": "core.hello.test"
}
END: Cython Metadata */
...
#define __PYX_HAVE__core__hello__test
#define __PYX_HAVE_API__core__hello__test
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "core.hello.test" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "core.hello.test"
extern int __pyx_module_is_main_core__hello__test;
int __pyx_module_is_main_core__hello__test = 0;

/* Implementation of "core.hello.test" */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_core__hello__test) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "core.hello.test")) {
      if (unlikely((PyDict_SetItemString(modules, "core.hello.test", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init core.hello.test", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init core.hello.test");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
