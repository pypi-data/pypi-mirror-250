...
class ResourceRouter(fastapi.APIRouter, Generic[R]):
    ...
    @classmethod
    def with_model(cls, app: fastapi.FastAPI, model: type[R], **kwargs: Any) -> 'ResourceRouter[R]':
    ...
    def __init__(self, **kwargs: Any):
        ...
        self.add_api_route(
            ...
            summary=f'Create a new {model.__name__}',
    ...
    def add_to_application(self, app: fastapi.FastAPI):
