...
def main():
    ...
    for tm in range(1000):
        ...
        vect = []
        for k in range(-n, n + 1):
            dx += r[k + n][0] * cos(k * pi * tm / 1000) - r[k + n][1] * sin(k * pi * tm / 1000)
            dy += r[k + n][0] * sin(k * pi * tm / 1000) + r[k + n][1] * cos(k * pi * tm / 1000)
            vect.append((r[k + n][0] * cos(k * pi * tm / 1000) - r[k + n][1] * sin(k * pi * tm / 1000),
                         r[k + n][0] * sin(k * pi * tm / 1000) + r[k + n][1] * cos(k * pi * tm / 1000)))
        vects.append(vect)
    ...
    while True:
        ...
        for k in range(-n, n + 1):
            ...
            pygame.draw.circle(screen, (150, 150, 150), curr, 3)
            prev = curr
