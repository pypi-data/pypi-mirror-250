...
class RDatabase(object):
    ...
    def build(self) -> None:
            ...
            ### "message_send".
            {
                ...
                "fields": [
                    ...
                    },
                    {
                        ...
                        "constraint": "NOT NULL",
                        "comment": "Send state, 0 is not sent, 1 is handling, 2 is send success, 3 is send fail, 4 is send cancel."
                    },
                    {
                        "name": "send_type",
                        "type_": "varchar(8)",
                        ...
                        "comment": (
                            "Send type, "
                            "\"text\" is text message, "
                            "\"at\" is text message with \"@\", "
                            "\"file\" is file message, "
                            "\"image\" is image message, "
                            "\"emoticon\" is emoticon message, "
                            "\"pat\" is pat message, "
                            "\"public\" is public account message, "
                            "\"forward\" is forward message."
                        )
                    },
                    {
                        "name": "receive_id",
                    ...
                    },
                    {
                        ...
                        "type_": "json",
                        "constraint": "NOT NULL",
                        "comment": "Send parameters, when parameter \"file_id\" exists, then download file and convert to parameter \"path\"."
                    }
                ],
                "primary": "send_id",
                "indexes": [
        ...
        ## WeChat.
        self.rrdatabase_wechat.build.build(databases, tables)
    ...
    @wrap_thread
    def from_message_send(self) -> None:
        """
    ...
    def start_all(self) -> None:
        ...
        self.to_message_send()
        self.from_message_send()