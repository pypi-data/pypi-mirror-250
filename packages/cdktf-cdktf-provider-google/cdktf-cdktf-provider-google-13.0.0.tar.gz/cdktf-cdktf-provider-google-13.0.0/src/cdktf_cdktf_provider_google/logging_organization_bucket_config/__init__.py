...
Refer to the Terraform Registry for docs: [`google_logging_organization_bucket_config`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/logging_organization_bucket_config).
'''
import abc
import builtins
import datetime
