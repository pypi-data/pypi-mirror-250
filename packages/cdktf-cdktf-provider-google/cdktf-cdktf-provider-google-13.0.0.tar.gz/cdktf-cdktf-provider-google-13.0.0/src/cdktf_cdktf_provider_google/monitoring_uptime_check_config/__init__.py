...
Refer to the Terraform Registry for docs: [`google_monitoring_uptime_check_config`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/monitoring_uptime_check_config).
'''
import abc
import builtins
import datetime
