...
Refer to the Terraform Registry for docs: [`google_iam_workforce_pool`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/iam_workforce_pool).
'''
import abc
import builtins
import datetime
