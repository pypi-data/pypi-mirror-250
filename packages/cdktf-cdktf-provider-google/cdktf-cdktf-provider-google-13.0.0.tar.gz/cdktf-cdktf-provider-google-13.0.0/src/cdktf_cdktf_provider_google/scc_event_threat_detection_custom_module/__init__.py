...
Refer to the Terraform Registry for docs: [`google_scc_event_threat_detection_custom_module`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/scc_event_threat_detection_custom_module).
'''
import abc
import builtins
import datetime
