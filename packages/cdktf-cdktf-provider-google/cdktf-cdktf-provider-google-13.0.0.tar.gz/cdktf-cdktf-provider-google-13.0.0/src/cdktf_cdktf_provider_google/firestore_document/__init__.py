...
Refer to the Terraform Registry for docs: [`google_firestore_document`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/firestore_document).
'''
import abc
import builtins
import datetime
