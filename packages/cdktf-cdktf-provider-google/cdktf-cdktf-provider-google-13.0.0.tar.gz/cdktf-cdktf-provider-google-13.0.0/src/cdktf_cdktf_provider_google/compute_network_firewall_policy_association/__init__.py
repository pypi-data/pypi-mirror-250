...
Refer to the Terraform Registry for docs: [`google_compute_network_firewall_policy_association`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/compute_network_firewall_policy_association).
'''
import abc
import builtins
import datetime
