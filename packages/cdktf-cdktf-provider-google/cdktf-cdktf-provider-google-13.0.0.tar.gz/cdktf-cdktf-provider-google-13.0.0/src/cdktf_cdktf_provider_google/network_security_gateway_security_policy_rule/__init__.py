...
Refer to the Terraform Registry for docs: [`google_network_security_gateway_security_policy_rule`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/network_security_gateway_security_policy_rule).
'''
import abc
import builtins
import datetime
