...
Refer to the Terraform Registry for docs: [`google_identity_platform_oauth_idp_config`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/identity_platform_oauth_idp_config).
'''
import abc
import builtins
import datetime
