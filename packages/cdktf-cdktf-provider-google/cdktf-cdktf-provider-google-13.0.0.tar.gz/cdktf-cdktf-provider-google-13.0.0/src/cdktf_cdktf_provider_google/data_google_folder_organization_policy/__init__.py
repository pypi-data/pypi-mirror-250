...
Refer to the Terraform Registry for docs: [`data_google_folder_organization_policy`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/data-sources/folder_organization_policy).
'''
import abc
import builtins
import datetime
