...
Refer to the Terraform Registry for docs: [`data_google_monitoring_istio_canonical_service`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/data-sources/monitoring_istio_canonical_service).
'''
import abc
import builtins
import datetime
