...
Refer to the Terraform Registry for docs: [`google_beyondcorp_app_connector`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/beyondcorp_app_connector).
'''
import abc
import builtins
import datetime
