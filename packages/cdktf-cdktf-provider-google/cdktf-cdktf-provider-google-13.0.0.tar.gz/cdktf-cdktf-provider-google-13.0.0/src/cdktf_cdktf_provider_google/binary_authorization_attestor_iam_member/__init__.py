...
Refer to the Terraform Registry for docs: [`google_binary_authorization_attestor_iam_member`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/binary_authorization_attestor_iam_member).
'''
import abc
import builtins
import datetime
