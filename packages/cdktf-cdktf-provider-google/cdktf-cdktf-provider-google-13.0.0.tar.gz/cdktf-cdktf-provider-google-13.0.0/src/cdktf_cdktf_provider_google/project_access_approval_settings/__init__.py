...
Refer to the Terraform Registry for docs: [`google_project_access_approval_settings`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/project_access_approval_settings).
'''
import abc
import builtins
import datetime
