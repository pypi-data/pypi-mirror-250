...
Refer to the Terraform Registry for docs: [`data_google_pubsub_topic`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/data-sources/pubsub_topic).
'''
import abc
import builtins
import datetime
