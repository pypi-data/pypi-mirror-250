...
Refer to the Terraform Registry for docs: [`data_google_artifact_registry_repository`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/data-sources/artifact_registry_repository).
'''
import abc
import builtins
import datetime
