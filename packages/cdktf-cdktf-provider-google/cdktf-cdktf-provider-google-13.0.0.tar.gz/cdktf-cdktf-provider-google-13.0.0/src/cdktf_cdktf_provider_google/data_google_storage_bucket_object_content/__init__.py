...
Refer to the Terraform Registry for docs: [`data_google_storage_bucket_object_content`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/data-sources/storage_bucket_object_content).
'''
import abc
import builtins
import datetime
