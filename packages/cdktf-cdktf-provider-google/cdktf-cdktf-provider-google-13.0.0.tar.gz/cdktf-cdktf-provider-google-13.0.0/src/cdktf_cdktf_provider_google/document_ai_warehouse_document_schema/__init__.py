...
Refer to the Terraform Registry for docs: [`google_document_ai_warehouse_document_schema`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/document_ai_warehouse_document_schema).
'''
import abc
import builtins
import datetime
