...
Refer to the Terraform Registry for docs: [`google_storage_default_object_access_control`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/storage_default_object_access_control).
'''
import abc
import builtins
import datetime
