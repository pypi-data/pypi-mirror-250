...
Refer to the Terraform Registry for docs: [`google_integration_connectors_connection`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/integration_connectors_connection).
'''
import abc
import builtins
import datetime
