...
Refer to the Terraform Registry for docs: [`google_service_networking_peered_dns_domain`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/service_networking_peered_dns_domain).
'''
import abc
import builtins
import datetime
