...
Refer to the Terraform Registry for docs: [`google_vmwareengine_network_peering`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/vmwareengine_network_peering).
'''
import abc
import builtins
import datetime
