...
Refer to the Terraform Registry for docs: [`google_certificate_manager_certificate_map`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/certificate_manager_certificate_map).
'''
import abc
import builtins
import datetime
