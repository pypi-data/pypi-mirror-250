...
Refer to the Terraform Registry for docs: [`google_os_config_patch_deployment`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/os_config_patch_deployment).
'''
import abc
import builtins
import datetime
