...
Refer to the Terraform Registry for docs: [`google_dns_managed_zone`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/dns_managed_zone).
'''
import abc
import builtins
import datetime
