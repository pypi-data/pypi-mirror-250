...
Refer to the Terraform Registry for docs: [`data_google_privateca_certificate_authority`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/data-sources/privateca_certificate_authority).
'''
import abc
import builtins
import datetime
