...
Refer to the Terraform Registry for docs: [`google_org_policy_policy`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/org_policy_policy).
'''
import abc
import builtins
import datetime
