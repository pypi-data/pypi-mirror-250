...
Refer to the Terraform Registry for docs: [`google_endpoints_service_consumers_iam_policy`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/endpoints_service_consumers_iam_policy).
'''
import abc
import builtins
import datetime
