...
Refer to the Terraform Registry for docs: [`google_iam_access_boundary_policy`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/iam_access_boundary_policy).
'''
import abc
import builtins
import datetime
