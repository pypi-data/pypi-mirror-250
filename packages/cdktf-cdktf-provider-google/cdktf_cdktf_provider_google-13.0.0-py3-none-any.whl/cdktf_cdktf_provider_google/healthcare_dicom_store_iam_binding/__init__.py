...
Refer to the Terraform Registry for docs: [`google_healthcare_dicom_store_iam_binding`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/healthcare_dicom_store_iam_binding).
'''
import abc
import builtins
import datetime
