...
Refer to the Terraform Registry for docs: [`data_google_vertex_ai_index`](https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/data-sources/vertex_ai_index).
'''
import abc
import builtins
import datetime
