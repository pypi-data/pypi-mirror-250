...
def add_ml_job(
    ...
    executor_method_schema = ExecutorMethodName[
        executor_version_obj.executor_version_from_name_version.executor_method_schema_name
    ].value
    ...
    for model_methods_schemas in models_methods_schemas:
        ...
        for model_methods_schema in model_methods_schemas["listModelMethodSchemas"]:
            list_model_params.append(
                {
                    model_methods_schema["schemaName"]: _generate_fake_schema(
                        json.loads(model_methods_schema["jsonSchema"])
                    )
                }
            )
