...
T = TypeVar("T", bound="ListProjectListsResponse200")


@_attrs_define
class ListProjectListsResponse200:
    """
    Attributes:
        next_ (Union[None, Unset, str]):
        previous (Union[None, Unset, str]):
        results (Union[Unset, List['ProjectList']]):
    """

    next_: Union[None, Unset, str] = UNSET
    previous: Union[None, Unset, str] = UNSET
    results: Union[Unset, List["ProjectList"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            results_item = ProjectList.from_dict(results_item_data)

            results.append(results_item)

        list_project_lists_response_200 = cls(
            next_=next_,
            previous=previous,
            results=results,
        )

        list_project_lists_response_200.additional_properties = d
        return list_project_lists_response_200
