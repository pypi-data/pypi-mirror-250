...
T = TypeVar("T", bound="ListPromptsResponse200")


@_attrs_define
class ListPromptsResponse200:
    """
    Attributes:
        next_ (Union[None, Unset, str]):
        previous (Union[None, Unset, str]):
        results (Union[Unset, List['Prompt']]):
    """

    next_: Union[None, Unset, str] = UNSET
    previous: Union[None, Unset, str] = UNSET
    results: Union[Unset, List["Prompt"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_prompts_response_200 = cls(
            next_=next_,
            previous=previous,
            results=results,
        )

        list_prompts_response_200.additional_properties = d
        return list_prompts_response_200
