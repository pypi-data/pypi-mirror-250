...
from zerocs.utils import GetClusterRpcProxy, ZeroProxy
...
if __name__ == '__main__':
    ...
    parser.add_argument('--MONGODB_CONFIG', '-MONGODB_CONFIG', help='MONGODB_CONFIG')

    args = parser.parse_args()
    config_obj = {
        "RABBITMQ_CONFIG": args.RABBITMQ_CONFIG,
        "LOGS_PATH": args.LOGS_PATH,
        "MONGODB_CONFIG": args.MONGODB_CONFIG
    }

    Config.set_configs(config_obj)
    ...
    func = WorkBuild.build(func=module.WorkFunction, rabbitmq_config=config_obj.get('RABBITMQ_CONFIG'))
