...
################################################################################## SPLIT PART #####################################################################################################
    ...
    if args.csv_first_train is None and args.csv_first_test is None:
...
def cml():
    ...
    split_group.add_argument('--csv', type=str, help='CSV with columns surf,class')
    split_group.add_argument('--csv_first_train', type=str, help='CSV with column surf', default=None)
    split_group.add_argument('--csv_first_test', type=str, help='CSV with column surf', default=None)
    ...
    train_group.add_argument('--csv_train', type=str, help='CSV with column surf', default=None)
    train_group.add_argument('--csv_valid', type=str, help='CSV with column surf', default=None)
    train_group.add_argument('--csv_test', type=str, help='CSV with column surf', default=None)
    ...
    if not ((args.csv is not None) ^ (args.csv_first_train is not None and args.csv_first_test is not None)):
        parser.error('Either --csv or both --csv_first_train and --csv_first_test must be provided, but not both.')
