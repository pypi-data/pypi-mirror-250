...
df = pd.read_excel("F:/0 - Bibliotecas Windows/Downloads/sem_erro_estudo_Opiliones.xlsx")
...
nome_taxon_usuario = 'Stygnoplus tapirapeco'
resultado = verificar_taxon(nome_taxon_usuario, 4)
pprint(resultado)
