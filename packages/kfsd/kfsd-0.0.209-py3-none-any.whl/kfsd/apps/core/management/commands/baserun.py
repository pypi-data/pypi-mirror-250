...
from kfsd.apps.endpoints.serializers.auth.user import UserModelSerializer
from kfsd.apps.endpoints.serializers.auth.org import OrgModelSerializer
from kfsd.apps.endpoints.serializers.auth.team import TeamModelSerializer
from kfsd.apps.endpoints.serializers.auth.role import RoleModelSerializer
from kfsd.apps.endpoints.serializers.auth.apikey import APIKeyModelSerializer
from kfsd.apps.endpoints.serializers.auth.access import AccessModelSerializer
from kfsd.apps.endpoints.serializers.auth.plan import PlanModelSerializer
from kfsd.apps.endpoints.serializers.auth.service import ServiceModelSerializer
...
class Command(BaseCommand):
    ...
    def getBaseSerializers(self):
        return {
            "models.user": UserModelSerializer,
            "models.org": OrgModelSerializer,
            "models.team": TeamModelSerializer,
            "models.role": RoleModelSerializer,
            "models.apikey": APIKeyModelSerializer,
            "models.access": AccessModelSerializer,
            "models.plan": PlanModelSerializer,
            "models.service": ServiceModelSerializer,
