...
Refer to the Terraform Registry for docs: [`newrelic_application_settings`](https://registry.terraform.io/providers/newrelic/newrelic/3.28.1/docs/resources/application_settings).
'''
import abc
import builtins
import datetime
