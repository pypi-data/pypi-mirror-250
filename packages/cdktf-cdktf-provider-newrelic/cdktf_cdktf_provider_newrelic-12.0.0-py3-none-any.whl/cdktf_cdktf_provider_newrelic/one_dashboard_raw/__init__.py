...
Refer to the Terraform Registry for docs: [`newrelic_one_dashboard_raw`](https://registry.terraform.io/providers/newrelic/newrelic/3.28.1/docs/resources/one_dashboard_raw).
'''
import abc
import builtins
import datetime
