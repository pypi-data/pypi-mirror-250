...
Refer to the Terraform Registry for docs: [`newrelic_events_to_metrics_rule`](https://registry.terraform.io/providers/newrelic/newrelic/3.28.1/docs/resources/events_to_metrics_rule).
'''
import abc
import builtins
import datetime
