...
Refer to the Terraform Registry for docs: [`newrelic_alert_condition`](https://registry.terraform.io/providers/newrelic/newrelic/3.28.1/docs/resources/alert_condition).
'''
import abc
import builtins
import datetime
...
class AlertCondition(
    ...
    def __init__(
        ...
        *,
        ...
        :param type: The type of condition. One of: (apm_jvm_metric, apm_kt_metric, browser_metric, mobile_metric, servers_metric, apm_app_metric). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.28.1/docs/resources/alert_condition#type AlertCondition#type}
