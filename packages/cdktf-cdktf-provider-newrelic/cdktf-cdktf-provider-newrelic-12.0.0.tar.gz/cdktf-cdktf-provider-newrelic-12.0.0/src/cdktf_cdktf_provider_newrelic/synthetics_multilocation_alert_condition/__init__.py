...
Refer to the Terraform Registry for docs: [`newrelic_synthetics_multilocation_alert_condition`](https://registry.terraform.io/providers/newrelic/newrelic/3.28.1/docs/resources/synthetics_multilocation_alert_condition).
'''
import abc
import builtins
import datetime
