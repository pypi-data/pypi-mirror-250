...
Refer to the Terraform Registry for docs: [`newrelic_synthetics_cert_check_monitor`](https://registry.terraform.io/providers/newrelic/newrelic/3.28.1/docs/resources/synthetics_cert_check_monitor).
'''
import abc
import builtins
import datetime
