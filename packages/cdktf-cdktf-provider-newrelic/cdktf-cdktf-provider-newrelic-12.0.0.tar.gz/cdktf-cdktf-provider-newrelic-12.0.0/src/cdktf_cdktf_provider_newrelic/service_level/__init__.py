...
Refer to the Terraform Registry for docs: [`newrelic_service_level`](https://registry.terraform.io/providers/newrelic/newrelic/3.28.1/docs/resources/service_level).
'''
import abc
import builtins
import datetime
