...
py -m pip install --upgrade pipreqs build twine && py -m pipreqs.pipreqs . --force && py -m build && pip uninstall textureminer -y && pip install ./dist/textureminer-0.0.0-py3-none-any.whl && textureminer -v && textureminer --help
