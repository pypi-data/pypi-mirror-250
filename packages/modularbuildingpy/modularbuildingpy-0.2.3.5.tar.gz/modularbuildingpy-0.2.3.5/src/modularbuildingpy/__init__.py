...
import os, sys, re, shutil, logging, psutil, functools, pkg_resources, warnings, requests, json, time
import numpy as np
import pandas as pd
...
class _Generate(object):
    ...
    def __init__(self, name, directory, logger, material, **kwargs):
        ...
        df = pd.read_excel(
            "./data/aisc-shapes-database-v16.0.xlsx", sheet_name="Database v16.0"
        ).set_index("Type")
