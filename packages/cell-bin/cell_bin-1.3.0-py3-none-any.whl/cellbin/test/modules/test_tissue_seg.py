...
def main(model_type="bcdu"):
    model_path = r"E:\tissue_dataset\workspace\tissueseg_bcdu_H_231110_tf.onnx"
    ...
    input_path = r"E:\tissue_dataset\workspace\src_test_big\img"
    out_path = r"E:\tissue_dataset\workspace\src_test_big\test"
    gpu = "0"
    num_threads = 0
