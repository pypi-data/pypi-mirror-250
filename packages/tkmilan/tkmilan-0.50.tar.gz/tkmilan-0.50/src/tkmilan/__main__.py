...
class NB_Child_Complex(NotebookUniform):
    ...
    def setup_tab(self, tid: str, tname: str, *, exampleExtraArg):  # type: ignore[override]
        assert exampleExtraArg == 'Extra Argument'
    ...
    def setup_tabs(self, c1: Checkbox):
        return {
            ...
            'tc': Notebook.Tab('Tab Complex', NB_Child_Complex(self,
                                                               ...
                                                               exampleExtraArg='Extra Argument',
                                                               styleID='TabCenter|TabLarge'),
...
class RW(RootWindow):
    ...
    def debugInfo(self, widget, *, parent: bool = False):
        ...
        if widget.gstate.__class__ != GuiState:
