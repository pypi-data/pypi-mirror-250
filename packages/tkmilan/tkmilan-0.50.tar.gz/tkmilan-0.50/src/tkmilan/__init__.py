...
class RootWindow(tk.Tk, mixin.ContainerWidget):
    ...
    def __setstyle_checkbox_ro(self):
        ...
        if __debug__:
            ...
            assert 'embossed' in root_map, f'.: theme has no `embossed` settings:: map={root_map}'
...
class FrameStateful(ttk.LabelFrame, mixin.ContainerWidget):
    ...
    def __init__(self, parent: mixin.ContainerWidget, *args,
                 ...
                 cstateReadonly: bool = False, cstateArgs: typing.Optional[typing.Mapping[str, typing.Any]] = None,
                 styleID: typing.Optional[str] = None,
                 **kwargs):
...
class RadioFrame(FrameLabelled):
    ...
    See Also:
        ...
        features.
    '''
    # TODO: Support external variable?
    wstate_single = 'raw'
    '''Default value for `wstate_single <mixin.MixinStateContainer.wstate_single>`.'''
    ...
    class RadioFrame_Raw(FrameUnlabelled):
        '''Internal `RadioFrame` widget definition.
    ...
    def setup_widgets(self, stateRadio: validation.StaticMap, *,
        ...
        self.raw = self.RadioFrame_Raw(self, stateRadio=stateRadio, w_radio=self.__w_radio,
                                       **(frameArgs or {}))
