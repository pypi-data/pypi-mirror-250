                ...
                return Entity.deserialize(
                    entity_def,
                    {
                        **{
                            ...
                            "_updated": results[0]["updated_at"].isoformat()
                            if results[0]["updated_at"]
                            else results[0]["updated_at"],
                            "_created": results[0]["created_at"].isoformat()
                        ...
                        Entity.deserialize(
                            entity_def,
                            {
                                **{
                                    ...
                                    "_updated": result["updated_at"].isoformat()
                                    if result["updated_at"]
                                    else result["updated_at"],
                                    "_created": result["created_at"].isoformat()
                ...
                return [
                    Entity.deserialize(
                        entity_def,
                        {
                            **{
                                "identifier": r["id"],
                                "_updated": r["updated_at"].isoformat()
                                if r["updated_at"]
                                else r["updated_at"],
                                "_created": r["created_at"].isoformat()
                                if r["created_at"]
                                else r["created_at"],
                            },
                            **r["content"],
        ...
        with self.__conn.cursor() as cursor:
            ...
            cursor.execute(
                statement,
                {
                    ...
                    "from_id": relationship.ref_from.identifier
                    ...
                    "to_id": relationship.ref_to.identifier
