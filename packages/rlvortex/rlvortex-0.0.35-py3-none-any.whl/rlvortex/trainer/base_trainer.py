...
class OnPolicyTrainer(BaseTrainerR):
    ...
    def train(self, epochs: int):
        ...
        for _ in range(epochs):
            self._on_collection_start()
            self.collector.collect()
            self._on_collection_end()
            self._on_policy_update_start()
            update_data: Dict[str, torch.Tensor] = self.algorithm.update(self.collector)
            self._on_policy_update_end()
    ...
    def _on_collection_start(self) -> None:
        """
    ...
    def _on_collection_end(self) -> None:
        """
    ...
    def _on_policy_update_start(self) -> None:
        """
        This event is triggered before the policy update.
        """
        pass

    def _on_policy_update_end(self) -> None:
        """
