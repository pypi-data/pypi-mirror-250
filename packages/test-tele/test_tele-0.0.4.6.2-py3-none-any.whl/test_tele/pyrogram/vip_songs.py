...
#     query = query.strip().lower().replace(".ost", "").lstrip()
    
#     # Default = detective conan
#     keyword = 'detective+conan' if query == '' else query.replace(" ", "+")
#     return f"https://downloads.khinsider.com/search?search={keyword}"
