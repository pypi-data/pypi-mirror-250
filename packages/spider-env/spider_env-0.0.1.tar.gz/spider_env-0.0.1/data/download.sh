...
gURL='https://drive.google.com/u/0/uc?id=1iRDVHLr4mX2wQKSgA9J8Pire73Jahh0m&export=download'
...
cmd='curl --insecure -LOJb /tmp/gcokie "${ggURL}&confirm=${getcode}&id=${ggID}"'
