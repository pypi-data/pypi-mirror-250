...
_DATASETDOWNLOAD = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetTaxonomyDatasetStream',
    full_name='ncbi.datasets.v2.DatasetDownload.GetTaxonomyDatasetStream',
    index=5,
    containing_service=None,
    input_type=ncbi_dot_datasets_dot_v2_dot_datasets__pb2._TAXONOMYMETADATAREQUEST,
    output_type=google_dot_protobuf_dot_wrappers__pb2._BYTESVALUE,
    serialized_options=b'\302\360\031\371\002\n\275\001\010\001\")/v2alpha/taxonomy/taxon/{taxons}/download*$Get a taxonomy data package by taxon22Download a taxonomy report and names data package.:\031download_taxonomy_packageB\010Taxonomyr\017application/zip\n\266\001\010\002\"\032/v2alpha/taxonomy/download*$Get a taxonomy data package by taxon22Download a taxonomy report and names data package.:!download_taxonomy_package_by_postB\010Taxonomyr\017application/zip',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
...
_TAXONOMYCPPDATASET = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\302\360\031\337\005\n\362\002\010\001\022 /v2alpha/taxonomy/taxon/{taxons}\032!/v2alpha/taxonomy/taxon2/{taxons}*3Use taxonomic identifiers to get taxonomic metadata2\326\001Using NCBI Taxonomy IDs or names (common or scientific) at any rank, get metadata about a taxonomic node including taxonomic identifiers, lineage information, child nodes, and gene and genome counts in JSON format.:\021taxonomy_metadataB\010Taxonomy\n\347\002\010\002\022\021/v2alpha/taxonomy\032\030/v2alpha/taxonomy/taxon2*;Use taxonomic identifiers to get taxonomic metadata by post2\326\001Using NCBI Taxonomy IDs or names (common or scientific) at any rank, get metadata about a taxonomic node including taxonomic identifiers, lineage information, child nodes, and gene and genome counts in JSON format.:\026taxonomy_metadata_postB\010Taxonomy',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetTaxonomyDataReportFor',
    full_name='ncbi.datasets.v2.TaxonomyCppDataset.GetTaxonomyDataReportFor',
    index=1,
    containing_service=None,
    input_type=ncbi_dot_datasets_dot_v2_dot_datasets__pb2._TAXONOMYMETADATAREQUEST,
    output_type=ncbi_dot_datasets_dot_v2_dot_reports_dot_taxonomy__pb2._TAXONOMYDATAREPORTPAGE,
    serialized_options=b'\302\360\031\260\006\n\223\003\010\001\"//v2alpha/taxonomy/taxon/{taxons}/dataset_report*6Use taxonomic identifiers to get taxonomic data report2\326\001Using NCBI Taxonomy IDs or names (common or scientific) at any rank, get metadata about a taxonomic node including taxonomic identifiers, lineage information, child nodes, and gene and genome counts in JSON format.:\024taxonomy_data_reportB\010Taxonomyh\001r\020application/jsonr\031text/tab-separated-values\n\227\003\010\002\" /v2alpha/taxonomy/dataset_report*DUse taxonomic identifiers to get taxonomic names data report by post2\326\001Using NCBI Taxonomy IDs or names (common or scientific) at any rank, get metadata about a taxonomic node including taxonomic identifiers, lineage information, child nodes, and gene and genome counts in JSON format.:\031taxonomy_data_report_postB\010Taxonomyh\001r\020application/jsonr\031text/tab-separated-values',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetTaxonomyNamesDataReportFor',
    full_name='ncbi.datasets.v2.TaxonomyCppDataset.GetTaxonomyNamesDataReportFor',
    index=2,
    containing_service=None,
    input_type=ncbi_dot_datasets_dot_v2_dot_datasets__pb2._TAXONOMYMETADATAREQUEST,
    output_type=ncbi_dot_datasets_dot_v2_dot_reports_dot_taxonomy__names__pb2._TAXONOMYNAMESDATAREPORTPAGE,
    serialized_options=b'\302\360\031\307\004\n\246\002\010\001\032\'/v2alpha/taxonomy/taxon2/{taxons}/names\",/v2alpha/taxonomy/taxon/{taxons}/name_report*<Use taxonomic identifiers to get taxonomic names data report2sUsing NCBI Taxonomy IDs or names (common or scientific) at any rank, get metadata about associated taxonomic names.:\016taxonomy_namesB\010Taxonomy\n\233\002\010\002\032\036/v2alpha/taxonomy/taxon2/names\"\035/v2alpha/taxonomy/name_report*DUse taxonomic identifiers to get taxonomic names data report by post2sUsing NCBI Taxonomy IDs or names (common or scientific) at any rank, get metadata about associated taxonomic names.:\023taxonomy_names_postB\010Taxonomy',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\302\360\031\305\006\n\250\003\010\001\0221/v2alpha/taxonomy/taxon/{taxons}/filtered_subtree\0322/v2alpha/taxonomy/taxon/{taxons}/filtered_subtree2*=Use taxonomic identifiers to get a filtered taxonomic subtree2\330\001Using NCBI Taxonomy IDs or names (common or scientific) at any rank, get a filtered taxonomic subtree that includes the full parent lineage and all immediate children from the selected taxonomic ranks in JSON format.:\031taxonomy_filtered_subtreeB\010Taxonomy\n\227\003\010\002\022\"/v2alpha/taxonomy/filtered_subtree\032#/v2alpha/taxonomy/filtered_subtree2*EUse taxonomic identifiers to get a filtered taxonomic subtree by post2\330\001Using NCBI Taxonomy IDs or names (common or scientific) at any rank, get a filtered taxonomic subtree that includes the full parent lineage and all immediate children from the selected taxonomic ranks in JSON format.:\036taxonomy_filtered_subtree_postB\010Taxonomy',
    create_key=_descriptor._internal_create_key,
  ),
])
