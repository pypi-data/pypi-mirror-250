...
openapi_enum = _descriptor.FieldDescriptor(
  name='openapi_enum', full_name='ncbi.datasets.options.openapi_enum', index=2,
  number=53000, type=11, cpp_type=10, label=1,
  has_default_value=False, default_value=None,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
  serialized_options=None, json_name='openapiEnum', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key)
GATEWAY_FIELD_NUMBER = 53000
gateway = _descriptor.FieldDescriptor(
  name='gateway', full_name='ncbi.datasets.options.gateway', index=3,
  number=53000, type=11, cpp_type=10, label=1,
  has_default_value=False, default_value=None,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
...
request_example = _descriptor.FieldDescriptor(
  name='request_example', full_name='ncbi.datasets.options.request_example', index=4,
  number=53000, type=11, cpp_type=10, label=1,
  has_default_value=False, default_value=None,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
...
_OPENAPIENUMOPTIONS = _descriptor.Descriptor(
  name='OpenapiEnumOptions',
  full_name='ncbi.datasets.options.OpenapiEnumOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='is_internal', full_name='ncbi.datasets.options.OpenapiEnumOptions.is_internal', index=0,
...
DESCRIPTOR.message_types_by_name['OpenapiEnumOptions'] = _OPENAPIENUMOPTIONS
...
DESCRIPTOR.extensions_by_name['openapi_enum'] = openapi_enum
...
openapi_enum.message_type = _OPENAPIENUMOPTIONS
