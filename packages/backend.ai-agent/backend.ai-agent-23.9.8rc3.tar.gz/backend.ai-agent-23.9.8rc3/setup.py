...
setup(**{
    ...
    'install_requires': (
        ...
        'async_timeout~=4.0',
        'attrs>=20.3',
        """backend.ai-cli==23.09.8rc3
""",
        """backend.ai-common==23.09.8rc3
""",
        """backend.ai-kernel-binary==23.09.8rc3
""",
        """backend.ai-kernel-helper==23.09.8rc3
""",
        """backend.ai-kernel==23.09.8rc3
""",
        'backend.ai-krunner-static-gnu==4.1.0',
        """backend.ai-plugin==23.09.8rc3
""",
        'cachetools~=5.2.0',
        'callosum~=1.0.1',
        'cattrs~=22.2.0',
