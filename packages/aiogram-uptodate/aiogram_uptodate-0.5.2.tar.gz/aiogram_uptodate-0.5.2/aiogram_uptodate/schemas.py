...
class DialogTSheetAct(str, Enum):
    ignore = "IGNORE"
    time = "SET-TIME"
    back = "BACK"
...
class TimeSheetCallback(CallbackData, prefix="timesheet"):
    act: str
...
class DialogTimeSheetCallback(TimeSheetCallback, prefix="dialog_timesheet"):
    act: DialogTSheetAct
