...
class UpdateLeadRequestDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'code': (str,),  # noqa: E501
            'product_code': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'product_slug': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, product_code, product_slug, account, status, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            product_code ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Unique identifier of the product that this object belongs to.
            product_slug ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): A slug is a human-readable, unique identifier, used to identify a resource      instead of a less human-readable identifier like an id.
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, product_code, product_slug, account, status, *args, **kwargs):  # noqa: E501
        """UpdateLeadRequestDto - a model defined in OpenAPI
