...
Refer to the Terraform Registry for docs: [`google_backup_dr_management_server`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_backup_dr_management_server).
'''
import abc
import builtins
import datetime
