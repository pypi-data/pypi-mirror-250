...
Refer to the Terraform Registry for docs: [`google_healthcare_dicom_store`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_healthcare_dicom_store).
'''
import abc
import builtins
import datetime
