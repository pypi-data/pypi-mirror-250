...
Refer to the Terraform Registry for docs: [`google_edgenetwork_subnet`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_edgenetwork_subnet).
'''
import abc
import builtins
import datetime
