...
Refer to the Terraform Registry for docs: [`google_data_loss_prevention_inspect_template`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_data_loss_prevention_inspect_template).
'''
import abc
import builtins
import datetime
