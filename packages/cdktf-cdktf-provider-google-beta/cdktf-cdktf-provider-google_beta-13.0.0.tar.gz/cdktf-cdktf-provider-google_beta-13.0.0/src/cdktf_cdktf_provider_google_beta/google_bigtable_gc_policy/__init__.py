...
Refer to the Terraform Registry for docs: [`google_bigtable_gc_policy`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_bigtable_gc_policy).
'''
import abc
import builtins
import datetime
