...
Refer to the Terraform Registry for docs: [`google_resource_manager_lien`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_resource_manager_lien).
'''
import abc
import builtins
import datetime
