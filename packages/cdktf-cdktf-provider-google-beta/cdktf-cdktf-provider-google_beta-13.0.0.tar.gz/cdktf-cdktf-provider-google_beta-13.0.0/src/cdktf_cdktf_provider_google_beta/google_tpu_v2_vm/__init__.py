...
Refer to the Terraform Registry for docs: [`google_tpu_v2_vm`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_tpu_v2_vm).
'''
import abc
import builtins
import datetime
