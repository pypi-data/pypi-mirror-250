...
Refer to the Terraform Registry for docs: [`google_api_gateway_api_config_iam_binding`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_api_gateway_api_config_iam_binding).
'''
import abc
import builtins
import datetime
