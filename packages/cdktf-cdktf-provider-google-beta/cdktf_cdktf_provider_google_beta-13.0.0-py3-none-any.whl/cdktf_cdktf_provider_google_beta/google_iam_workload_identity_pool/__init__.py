...
Refer to the Terraform Registry for docs: [`google_iam_workload_identity_pool`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_iam_workload_identity_pool).
'''
import abc
import builtins
import datetime
