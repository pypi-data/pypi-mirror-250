...
Refer to the Terraform Registry for docs: [`google_tags_location_tag_binding`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_tags_location_tag_binding).
'''
import abc
import builtins
import datetime
