...
Refer to the Terraform Registry for docs: [`data_google_monitoring_istio_canonical_service`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/data-sources/google_monitoring_istio_canonical_service).
'''
import abc
import builtins
import datetime
