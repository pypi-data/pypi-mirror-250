...
Refer to the Terraform Registry for docs: [`google_beyondcorp_app_gateway`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_beyondcorp_app_gateway).
'''
import abc
import builtins
import datetime
