...
Refer to the Terraform Registry for docs: [`google_network_connectivity_service_connection_policy`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_network_connectivity_service_connection_policy).
'''
import abc
import builtins
import datetime
