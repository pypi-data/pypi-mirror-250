...
Refer to the Terraform Registry for docs: [`google_vmwareengine_external_address`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_vmwareengine_external_address).
'''
import abc
import builtins
import datetime
