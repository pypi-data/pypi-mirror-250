...
Refer to the Terraform Registry for docs: [`google_compute_node_template`](https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_compute_node_template).
'''
import abc
import builtins
import datetime
