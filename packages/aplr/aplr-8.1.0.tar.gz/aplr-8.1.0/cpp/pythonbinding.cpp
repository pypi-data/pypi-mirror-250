...
PYBIND11_MODULE(aplr_cpp, m)
{
    py::class_<APLRRegressor>(m, "APLRRegressor", py::module_local())
        .def(py::init<int &, double &, int &, std::string &, std::string &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, double &, std::string &,
             ...
             py::arg("use_tuning_metric_for_variable_selection") = false)
        ...
        .def_readwrite("use_tuning_metric_for_variable_selection", &APLRRegressor::use_tuning_metric_for_variable_selection)
        .def(py::pickle(
            [](const APLRRegressor &a) { // __getstate__
                ...
                return py::make_tuple(a.m, a.v, a.random_state, a.loss_function, a.link_function, a.n_jobs, a.cv_folds, a.intercept, a.bins,
                                      ...
                                      a.group_mse_cycle_min_obs_in_bin, a.cv_error, a.use_tuning_metric_for_variable_selection);
            },
            [](py::tuple t) { // __setstate__
                ...
                bool use_tuning_metric_for_variable_selection = t[34].cast<bool>();
                ...
                a.cv_error = cv_error;
                a.use_tuning_metric_for_variable_selection = use_tuning_metric_for_variable_selection;
