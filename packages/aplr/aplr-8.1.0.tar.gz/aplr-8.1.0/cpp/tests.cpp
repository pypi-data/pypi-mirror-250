...
public:
    ...
    void test_aplrregressor_cauchy_group_mse_validation_and_var_selection()
    {
        // Model
        APLRRegressor model{APLRRegressor()};
        model.m = 100;
        ...
        model.max_eligible_terms = 5;
        model.validation_tuning_metric = "group_mse";
        model.use_tuning_metric_for_variable_selection = true;
        ...
        std::cout << predictions.mean() << "\n\n";
        tests.push_back(is_approximately_equal(predictions.mean(), 14.4327, 0.00001));
    }
    ...
    void test_aplrregressor_cauchy_group_mse_by_prediction_validation_and_var_selection()
    {
        // Model
        APLRRegressor model{APLRRegressor()};
        model.m = 100;
    ...
    void test_aplrregressor_gamma_custom_validation_and_var_selection()
    {
        // Model
        APLRRegressor model{APLRRegressor()};
        model.m = 100;
        ...
        std::cout << predictions.mean() << "\n\n";
        tests.push_back(is_approximately_equal(predictions.mean(), 23.4878, 0.00001));
    }
...
int main()
{
    ...
    tests.test_aplrregressor_cauchy_group_mse_validation_and_var_selection();
    tests.test_aplrregressor_cauchy_group_mse_by_prediction_validation();
    tests.test_aplrregressor_cauchy_group_mse_by_prediction_validation_and_var_selection();
    ...
    tests.test_aplrregressor_gamma_custom_validation_and_var_selection();
