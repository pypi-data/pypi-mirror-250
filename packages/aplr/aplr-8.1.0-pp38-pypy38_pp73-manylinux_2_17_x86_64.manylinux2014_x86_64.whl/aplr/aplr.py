...
class APLRRegressor:
    def __init__(
        ...
        use_tuning_metric_for_variable_selection: bool = False,
    ):
        self.m = m
        self.v = v
        ...
        self.use_tuning_metric_for_variable_selection = (
            use_tuning_metric_for_variable_selection
        )
    ...
    def __set_params_cpp(self):
        ...
        self.APLRRegressor.use_tuning_metric_for_variable_selection = (
            self.use_tuning_metric_for_variable_selection
        )
    ...
    def get_params(self, deep=True):
        return {
            ...
            "use_tuning_metric_for_variable_selection": self.use_tuning_metric_for_variable_selection,
        }
