...
from bug_tracker._type import TYPE_CHECKING
from bug_tracker.consts import OP,SPANDATA
from bug_tracker.hub import Hub, _should_send_default_pii
from bug_tracker.scope import add_global_event_processor
from bug_tracker.serializer import add_global_repr_processor
from bug_tracker.tracing import SOURCE_FOR_STYLE, TRANSACTION_SOURCE_URL
from bug_tracker.tracing_utils import record_sql_queries
from bug_tracker.utils import (
    AnnotatedValue,
...
from bug_tracker.integrations import Integration, DidNotEnable
from bug_tracker.integrations.logging import ignore_logger
from bug_tracker.integrations.wsgi import SentryWsgiMiddleware
from bug_tracker.integrations._wsgi_common import RequestExtractor
...
from bug_tracker.integrations.django.transactions import LEGACY_RESOLVER
from bug_tracker.integrations.django.templates import (
    get_template_frame_from_exception,
    patch_templates,
)
from bug_tracker.integrations.django.middleware import patch_django_middlewares
from bug_tracker.integrations.django.signals_handlers import patch_signals
from bug_tracker.integrations.django.views import patch_views

if DJANGO_VERSION[:2] > (1, 8):
    from bug_tracker.integrations.django.caching import patch_caching
else:
...
if TYPE_CHECKING:
    ...
    from bug_tracker.tracing import Span
    from bug_tracker.scope import Scope
    from bug_tracker.integrations.wsgi import _ScopedResponse
    from bug_tracker._type import Event, Hint, EventProcessor, NotImplementedType
