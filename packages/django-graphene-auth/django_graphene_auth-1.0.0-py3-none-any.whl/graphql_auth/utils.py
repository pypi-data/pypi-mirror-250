...
def get_user_by_natural_key(username):
    ...
    return UserModel._default_manager.select_related('status').filter(**{UserModel.USERNAME_FIELD: username}).first()



# def get_user_by_payload(payload):
#     """
#     It's the same as original method from graphql_jwt.utils,
