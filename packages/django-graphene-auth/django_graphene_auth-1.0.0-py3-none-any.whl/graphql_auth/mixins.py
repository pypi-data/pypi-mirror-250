...
from .bases import ErrorsFieldOutput, SuccessErrorsFieldOutput, SuccessFieldOutput
...
class RegisterMixin(SuccessErrorsFieldOutput):
    """
...
class VerifyAccountMixin(SuccessErrorsFieldOutput):
    """
    Verify user account.
...
class VerifySecondaryEmailMixin(SuccessErrorsFieldOutput):
    """
    ...
    def resolve_mutation(cls, root, info, **kwargs):
        try:
            ...
            # verified, the email has been saved to database and it was free.
            # If other account was created with it, it is already in use.
...
class ResendActivationEmailMixin(SuccessErrorsFieldOutput):
    """
...
class SendPasswordResetEmailMixin(SuccessErrorsFieldOutput):
    """
...
class PasswordResetMixin(SuccessErrorsFieldOutput):
    """
...
class PasswordSetMixin(SuccessErrorsFieldOutput):
    """
...
class ObtainJSONWebTokenMixin(SuccessErrorsFieldOutput):
    """
...
class ArchiveOrDeleteMixin(SuccessErrorsFieldOutput):
    @classmethod
...
class PasswordChangeMixin(SuccessErrorsFieldOutput):
    """
...
class UpdateAccountMixin(SuccessErrorsFieldOutput):
    """
...
class VerifyOrRefreshOrRevokeTokenMixin(SuccessErrorsFieldOutput):
    """
...
class SendSecondaryEmailActivationMixin(SuccessErrorsFieldOutput):
    """
...
class SwapEmailsMixin(SuccessErrorsFieldOutput):
    """
...
class RemoveSecondaryEmailMixin(SuccessErrorsFieldOutput):
    """
