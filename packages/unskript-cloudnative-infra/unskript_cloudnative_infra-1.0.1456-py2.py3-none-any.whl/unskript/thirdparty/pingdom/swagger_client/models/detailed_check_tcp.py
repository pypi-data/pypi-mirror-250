...
class DetailedCheckTcp(object):
    ...
    """
    swagger_types = {
        'check': 'AllOfDetailedCheckTcpCheck'
    }
    ...
    def __init__(self, check=None):  # noqa: E501
        """DetailedCheckTcp - a model defined in Swagger"""  # noqa: E501
        self._check = None
    ...
    @property
    def check(self):
        """Gets the check of this DetailedCheckTcp.  # noqa: E501


        :return: The check of this DetailedCheckTcp.  # noqa: E501
        :rtype: AllOfDetailedCheckTcpCheck
        """
        return self._check

    @check.setter
    def check(self, check):
        """Sets the check of this DetailedCheckTcp.


        :param check: The check of this DetailedCheckTcp.  # noqa: E501
        :type: AllOfDetailedCheckTcpCheck
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DetailedCheckTcp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetailedCheckTcp):
            return False
