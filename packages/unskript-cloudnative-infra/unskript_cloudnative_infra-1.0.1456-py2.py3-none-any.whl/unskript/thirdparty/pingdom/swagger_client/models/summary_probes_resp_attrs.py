...
class SummaryProbesRespAttrs(object):
    ...
    def __init__(self, probes=None):  # noqa: E501
        """SummaryProbesRespAttrs - a model defined in Swagger"""  # noqa: E501
        self._probes = None
    ...
    @property
    def probes(self):
        """Gets the probes of this SummaryProbesRespAttrs.  # noqa: E501


        :return: The probes of this SummaryProbesRespAttrs.  # noqa: E501
        :rtype: list[int]
        """
        return self._probes
    ...
    def probes(self, probes):
        """Sets the probes of this SummaryProbesRespAttrs.


        :param probes: The probes of this SummaryProbesRespAttrs.  # noqa: E501
        :type: list[int]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SummaryProbesRespAttrs, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SummaryProbesRespAttrs):
            return False
