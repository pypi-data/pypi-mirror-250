...
class ActionsAlertsEntry(object):
    ...
    """
    swagger_types = {
        'actions': 'ActionsAlertsEntryActions'
    }
    ...
    def __init__(self, actions=None):  # noqa: E501
        """ActionsAlertsEntry - a model defined in Swagger"""  # noqa: E501
        self._actions = None
    ...
    @property
    def actions(self):
        """Gets the actions of this ActionsAlertsEntry.  # noqa: E501


        :return: The actions of this ActionsAlertsEntry.  # noqa: E501
        :rtype: ActionsAlertsEntryActions
        """
        return self._actions

    @actions.setter
    def actions(self, actions):
        """Sets the actions of this ActionsAlertsEntry.


        :param actions: The actions of this ActionsAlertsEntry.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ActionsAlertsEntry, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ActionsAlertsEntry):
            return False
