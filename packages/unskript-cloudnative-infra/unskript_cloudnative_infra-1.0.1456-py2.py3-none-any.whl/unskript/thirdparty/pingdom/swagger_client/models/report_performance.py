...
class ReportPerformance(object):
    ...
    """
    swagger_types = {
        'report': 'ReportPerformanceReport'
    }
    ...
    def __init__(self, report=None):  # noqa: E501
        """ReportPerformance - a model defined in Swagger"""  # noqa: E501
        self._report = None
    ...
    @property
    def report(self):
        """Gets the report of this ReportPerformance.  # noqa: E501


        :return: The report of this ReportPerformance.  # noqa: E501
        :rtype: ReportPerformanceReport
        """
        return self._report

    @report.setter
    def report(self, report):
        """Sets the report of this ReportPerformance.


        :param report: The report of this ReportPerformance.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ReportPerformance, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReportPerformance):
            return False
