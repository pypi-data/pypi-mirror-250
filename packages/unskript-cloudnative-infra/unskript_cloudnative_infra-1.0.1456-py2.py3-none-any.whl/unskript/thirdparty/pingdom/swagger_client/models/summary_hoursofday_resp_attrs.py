...
class SummaryHoursofdayRespAttrs(object):
    ...
    """
    swagger_types = {
        'hoursofday': 'list[SummaryHoursofdayRespAttrsHoursofday]'
    }
    ...
    def __init__(self, hoursofday=None):  # noqa: E501
        """SummaryHoursofdayRespAttrs - a model defined in Swagger"""  # noqa: E501
        self._hoursofday = None
        self.discriminator = None
        if hoursofday is not None:
            self.hoursofday = hoursofday

    @property
    def hoursofday(self):
        """Gets the hoursofday of this SummaryHoursofdayRespAttrs.  # noqa: E501


        :return: The hoursofday of this SummaryHoursofdayRespAttrs.  # noqa: E501
        :rtype: list[SummaryHoursofdayRespAttrsHoursofday]
        """
        return self._hoursofday

    @hoursofday.setter
    def hoursofday(self, hoursofday):
        """Sets the hoursofday of this SummaryHoursofdayRespAttrs.


        :param hoursofday: The hoursofday of this SummaryHoursofdayRespAttrs.  # noqa: E501
        :type: list[SummaryHoursofdayRespAttrsHoursofday]
        """

        self._hoursofday = hoursofday
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SummaryHoursofdayRespAttrs, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SummaryHoursofdayRespAttrs):
            return False
