...
class DetailedCheckHttpCustom(object):
    ...
    """
    swagger_types = {
        'check': 'AllOfDetailedCheckHttpCustomCheck'
    }
    ...
    def __init__(self, check=None):  # noqa: E501
        """DetailedCheckHttpCustom - a model defined in Swagger"""  # noqa: E501
        self._check = None
    ...
    @property
    def check(self):
        """Gets the check of this DetailedCheckHttpCustom.  # noqa: E501


        :return: The check of this DetailedCheckHttpCustom.  # noqa: E501
        :rtype: AllOfDetailedCheckHttpCustomCheck
        """
        return self._check

    @check.setter
    def check(self, check):
        """Sets the check of this DetailedCheckHttpCustom.


        :param check: The check of this DetailedCheckHttpCustom.  # noqa: E501
        :type: AllOfDetailedCheckHttpCustomCheck
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DetailedCheckHttpCustom, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetailedCheckHttpCustom):
            return False
