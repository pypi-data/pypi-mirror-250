...
class MetadataGETAuthentications(object):
    ...
    """
    swagger_types = {
        'http_authentications': 'list[HttpAuthentications]'
    }

    attribute_map = {
        'http_authentications': 'httpAuthentications'
    }

    def __init__(self, http_authentications=None):  # noqa: E501
        """MetadataGETAuthentications - a model defined in Swagger"""  # noqa: E501
        self._http_authentications = None
        self.discriminator = None
        if http_authentications is not None:
            self.http_authentications = http_authentications

    @property
    def http_authentications(self):
        """Gets the http_authentications of this MetadataGETAuthentications.  # noqa: E501

        HTTP (browser-level) authentications. Currently, only Basic Authentication is supported  # noqa: E501

        :return: The http_authentications of this MetadataGETAuthentications.  # noqa: E501
        :rtype: list[HttpAuthentications]
        """
        return self._http_authentications

    @http_authentications.setter
    def http_authentications(self, http_authentications):
        """Sets the http_authentications of this MetadataGETAuthentications.

        HTTP (browser-level) authentications. Currently, only Basic Authentication is supported  # noqa: E501

        :param http_authentications: The http_authentications of this MetadataGETAuthentications.  # noqa: E501
        :type: list[HttpAuthentications]
        """

        self._http_authentications = http_authentications
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetadataGETAuthentications, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetadataGETAuthentications):
            return False
