...
class UDP(object):
    ...
    def __init__(self, host=None, type=None, probeid=None, probe_filters=None, ipv6=None, responsetime_threshold=30000, port=None, stringtosend=None, stringtoexpect=None):  # noqa: E501
        """UDP - a model defined in Swagger"""  # noqa: E501
        self._host = None
        self._type = None
        self._probeid = None
        ...
        if stringtosend is not None:
            self.stringtosend = stringtosend
        if stringtoexpect is not None:
            self.stringtoexpect = stringtoexpect

    @property
    def host(self):
        """Gets the host of this UDP.  # noqa: E501

        Target host  # noqa: E501

        :return: The host of this UDP.  # noqa: E501
        :rtype: str
        """
        return self._host
    ...
    @host.setter
    def host(self, host):
        """Sets the host of this UDP.

        Target host  # noqa: E501

        :param host: The host of this UDP.  # noqa: E501
        :type: str
        """
        if host is None:
    ...
    @property
    def type(self):
        """Gets the type of this UDP.  # noqa: E501


        :return: The type of this UDP.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this UDP.


        :param type: The type of this UDP.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["udp"]  # noqa: E501
    ...
    @property
    def probeid(self):
        """Gets the probeid of this UDP.  # noqa: E501

        Probe identifier  # noqa: E501

        :return: The probeid of this UDP.  # noqa: E501
        :rtype: int
        """
    ...
    def probeid(self, probeid):
        """Sets the probeid of this UDP.

        Probe identifier  # noqa: E501

        :param probeid: The probeid of this UDP.  # noqa: E501
        :type: int
        """
    ...
    def probe_filters(self):
        """Gets the probe_filters of this UDP.  # noqa: E501
        ...
        :return: The probe_filters of this UDP.  # noqa: E501
        :rtype: int
        """
    ...
    def probe_filters(self, probe_filters):
        """Sets the probe_filters of this UDP.

        Filters used for probe selections. Comma separated key:value pairs. Currently only region is supported. Possible values are 'EU', 'NA', 'APAC' and 'LATAM'.  # noqa: E501

        :param probe_filters: The probe_filters of this UDP.  # noqa: E501
        :type: int
        """
    ...
    @property
    def ipv6(self):
        """Gets the ipv6 of this UDP.  # noqa: E501

        Use ipv6 instead of ipv4  # noqa: E501

        :return: The ipv6 of this UDP.  # noqa: E501
        :rtype: bool
        """
        return self._ipv6
    ...
    @ipv6.setter
    def ipv6(self, ipv6):
        """Sets the ipv6 of this UDP.

        Use ipv6 instead of ipv4  # noqa: E501

        :param ipv6: The ipv6 of this UDP.  # noqa: E501
        :type: bool
        """
    ...
    def responsetime_threshold(self):
        """Gets the responsetime_threshold of this UDP.  # noqa: E501
        ...
        :return: The responsetime_threshold of this UDP.  # noqa: E501
        :rtype: int
        """
    ...
    def responsetime_threshold(self, responsetime_threshold):
        """Sets the responsetime_threshold of this UDP.

        Triggers a down alert if the response time exceeds threshold specified in ms (Not available for Starter and Free plans.)  # noqa: E501

        :param responsetime_threshold: The responsetime_threshold of this UDP.  # noqa: E501
        :type: int
        """
    ...
    @property
    def port(self):
        """Gets the port of this UDP.  # noqa: E501

        (udp specific) Target port  # noqa: E501

        :return: The port of this UDP.  # noqa: E501
        :rtype: int
        """
        return self._port
    ...
    @port.setter
    def port(self, port):
        """Sets the port of this UDP.

        (udp specific) Target port  # noqa: E501

        :param port: The port of this UDP.  # noqa: E501
        :type: int
        """
        if port is None:
    ...
    def stringtosend(self):
        """Gets the stringtosend of this UDP.  # noqa: E501

        (udp specific) String to send  # noqa: E501

        :return: The stringtosend of this UDP.  # noqa: E501
        :rtype: str
        """
        return self._stringtosend

    @stringtosend.setter
    def stringtosend(self, stringtosend):
        """Sets the stringtosend of this UDP.

        (udp specific) String to send  # noqa: E501

        :param stringtosend: The stringtosend of this UDP.  # noqa: E501
        :type: str
        """

        self._stringtosend = stringtosend

    @property
    def stringtoexpect(self):
        """Gets the stringtoexpect of this UDP.  # noqa: E501

        (udp specific) String to expect in response  # noqa: E501

        :return: The stringtoexpect of this UDP.  # noqa: E501
        :rtype: str
        """
    ...
    def stringtoexpect(self, stringtoexpect):
        """Sets the stringtoexpect of this UDP.

        (udp specific) String to expect in response  # noqa: E501

        :param stringtoexpect: The stringtoexpect of this UDP.  # noqa: E501
        :type: str
        """
