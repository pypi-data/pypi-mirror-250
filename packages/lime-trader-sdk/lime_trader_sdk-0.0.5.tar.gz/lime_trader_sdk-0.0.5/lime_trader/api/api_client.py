...
from typing import TypeVar, Type, Any, Callable, Union
import httpx
import websocket
...
class ApiClient:
    ...
    def _map_response(self, data: Union[dict[str, Any], list[str, Any]], t: Type[T]) -> T:
        """
    ...
    def _prepare_json_body(self, json: Any) -> Union[dict[str, Any], list[dict[str, Any]]]:
        if type(json) == list:
