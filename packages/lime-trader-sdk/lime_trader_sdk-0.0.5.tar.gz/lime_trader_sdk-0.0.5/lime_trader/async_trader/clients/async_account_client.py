...
class AsyncAccountClient(AccountClient):
    ...
    async def get_positions(self, account_number: str, date: Union[datetime.date, None] = None,
                            strategy: Union[bool, None] = None) -> list[AccountPosition]:
    ...
    async def get_transactions_journal(self, account_number: str, start_date: Union[datetime.date, None],
