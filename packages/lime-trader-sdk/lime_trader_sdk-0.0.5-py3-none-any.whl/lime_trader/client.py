...
class LimeClient:
    ...
    def __init__(self, base_url: str, credentials: Credentials, logger: Union[logging.Logger, None] = None,
                 auth_url: Union[str, None] = None, timeout: int = DEFAULT_TIMEOUT):
        """
        Args:
    ...
    @classmethod
    def from_json(cls, json_str: str, logger: Union[logging.Logger, None] = None) -> 'LimeClient':
        """
    ...
    @classmethod
    def from_file(cls, file_path: str, logger: Union[logging.Logger, None] = None) -> 'LimeClient':
        """
    ...
    @classmethod
    def from_dict(cls, data: dict[str, str], logger: Union[logging.Logger, None] = None) -> 'LimeClient':
        """
    ...
    @classmethod
    def from_env(cls, logger: Union[logging.Logger, None] = None) -> 'LimeClient':
        """
    ...
    @classmethod
    def from_env_file(cls, file_path: str, logger: Union[logging.Logger, None] = None) -> 'LimeClient':
        """
