...
class AccountClient:
    ...
    def get_positions(self, account_number: str, date: Union[datetime.date, None] = None,
    ...
    def get_transactions_journal(self, account_number: str, start_date: Union[datetime.date, None],
