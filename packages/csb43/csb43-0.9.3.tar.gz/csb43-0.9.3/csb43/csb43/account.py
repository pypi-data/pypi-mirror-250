...
0                              '
    ...
    def __init__(
        ...
        **record_settings
        ...
        self.__closing: Optional['ClosingAccount'] = None

        self.__bankCode: Optional[str] = None
        self.__branchCode: Optional[str] = None
        self.__accountNumber: Optional[str] = None
        self.__currencyCode: Optional[bytes] = None
        self.__initialBalance: Optional[bytes] = None
        self.__debitOrCredit: Optional[bytes] = None
        self.__initialDate: Optional[bytes] = None
        self.__finalDate: Optional[bytes] = None
        self.__shortName: Optional[str] = None
        self.__currencyCode = None
        self.__padding: Optional[str] = None
        self.__informationMode: Optional[str] = None
    ...
    def _set_account_number(self, value: bytes, **chk_args):
...
'0000000000'"""
    ...
    @check_strict(br'^\d{4}$')
    def _set_bank_code(self, value: bytes, **chk_args):
...
'0000'"""
    ...
    @check_strict(br'^[ \d]{4}$')
    def _set_branch_code(self, value: bytes, **chk_args):
...
'0000'"""
    ...
    @check_strict(br'^[ \d]{3}$')
    def _set_currency_code(self, value: bytes, **chk_args):
...
`ISO 4217` codes can be assigned::
    ...
    @check_strict(br'^[ \d]$')
    def _set_information_mode(self, value: bytes, **chk_args):
...
'2'"""
    ...
    def _set_short_name(self, value: bytes, **chk_args):
        """
        value -- (enc: latin1)
        """
        # internal is unicode
        text = self.str_decode(value)
        self.__shortName = text.rstrip(' ') if text is not None else None
...
:rtype: :class:`str`"""
    ...
    def _set_initial_balance(self, value: bytes, **chk_args):
...
to adjust the decimal format set for the object::
    ...
    @check_strict(br'^[12]$')
    def _set_expense_or_income(self, value: bytes, **chk_args):
    ...
    @check_strict(br'^\d{6}$')
    def _set_initial_date(self, value: bytes, **chk_args):
...
Setting a date::
    ...
    @check_strict(br'^\d{6}$')
    def _set_final_date(self, value: bytes, **chk_args):
...
Setting a date::
    ...
    def add_transaction(self, record: Union[bytes, Transaction]):
        '''
    ...
    def add_item(self, record: Union[bytes, Item]):
        '''
    ...
    def get_account_key(self) -> str:
        ...
        dig1 = fixDigit((
            sumprod(self.bankCode, c1)
            + sumprod(self.branchCode, c2)
        ) % 11)
    ...
    def close_account(
        self,
        record: Union[bytes, 'ClosingAccount'] = None,
        update=False
    ):
        '''
    ...
    @property
    def abstract(self) -> Optional['ClosingAccount']:
        ":rtype: :class:`ClosingAccount` account abstract"
        return self.__closing

    def add_exchange(self, record: Union[bytes, Exchange], update=False):
        '''
...
class ClosingAccount(RecordSequence):
    ...
    def __init__(
        ...
        **record_settings
        ...
        self.__branchCode: Optional[str] = None
        self.__accountNumber: Optional[str] = None
        self.__debitEntries: Optional[bytes] = None
        self.__creditEntries: Optional[bytes] = None
        self.__debitAmount: Optional[bytes] = None
        self.__creditAmount: Optional[bytes] = None
        self.__totalAmountCode: Optional[bytes] = None
        self.__totalAmount: Optional[bytes] = None
        self.__currencyCode: Optional[bytes] = None
        self.__padding: Optional[str] = None
    ...
    def is_valid(record) -> bool:
        return (
            isinstance(record, (str, bytes))
            and (76 <= len(record) <= 80) and (record[0:2] == b'33')
        )
    ...
    # user out: int
    @check_strict(br'^\d{5}$')
    def _set_expense_entries(self, value: bytes, **chk_args):
    ...
    @check_strict(br'^\d{5}$')
    def _set_income_entries(self, value: bytes, **chk_args):
    ...
    @check_strict(br'^\d{14}$')
    def _set_expense_amount(self, value: bytes, **chk_args):
    ...
    def expense(self, value):
        ...
        bal, _ = self._unformat_currency(v)
        field = "%014d" % bal
    ...
    @check_strict(br'^\d{14}$')
    def _set_income_amount(self, value: bytes, **chk_args):
    ...
    @check_strict(br'^\d{14}$')
    def _set_total_balance(self, value: bytes, **chk_args):
    ...
    @check_strict(br'^[12]$')
    def _set_total_balance_code(self, value: bytes, **chk_args):
    ...
    def balance(self, value):
        v = self._to_decimal(value)
        bal, sign = self._unformat_currency(v)
        field = "%014d" % bal
