...
# body param
SchemaForRequestBodyApplicationJson = OCRDeskewImageBody


request_body_ocr_deskew_image_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _post_deskew_image_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ocr_deskew_image_body.serialize(body, content_type)
...
class PostDeskewImage(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_deskew_image(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json; charset=utf-8; charset=utf-8/json; charset=utf-8; charset=utf-8; charset=utf-8"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def post_deskew_image(
        ...
        return self._post_deskew_image_oapg(
            body=body,
