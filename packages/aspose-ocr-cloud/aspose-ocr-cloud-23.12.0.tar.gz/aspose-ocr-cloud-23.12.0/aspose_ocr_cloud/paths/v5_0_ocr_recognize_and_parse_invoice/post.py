...
from aspose_ocr_cloud import api_client, exceptions
...
# body param
SchemaForRequestBodyApplicationJson = OCRRecognizeAndParseInvoiceBody


request_body_ocr_recognize_and_parse_invoice_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _post_recognize_and_parse_invoice_oapg(
        self,
    ...
    def _post_recognize_and_parse_invoice_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ocr_recognize_and_parse_invoice_body.serialize(body, content_type)
...
class PostRecognizeAndParseInvoice(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_recognize_and_parse_invoice(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json; charset=utf-8"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def post_recognize_and_parse_invoice(
        ...
        return self._post_recognize_and_parse_invoice_oapg(
            body=body,
