...
class BaseApi(api_client.Api):
    @typing.overload
    def _post_convert_text_to_speech_trial_oapg(
        self,
...
class PostConvertTextToSpeechTrial(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_convert_text_to_speech_trial(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json; charset=utf-8"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def post_convert_text_to_speech_trial(
        ...
        return self._post_convert_text_to_speech_trial_oapg(
            body=body,
