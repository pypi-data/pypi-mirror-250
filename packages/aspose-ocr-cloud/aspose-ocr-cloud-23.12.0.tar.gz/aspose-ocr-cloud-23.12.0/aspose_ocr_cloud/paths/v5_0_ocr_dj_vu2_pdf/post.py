...
# body param
SchemaForRequestBodyApplicationJson = OCRDjVu2PDFBody


request_body_ocrdj_vu2_pdf_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _post_dj_vu2_pdf_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ocrdj_vu2_pdf_body.serialize(body, content_type)
...
class PostDjVu2Pdf(BaseApi):
    ...
    def post_dj_vu2_pdf(
        ...
        return self._post_dj_vu2_pdf_oapg(
            body=body,
