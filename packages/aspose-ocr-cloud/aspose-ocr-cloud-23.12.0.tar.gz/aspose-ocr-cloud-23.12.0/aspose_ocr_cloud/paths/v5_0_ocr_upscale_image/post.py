...
# body param
SchemaForRequestBodyApplicationJson = OCRUpscaleImageBody


request_body_ocr_upscale_image_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _post_upscale_image_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ocr_upscale_image_body.serialize(body, content_type)
...
class PostUpscaleImage(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_upscale_image(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json; charset=utf-8"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def post_upscale_image(
        ...
        return self._post_upscale_image_oapg(
            body=body,
