...
# body param
SchemaForRequestBodyApplicationJson = OCRRecognizeFontBody


request_body_ocr_recognize_font_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _post_identify_font_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ocr_recognize_font_body.serialize(body, content_type)
...
class PostIdentifyFont(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_identify_font(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json; charset=utf-8; charset=utf-8/json; charset=utf-8; charset=utf-8; charset=utf-8"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def post_identify_font(
        ...
        return self._post_identify_font_oapg(
            body=body,
