...
# body param
SchemaForRequestBodyApplicationJson = TTSBodyDeprecated


request_body_tts_body_deprecated = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _post_text_to_speech_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tts_body_deprecated.serialize(body, content_type)
