...
# body param
SchemaForRequestBodyApplicationJson = OCRDewarpImageBody


request_body_ocr_dewarp_image_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _post_dewarp_image_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ocr_dewarp_image_body.serialize(body, content_type)
...
class PostDewarpImage(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_dewarp_image(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json; charset=utf-8; charset=utf-8/json; charset=utf-8; charset=utf-8; charset=utf-8"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def post_dewarp_image(
        ...
        return self._post_dewarp_image_oapg(
            body=body,
