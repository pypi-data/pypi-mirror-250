...
def run_recognize_image_trial_demo(config: Configuration):
    ...
    with aspose_ocr_cloud.ApiClient(config) as api_client:
        ...
        try:
            ...
            task_id_response = api_instance.post_recognize_image_trial(
                body=body,
            )
            ...
            task_response : OCRResponse = api_instance.get_recognize_image_trial(
