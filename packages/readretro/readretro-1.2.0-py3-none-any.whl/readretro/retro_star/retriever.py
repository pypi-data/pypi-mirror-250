...
class Retriever:
    def __init__(self, data):
        ...
        with open(os.path.join(script_dir,'..',data)) as f:
...
class pathRetriever:
    def __init__(self, kegg_mol_data, pathway_data, token):
        ...
        kegg_mol = pd.read_csv(os.path.join(script_dir,'..',kegg_mol_data))
        pathways = pd.read_pickle(os.path.join(script_dir,'..',pathway_data))
