...
class MaterializedViewArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] cluster_name: The cluster to maintain the materialized view. If not specified, defaults to the quickstart cluster.
    ...
    def cluster_name(self) -> Optional[pulumi.Input[str]]:
        """
        The cluster to maintain the materialized view. If not specified, defaults to the quickstart cluster.
        """
