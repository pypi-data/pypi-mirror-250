...
_client: "Brunner | None" = None

logger = logging.getLogger("brunner_client")
...
def set_shared_state_pickle(value: Any, path="state.pickle") -> None:
    ...
    Set the state in the shared folder using pickle
    """
    return Brunner.set_shared_state_pickle(value=value, path=path)


@deprecate("Brunner.get_shared_state_pickle(...)")
def get_shared_state_pickle(path="state.pickle") -> Any:
    """
    Get the state in the shared folder using pickle
    """
    return Brunner.get_shared_state_pickle(path=path)
...
def set_shared_state(value: Any, path="state.json") -> None:
    ...
    Set the state in the shared folder using pickle
    """
    return Brunner.set_shared_state(value=value, path=path)
...
def get_shared_state(path="state.json") -> None:
    ...
    Set the state in the shared folder using pickle
    """
    return Brunner.get_shared_state(path=path)
