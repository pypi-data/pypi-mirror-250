...
class RegisteredDomain(
    ...
    def __init__(
        ...
        *,
        ...
        :param contact_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#contact_id RegisteredDomain#contact_id}.
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#name RegisteredDomain#name}.
        :param auto_renew_enabled: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#auto_renew_enabled RegisteredDomain#auto_renew_enabled}.
        :param dnssec_enabled: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#dnssec_enabled RegisteredDomain#dnssec_enabled}.
        :param extended_attributes: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#extended_attributes RegisteredDomain#extended_attributes}.
        :param premium_price: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#premium_price RegisteredDomain#premium_price}.
        :param timeouts: Timeouts for operations, given as a parsable string as in ``10m`` or ``30s``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#timeouts RegisteredDomain#timeouts}
        :param transfer_lock_enabled: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#transfer_lock_enabled RegisteredDomain#transfer_lock_enabled}.
        :param whois_privacy_enabled: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#whois_privacy_enabled RegisteredDomain#whois_privacy_enabled}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing RegisteredDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#import import section} in the documentation of this resource for the id to use
    ...
    def put_timeouts(
        ...
        *,
        ...
        '''
        :param create: Create timeout. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#create RegisteredDomain#create}
        :param delete: Delete timeout (currently unused). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#delete RegisteredDomain#delete}
        :param update: Update timeout. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#update RegisteredDomain#update}
        '''
...
class RegisteredDomainDomainRegistration:
    def __init__(self, *, state: typing.Optional[builtins.str] = None) -> None:
        '''
        :param state: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#state RegisteredDomain#state}.
        '''
        if __debug__:
...
class RegisteredDomainRegistrantChange:
    def __init__(self, *, state: typing.Optional[builtins.str] = None) -> None:
        '''
        :param state: State of the registrant change. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/resources/registered_domain#state RegisteredDomain#state}
        '''
        if __debug__:
