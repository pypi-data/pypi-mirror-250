...
class TMOP_Metric_014(TMOP_QualityMetric):
    ...
    def EvalWMatrixForm(self, Jpt):
        r"""EvalWMatrixForm(TMOP_Metric_014 self, DenseMatrix Jpt) -> double"""
...
class DiscreteAdaptTC(TargetConstructor):
    ...
    def UpdateGradientTargetSpecification(self, *args, **kwargs):
        r"""UpdateGradientTargetSpecification(DiscreteAdaptTC self, Vector x, double dx, bool reuse_flag=False, int x_ordering=byNODES)"""
    ...
    def UpdateHessianTargetSpecification(self, *args, **kwargs):
        r"""UpdateHessianTargetSpecification(DiscreteAdaptTC self, Vector x, double dx, bool reuse_flag=False, int x_ordering=byNODES)"""
...
class TMOP_Integrator(mfem._ser.nonlininteg.NonlinearFormIntegrator):
    ...
    def GetSurfaceFittingErrors(self, pos, err_avg, err_max):
        r"""GetSurfaceFittingErrors(TMOP_Integrator self, Vector pos, double & err_avg, double & err_max)"""
