...
class Mesh(object):
    ...
    def CreatePeriodicVertexMapping(self, translations, tol=1e-8):
        r"""CreatePeriodicVertexMapping(Mesh self, vector_Vector translations, double tol=1e-8) -> std::vector< int,std::allocator< int > >"""
    ...
    def GetGeometricParametersFromJacobian(self, J, volume, aspr, skew, ori):
        r"""GetGeometricParametersFromJacobian(Mesh self, DenseMatrix J, double & volume, Vector aspr, Vector skew, Vector ori)"""
