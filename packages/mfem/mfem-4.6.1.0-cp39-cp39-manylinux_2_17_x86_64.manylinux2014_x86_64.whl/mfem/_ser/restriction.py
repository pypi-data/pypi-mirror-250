...
class FaceRestriction(mfem._ser.operators.Operator):
    ...
    def AddMultTransposeUnsigned(self, x, y, a=1.0):
        r"""AddMultTransposeUnsigned(FaceRestriction self, Vector x, Vector y, double const a=1.0)"""
...
class ConformingFaceRestriction(FaceRestriction):
    ...
    def AddMultTransposeUnsigned(self, x, y, a=1.0):
        r"""AddMultTransposeUnsigned(ConformingFaceRestriction self, Vector x, Vector y, double const a=1.0)"""
