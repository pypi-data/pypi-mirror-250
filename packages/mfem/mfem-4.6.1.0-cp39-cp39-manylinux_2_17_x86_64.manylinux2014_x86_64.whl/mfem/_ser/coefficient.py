...
class CartesianCoefficient(Coefficient):
    ...
    def Eval(self, T, ip):
        r"""Eval(CartesianCoefficient self, ElementTransformation T, IntegrationPoint ip) -> double"""
...
class CylindricalRadialCoefficient(Coefficient):
    ...
    def Eval(self, T, ip):
        r"""Eval(CylindricalRadialCoefficient self, ElementTransformation T, IntegrationPoint ip) -> double"""
...
class CylindricalAzimuthalCoefficient(Coefficient):
    ...
    def Eval(self, T, ip):
        r"""Eval(CylindricalAzimuthalCoefficient self, ElementTransformation T, IntegrationPoint ip) -> double"""
...
class SphericalRadialCoefficient(Coefficient):
    ...
    def Eval(self, T, ip):
        r"""Eval(SphericalRadialCoefficient self, ElementTransformation T, IntegrationPoint ip) -> double"""
...
class SphericalAzimuthalCoefficient(Coefficient):
    ...
    def Eval(self, T, ip):
        r"""Eval(SphericalAzimuthalCoefficient self, ElementTransformation T, IntegrationPoint ip) -> double"""
...
class SphericalPolarCoefficient(Coefficient):
    ...
    def Eval(self, T, ip):
        r"""Eval(SphericalPolarCoefficient self, ElementTransformation T, IntegrationPoint ip) -> double"""
...
class TransformedCoefficient(Coefficient):
    ...
    def __init__(self, *args):
        r"""
        __init__(TransformedCoefficient self, Coefficient q, std::function< double (double) > F) -> TransformedCoefficient
        __init__(TransformedCoefficient self, Coefficient q1, Coefficient q2, std::function< double (double,double) > F) -> TransformedCoefficient
        """
