...
class BilinearForm(mfem._ser.matrix.Matrix):
    ...
    def GetDBFI_Marker(self):
        r"""GetDBFI_Marker(BilinearForm self) -> mfem::Array< mfem::Array< int > * > *"""
...
class MixedBilinearForm(mfem._ser.matrix.Matrix):
    ...
    def GetDBFI_Marker(self):
        r"""GetDBFI_Marker(MixedBilinearForm self) -> mfem::Array< mfem::Array< int > * > *"""
...
class DiscreteLinearOperator(MixedBilinearForm):
    ...
    def GetDI_Marker(self):
        r"""GetDI_Marker(DiscreteLinearOperator self) -> mfem::Array< mfem::Array< int > * > *"""
