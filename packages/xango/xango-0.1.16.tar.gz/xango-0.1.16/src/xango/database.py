...
class GraphEdgeCollection(object):
    ...
    def _parse_row(self, row):
        ...
        return GraphEdgeCollectionNode(item=item, edge=edge, kinds=kinds, paths=paths)
...
class GraphEdgeCollectionNode(object):
    def __init__(self, item:CollectionItem, db=None, edge:dict=None, paths:dict=None, kinds:dict={}):
        self._db = db
        self.item = item
        self.edge = edge
        self.root = paths.get("vertices")[0] if paths and paths.get("vertices") else None
        self.kinds = kinds or {}
