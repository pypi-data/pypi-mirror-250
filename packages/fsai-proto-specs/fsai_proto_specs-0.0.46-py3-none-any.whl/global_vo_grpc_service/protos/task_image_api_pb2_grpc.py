...
class TaskImageApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateTaskImageAsCompleted = channel.unary_unary(
                '/TaskImageApi/UpdateTaskImageAsCompleted',
                request_serializer=global__vo__grpc__service_dot_protos_dot_task__image__api__pb2.UpdateTaskImageAsCompletedRequest.SerializeToString,
                response_deserializer=global__vo__grpc__service_dot_protos_dot_task__image__api__pb2.UpdateTaskImageAsCompletedResponse.FromString,
                )
...
class TaskImageApiServicer(object):
    ...
    def UpdateTaskImageAsCompleted(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_TaskImageApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateTaskImageAsCompleted': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateTaskImageAsCompleted,
                    request_deserializer=global__vo__grpc__service_dot_protos_dot_task__image__api__pb2.UpdateTaskImageAsCompletedRequest.FromString,
                    response_serializer=global__vo__grpc__service_dot_protos_dot_task__image__api__pb2.UpdateTaskImageAsCompletedResponse.SerializeToString,
            ),
...
class TaskImageApi(object):
    ...
    @staticmethod
    def UpdateTaskImageAsCompleted(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/TaskImageApi/UpdateTaskImageAsCompleted',
            global__vo__grpc__service_dot_protos_dot_task__image__api__pb2.UpdateTaskImageAsCompletedRequest.SerializeToString,
            global__vo__grpc__service_dot_protos_dot_task__image__api__pb2.UpdateTaskImageAsCompletedResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
