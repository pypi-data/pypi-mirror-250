...
from .personal_event import (
    PersonalEventCreateMutation,
    PersonalEventDeleteMutation,
    PersonalEventPatchMutation,
)
from .room import (
...
class Mutation(graphene.ObjectType):
    ...
    create_personal_event = PersonalEventCreateMutation.Field()
    delete_personal_event = PersonalEventDeleteMutation.Field()
    update_personal_event = PersonalEventPatchMutation.Field()
