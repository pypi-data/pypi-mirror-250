...
from dbnomics_data_model.json_utils.parsing import loader, parse_json_data_as
...
class CategoryTreeJson:
    ...
    def from_json_data(cls, data: list[Json]) -> Self:
        try:
            nodes = parse_json_data_as(data, type_=list[CategoryTreeNodeJson])
...
if loader.frefs is None:
    loader.frefs = {}
loader.frefs["CategoryTreeNodeJson"] = CategoryTreeNodeJson  # type: ignore[assignment]
