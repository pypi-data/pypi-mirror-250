...
CONFIG_COMMENTS = {
    ...
    "FeatureRemoving": {
        "remove_features_by_correlation": {
            ...
            "min_features_to_keep": "This number of features will always be left in the dataset, although more features may also remain.",
        ...
        "remove_features_by_selection": {
            ...
            "min_features_to_keep": "Minimum number of features to select. This number of features will always be left in the dataset, although more features may also remain.",
            "plotting": "If True, see plots about feature importance and cross-validation scores aqcuired during feature selection.",
        },
        "remove_features_by_top_n": {
            "top_n_features": "Top N number of features to keep in the dataset. No N of features above this number will be kept. If -1, all features are kept.",
        },
        "sequential_order_of_removing": {
            ...
            "use_scoring_for_random_forest_selection": "Given no custom estimator is given, whether to use the scoring function or not (reverting to r2 or accuracy) for optimising the RandomForest estimator which will be used for feature selection.",
