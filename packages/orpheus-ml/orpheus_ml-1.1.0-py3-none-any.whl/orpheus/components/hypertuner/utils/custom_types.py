...
class ErrorDict:
    ...
    @classmethod
    def get(cls, error_key: str, estimator_str: Optional[str] = None) -> Dict[str, float] | List[EstimatorErrorInfo]:
    ...
    @classmethod
    def set(cls, error_key: str, estimator_str: str, error_data: EstimatorErrorInfo | List[EstimatorErrorInfo]) -> None:
...
class DefaultArgsDict:
    ...
    @classmethod
    def get(cls, estimator_str, param=None) -> Dict[str, float] | float | None:
        return (
