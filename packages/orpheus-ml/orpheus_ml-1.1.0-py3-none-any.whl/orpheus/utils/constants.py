...
CONFIG_COMMENTS = {
    ...
    "FeatureRemoving": {
        "remove_features_by_correlation": {
            ...
            "min_features_to_keep": "This number of features will always be left in the dataset.",
        ...
        "remove_features_by_selection": {
            ...
            "min_features_to_select": "Minimum number of features to select. This number of features will always be scored.",
            "plotting": "If True, see plots about feature importance and cross-validation scores aqcuired during feature selection.",
        },
        "remove_features_by_top_n": {
            "top_n_features": "Top N number of features to keep. If -1, all features are kept.",
        },
