...
Usage:
      seldom mkrec [FILE.py] [OPTIONS]
             sbase mkrec [FILE.py] [OPTIONS]
     seldom record [FILE.py] [OPTIONS]
            sbase record [FILE.py] [OPTIONS]
    seldom codegen [FILE.py] [OPTIONS]
           sbase codegen [FILE.py] [OPTIONS]

Examples:
    sbase mkrec new_test.py
    sbase mkrec new_test.py --url=seldom.io
...
def main():
    ...
    data = []
    data.append("from seldom import BaseCase")
    data.append("")
    data.append("")
    ...
    if " " not in recorded_file:
        os.system("%sseldom print %s -n" % (prefix, recorded_file))
    elif '"' not in recorded_file:
        os.system('%sseldom print "%s" -n' % (prefix, recorded_file))
    else:
        os.system("%sseldom print '%s' -n" % (prefix, recorded_file))

    print("sss", recorded_file)
