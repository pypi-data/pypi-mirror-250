...
class DataSalesforceUserLicense(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0dfd33d2287e638186ba1ab54c4768422437d0257a3995a94611d1547419c92f)
    ...
    def generate_config_for_import(
        ...
        '''Generates CDKTF code for importing a DataSalesforceUserLicense resource upon running "cdktf plan ".

        :param scope: The scope in which to define this construct.
        :param import_to_id: The construct id used in the generated config for the DataSalesforceUserLicense to import.
        :param import_from_id: The id of the existing DataSalesforceUserLicense that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/salesforce/0.1.0/docs/data-sources/user_license#import import section} in the documentation of this resource for the id to use
        :param provider: ? Optional instance of the provider where the DataSalesforceUserLicense to import is found.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__97685148e4907dc060c404b7084dd25606d19697700cda0a0cc106bce077bb2e)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def license_definition_key(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c829932781690613a154aebe2ef0045c5c8413a7630ec9ae565500e04326c3da)
...
def _typecheckingstub__97685148e4907dc060c404b7084dd25606d19697700cda0a0cc106bce077bb2e(
    scope: _constructs_77d1e7e8.Construct,
    import_to_id: builtins.str,
    import_from_id: builtins.str,
    provider: typing.Optional[_cdktf_9a9027ec.TerraformProvider] = None,
...
def _typecheckingstub__c829932781690613a154aebe2ef0045c5c8413a7630ec9ae565500e04326c3da(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
