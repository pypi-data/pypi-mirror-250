...
class DataSalesforceProfile(
    ...
    def generate_config_for_import(
        ...
        '''Generates CDKTF code for importing a DataSalesforceProfile resource upon running "cdktf plan ".

        :param scope: The scope in which to define this construct.
        :param import_to_id: The construct id used in the generated config for the DataSalesforceProfile to import.
        :param import_from_id: The id of the existing DataSalesforceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/salesforce/0.1.0/docs/data-sources/profile#import import section} in the documentation of this resource for the id to use
        :param provider: ? Optional instance of the provider where the DataSalesforceProfile to import is found.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__25ae4dcac0ff1f0d05801a535260e14daaaf79e448c1434da346b85daba800d8)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
def _typecheckingstub__25ae4dcac0ff1f0d05801a535260e14daaaf79e448c1434da346b85daba800d8(
    scope: _constructs_77d1e7e8.Construct,
    import_to_id: builtins.str,
    import_from_id: builtins.str,
    provider: typing.Optional[_cdktf_9a9027ec.TerraformProvider] = None,
