...
"""
A setuptools based setup module for epion.
...
with open(path.join(here, 'epion', 'epion.py'), encoding='utf-8') as f:
    lines = f.readlines()
    for l in lines:
...
setup(
    ...
    author='Leendert Gravendeel',
    author_email='leendert@epion.nl',
    license='MIT',
    ...
    keywords='epion air co2 sensor data api',
