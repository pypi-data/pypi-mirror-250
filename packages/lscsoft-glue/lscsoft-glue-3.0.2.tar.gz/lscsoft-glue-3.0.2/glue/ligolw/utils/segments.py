	...
	<LIGO_LW>
		<Table Name="segment_definer:table">
			...
			<Stream Delimiter="," Name="segment_definer:table" Type="Local">
				,"H1","test","process:process_id:0","segment_definer:segment_def_id:0",,
				,"L1","test","process:process_id:0","segment_definer:segment_def_id:1",,
			</Stream>
		</Table>
		<Table Name="segment_summary:table">
			...
			<Stream Delimiter="," Name="segment_summary:table" Type="Local">
				,2147483647,4294967295,"process:process_id:0","segment_definer:segment_def_id:1","segment_summary:segment_sum_id:0",4294967295,4294967295
			</Stream>
		</Table>
		<Table Name="segment:table">
			...
			<Stream Delimiter="," Name="segment:table" Type="Local">
				10,0,"process:process_id:0","segment_definer:segment_def_id:0","segment:segment_id:0",0,0,
				15,0,"process:process_id:0","segment_definer:segment_def_id:1","segment:segment_id:1",5,0
			</Stream>
		</Table>
	</LIGO_LW>
