...
warnings.warn(
    "glue.iterutils has been moved to lal.iterutils inside the python(3)-lal "
    "package and will be removed from glue in a future release, please update "
    "your workflow to use lal.iterutils",
    DeprecationWarning,
)
