...
async def option_condition_embed(price_to_strike,conditions, option_symbol, underlying_symbol, strike, call_put, expiry, price, size, exchange, volume_change, price_change, weekday, hour_of_day, hook, conn):
...
async def sized_trade_embed(dollar_cost,expiry, option_symbol, call_put, strike, underlying_symbol, price, price_change, size, volume_change, conditions, exchange, price_to_strike, hour_of_day, weekday, timestamp, conn):
