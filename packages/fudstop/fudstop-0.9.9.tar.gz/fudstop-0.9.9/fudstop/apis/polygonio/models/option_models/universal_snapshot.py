...
class OptionData:
    def __init__(self, results):
        ...
        self.vol_oi_ratio = [f"{iv / oi:.6f}" if oi else None for iv, oi in zip(self.implied_volatility, self.open_interest)]
        ...
        self.data_dict = {
            ...
            'theta': self.theta,
            'theta_decay_rate': self.theta_decay_rate,
            'avg_theta_decay': self.avg_theta_decay,
            'delta': self.delta,
            'delta_theta_ratio': self.delta_to_theta_ratio,
            'gamma': self.gamma,
            'gamma_risk': self.gamma_risk,
