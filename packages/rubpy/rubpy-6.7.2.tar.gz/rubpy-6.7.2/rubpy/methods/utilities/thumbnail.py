...
try:
    ...
    cv2 = None
    numpy = None
    warnings.warn('Package {} not found, auto preview disabled'.format(e.name))
...
try:
    ...
    PIL = None
    warnings.warn('Package {} not found, auto preview on (cpanel, linux, etc.) disabled'.format(e.name))
