...
class SendGif:
    async def send_gif(
        ...
        return await self.send_message(object_guid=object_guid, message=caption, reply_to_message_id=reply_to_message_id, file_inline=gif, type='Gif', auto_delete=auto_delete, *args, **kwargs)