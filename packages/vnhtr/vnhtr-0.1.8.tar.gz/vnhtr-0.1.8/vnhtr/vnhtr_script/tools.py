...
class TrOCR:
    ...
    def download_weights(self):
        ...
        if os.path.exists(encoder_path):
            ...
            if os.system(f'wget -O {encoder_path} https://github.com/nguyenhoanganh2002/vnhtr_weights/blob/main/tr_encoder.pt?raw=true'):
                raise RuntimeError('Download encoder failed!')
        ...
        if os.path.exists(decoder_path):
            ...
            if os.system(f'wget -O {decoder_path} https://github.com/nguyenhoanganh2002/vnhtr_weights/blob/main/tr_decoder.pt?raw=true'):
                raise RuntimeError('Download decoder failed!')
