...
class DataApp:
    ...
    def register(self,
        ...
        if user_name is None:
            ...
            if user_name is None:
                raise ValueError(
                    "Username was not provided and not deafult information about user was found in the configuration.")
    ...
    def to_dict_widget(self, host: str = None):
        ...
        self_dict[AttributeNames.MAIN_PANEL.value] = self.main_panel.to_dict_widget(host)
        temporal_context = []
