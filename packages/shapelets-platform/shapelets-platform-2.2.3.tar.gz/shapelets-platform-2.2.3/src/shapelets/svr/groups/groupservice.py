...
class GroupsService(IGroupsService):
    ...
    def create(self, attributes: GroupAttributes) -> GroupProfile:
        if all([attributes.provider, attributes.providerGroupId]):
            ...
            elif attributes.name != group.name or attributes.description != group.description:
                # Update name or description?
                self._groups_repo.update_group_info(attributes)
    ...
    def update_group(self, update_group: GroupProfile) -> bool:
        ...
        # Update permissions
        return self._groups_repo.update_group_user_permission(update_group.usersInGroup, update_group.uid)
