...
def clique ():
	...
	import click
	@click.command ("astronomical")
	@click.option ('--glob-string', default = "")
	def astronomical_astronomical (glob_string):
		...
		import astronomical._status.establish as establish_status
	...
	group.add_command (astronomical_astronomical)	
