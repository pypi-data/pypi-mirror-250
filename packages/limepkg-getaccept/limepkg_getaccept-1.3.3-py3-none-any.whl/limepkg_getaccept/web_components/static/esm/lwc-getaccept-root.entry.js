...
const Root = class {
  ...
  render() {
    return [
      ...
      })()), h("div", { class: "ga-body" }, this.renderLayout()), h("div", { class: "ga-version" }, h("span", null, "Version: 1.3.3")), h("limel-button-group", { slot: "button" }, h("limel-button", { label: "Cancel", onClick: () => {
          this.isOpen = false;
