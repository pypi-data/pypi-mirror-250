...
const Root = class {
  ...
  render() {
    return [
      ...
      })()), index.h("div", { class: "ga-body" }, this.renderLayout()), index.h("div", { class: "ga-version" }, index.h("span", null, "Version: 1.3.3")), index.h("limel-button-group", { slot: "button" }, index.h("limel-button", { label: "Cancel", onClick: () => {
          this.isOpen = false;
