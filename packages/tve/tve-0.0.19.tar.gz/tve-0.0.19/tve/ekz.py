...
def show(num):
    if num == 0:
        image_path_1 = f"tve/pic/all_1.png"
        image_path_2 = f"tve/pic/all_2.png"
        image_path_3 = f"tve/pic/all_3.png"
    ...
    if num != 0:
        ...
        image_path_1 = f"tve/pic/usl_{num}.png"
        image_path_2 = f"tve/pic/resh_{num}.png"
