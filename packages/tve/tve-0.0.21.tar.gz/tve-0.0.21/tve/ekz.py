...
def show(num):
    if num == 0:
        image_path_1 = f"{main_path}/all_1.png"
        image_path_2 = f"{main_path}/all_2.png"
        image_path_3 = f"{main_path}/all_3.png"
    ...
    if num != 0:
        ...
        image_path_1 = f"{main_path}/usl_{num}.png"
        image_path_2 = f"{main_path}/resh_{num}.png"
...
def show_list(num):
    if num == 0:
        image_path_4 = f"{main_path}/all_4.png"
        img4 = Image.open(image_path_4)
        display(img4)
    if num != 0:
        # Определяем путь к изображению
        if num != 4:
            image_path_1 = f"{main_path}/usl_list_{num}.png"
            image_path_2 = f"{main_path}/resh_list_{num}.png"
