...
class WordExplorer:
    ...
    def explore(self):
        ...
        self.features = [span.text.strip() for span in features_span]
        self.gender = 'خنثی' if 'خنثی' in self.features else ('مذکر' if 'مذکر' in self.features else ('مونث' if 'مونث' in self.word_features else None))
