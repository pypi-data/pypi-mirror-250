...
def walk_commits(start_id: CommitID, get_node: Callable[[CommitID], Node], get_parent: Callable[[Node], CommitID | None]) -> Iterator[Node]:
    """Traverses a tree-like commit datastructure, starting in the provided commit.
    ...
    get_node: Callable[[CommitID], Node]
        Inspect the tree datastructure and get the node that correspondes to the given CommitID
