...
class Bootstrapper:
    ...
    def bootstrap_app(self, ads_api_client, start_orm, uow, publisher_service):
        return self.bootstrapper._bootstrap(ads_api_client=ads_api_client,
                                            start_orm=start_orm,
                                            uow=uow,
                                            publisher_service=publish_service)

    def _bootstrap(self, ads_api_client, start_orm, uow, publisher_service):
