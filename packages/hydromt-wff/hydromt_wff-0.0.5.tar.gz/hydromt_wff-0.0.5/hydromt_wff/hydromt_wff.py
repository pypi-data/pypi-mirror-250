...
def topographical_data(output_folder, bbox_path, basin_path):
    ...
    temp_folder = os.path.join(output_folder,'topographical_data_EPSG4326') 
    ...
    # shutil.rmtree(temp_folder)   # It is not temporal anymore, the layers in geographic coordinate system will be saved there
