...
def _download_issue_page(
    ...
    while True:
        try:
            ...
            # In the event that we continously error out and set our start_at
            # greater than our original batch_size, raise the error. This will
            # stop us from getting stuck in an infinite loop
            if start_at > batch_size:
                raise
