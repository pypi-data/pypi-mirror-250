...
#   timestamp: 2024-01-10T22:10:04+00:00
...
class StableDiffusionOut(BaseModel):
    ...
    __root__: Annotated[List[StableDiffusionImage], Field(title='StableDiffusionOut')]
...
WhisperOut = List[WhisperSegment]
