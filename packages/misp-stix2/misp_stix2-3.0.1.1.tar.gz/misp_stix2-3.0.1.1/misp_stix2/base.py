...
import misp_stix2
from misp_stix2.canonicalization.Canonicalize import canonicalize
...
class _STIXBase(collections.abc.Mapping):
    ...
    def __init__(self, allow_custom=False, interoperability=False, **kwargs):
        ...
        self.__INTEROPERABILITY_types = (
            misp_stix2.properties.EmbeddedObjectProperty, misp_stix2.properties.EnumProperty,
            misp_stix2.properties.ExtensionsProperty, misp_stix2.properties.DictionaryProperty,
            misp_stix2.properties.HashesProperty, misp_stix2.properties.IDProperty,
            misp_stix2.properties.ListProperty, misp_stix2.properties.OpenVocabProperty,
            misp_stix2.properties.ReferenceProperty, misp_stix2.properties.SelectorProperty,
        )
        ...
        if all_custom_prop_names:
            if not isinstance(self, misp_stix2.v20._STIXBase20):
