...
import misp_stix2
from misp_stix2.workbench import (
...
def test_default_created_timestamp():
    ...
    assert misp_stix2.utils.format_datetime(campaign.created) == timestamp
    assert misp_stix2.utils.format_datetime(campaign.modified) == timestamp
