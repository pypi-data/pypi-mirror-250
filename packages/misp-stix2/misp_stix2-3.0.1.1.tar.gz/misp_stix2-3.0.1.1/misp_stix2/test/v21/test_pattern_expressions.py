...
import misp_stix2
from misp_stix2.pattern_visitor import create_pattern_object
import misp_stix2.patterns
import misp_stix2.utils
...
def test_create_comparison_expression():
    exp = misp_stix2.EqualityComparisonExpression(
        "file:hashes.'SHA-256'",
        misp_stix2.HashConstant("aec070645fe53ee3b3763059376134f058cc337247c978add178b6ccdfb0019f", "SHA-256"),
    )   # noqa
...
def test_boolean_expression():
    exp1 = misp_stix2.MatchesComparisonExpression(
        "email-message:from_ref.value",
        misp_stix2.StringConstant(".+\\@example\\.com$"),
    )
    exp2 = misp_stix2.MatchesComparisonExpression(
        "email-message:body_multipart[*].body_raw_ref.name",
        misp_stix2.StringConstant("^Final Report.+\\.exe$"),
    )
    exp = misp_stix2.AndBooleanExpression([exp1, exp2])
...
def test_boolean_expression_with_parentheses():
    exp1 = misp_stix2.MatchesComparisonExpression(
        misp_stix2.ObjectPath(
            "email-message",
            [
                misp_stix2.ReferenceObjectPathComponent("from_ref"),
                misp_stix2.BasicObjectPathComponent("value", False),
            ],
        ),
        misp_stix2.StringConstant(".+\\@example\\.com$"),
    )
    ...
    exp = misp_stix2.ParentheticalExpression(misp_stix2.AndBooleanExpression([exp1, exp2]))
    assert str(exp) == "(email-message:from_ref.value MATCHES '.+\\\\@example\\\\.com$' AND email-message:body_multipart[*].body_raw_ref.name MATCHES '^Final Report.+\\\\.exe$')"  # noqa


def test_hash_followed_by_registryKey_expression_python_constant():
    hash_exp = misp_stix2.EqualityComparisonExpression(
        "file:hashes.MD5",
        misp_stix2.HashConstant("79054025255fb1a26e4bc422aef54eb4", "MD5"),
    )
    o_exp1 = misp_stix2.ObservationExpression(hash_exp)
    reg_exp = misp_stix2.EqualityComparisonExpression(
        misp_stix2.ObjectPath("windows-registry-key", ["key"]),
        misp_stix2.StringConstant("HKEY_LOCAL_MACHINE\\foo\\bar"),
    )
    o_exp2 = misp_stix2.ObservationExpression(reg_exp)
    fb_exp = misp_stix2.FollowedByObservationExpression([o_exp1, o_exp2])
    para_exp = misp_stix2.ParentheticalExpression(fb_exp)
    qual_exp = misp_stix2.WithinQualifier(300)
    exp = misp_stix2.QualifiedObservationExpression(para_exp, qual_exp)
...
def test_hash_followed_by_registryKey_expression():
    ...
    fb_exp = misp_stix2.FollowedByObservationExpression([o_exp1, o_exp2])
    para_exp = misp_stix2.ParentheticalExpression(fb_exp)
    qual_exp = misp_stix2.WithinQualifier(misp_stix2.IntegerConstant(300))
    exp = misp_stix2.QualifiedObservationExpression(para_exp, qual_exp)
    assert str(exp) == "([file:hashes.MD5 = '79054025255fb1a26e4bc422aef54eb4'] FOLLOWEDBY [windows-registry-key:key = 'HKEY_LOCAL_MACHINE\\\\foo\\\\bar']) WITHIN 300 SECONDS"  # noqa


def test_file_observable_expression():
    exp1 = misp_stix2.EqualityComparisonExpression(
        "file:hashes.'SHA-256'",
        misp_stix2.HashConstant(
            "aec070645fe53ee3b3763059376134f058cc337247c978add178b6ccdfb0019f",
            'SHA-256',
        ),
    )
    exp2 = misp_stix2.EqualityComparisonExpression("file:mime_type", misp_stix2.StringConstant("application/x-pdf"))
    bool_exp = misp_stix2.ObservationExpression(misp_stix2.AndBooleanExpression([exp1, exp2]))
...
@pytest.mark.parametrize(
    "observation_class, op", [
        (misp_stix2.AndObservationExpression, 'AND'),
        (misp_stix2.OrObservationExpression, 'OR'),
    ],
)
def test_multiple_file_observable_expression(observation_class, op):
    ...
    exp2 = misp_stix2.EqualityComparisonExpression(
        "file:hashes.MD5",
        misp_stix2.HashConstant("cead3f77f6cda6ec00f57d76c9a6879f", "MD5"),
    )
    bool1_exp = misp_stix2.OrBooleanExpression([exp1, exp2])
    exp3 = misp_stix2.EqualityComparisonExpression(
        "file:hashes.'SHA-256'",
        misp_stix2.HashConstant(
            "aec070645fe53ee3b3763059376134f058cc337247c978add178b6ccdfb0019f",
            'SHA-256',
    ...
    op1_exp = misp_stix2.ObservationExpression(bool1_exp)
    op2_exp = misp_stix2.ObservationExpression(exp3)
...
def test_root_types():
    ast = misp_stix2.ObservationExpression(
            misp_stix2.AndBooleanExpression(
                [
                    misp_stix2.ParentheticalExpression(
                       misp_stix2.OrBooleanExpression([
                           misp_stix2.EqualityComparisonExpression("a:b", misp_stix2.StringConstant("1")),
                           misp_stix2.EqualityComparisonExpression("b:c", misp_stix2.StringConstant("2")),
                       ]),
                    ),
                    misp_stix2.EqualityComparisonExpression(u"b:d", misp_stix2.StringConstant("3")),
                ],
            ),
    )
...
def test_artifact_payload():
    ...
    exp2 = misp_stix2.MatchesComparisonExpression(
        ...
        misp_stix2.StringConstant("\\xd4\\xc3\\xb2\\xa1\\x02\\x00\\x04\\x00"),
    )
    and_exp = misp_stix2.ObservationExpression(misp_stix2.AndBooleanExpression([exp1, exp2]))
...
def test_greater_than_python_constant():
    exp1 = misp_stix2.GreaterThanComparisonExpression("file:extensions.'windows-pebinary-ext'.sections[*].entropy", 7.0)
    exp = misp_stix2.ObservationExpression(exp1)
    assert str(exp) == "[file:extensions.'windows-pebinary-ext'.sections[*].entropy > 7.0]"


def test_greater_than():
    exp1 = misp_stix2.GreaterThanComparisonExpression(
        "file:extensions.'windows-pebinary-ext'.sections[*].entropy",
        misp_stix2.FloatConstant(7.0),
    )
    exp = misp_stix2.ObservationExpression(exp1)
    assert str(exp) == "[file:extensions.'windows-pebinary-ext'.sections[*].entropy > 7.0]"
...
def test_less_than():
    exp = misp_stix2.LessThanComparisonExpression("file:size", 1024)
...
def test_greater_than_or_equal():
    exp = misp_stix2.GreaterThanEqualComparisonExpression(
        "file:size",
        1024,
    )
    assert str(exp) == "file:size >= 1024"
...
def test_less_than_or_equal():
    exp = misp_stix2.LessThanEqualComparisonExpression(
        "file:size",
        1024,
    )
    assert str(exp) == "file:size <= 1024"
...
def test_not():
    exp = misp_stix2.LessThanComparisonExpression(
        "file:size",
        1024,
        negated=True,
    )
...
def test_and_observable_expression():
    exp1 = misp_stix2.AndBooleanExpression([
        misp_stix2.EqualityComparisonExpression(
            "user-account:account_type",
            "unix",
        ),
        misp_stix2.EqualityComparisonExpression(
            "user-account:user_id",
            misp_stix2.StringConstant("1007"),
        ),
        misp_stix2.EqualityComparisonExpression(
    ...
    exp2 = misp_stix2.AndBooleanExpression([
        misp_stix2.EqualityComparisonExpression(
            "user-account:account_type",
            "unix",
        ),
        misp_stix2.EqualityComparisonExpression(
            "user-account:user_id",
            misp_stix2.StringConstant("1008"),
        ),
        misp_stix2.EqualityComparisonExpression(
            "user-account:account_login",
            "Paul",
    ...
    exp3 = misp_stix2.AndBooleanExpression([
        misp_stix2.EqualityComparisonExpression(
            "user-account:account_type",
            "unix",
        ),
        misp_stix2.EqualityComparisonExpression(
            "user-account:user_id",
            misp_stix2.StringConstant("1009"),
        ),
        misp_stix2.EqualityComparisonExpression(
            "user-account:account_login",
            "Mary",
    ...
    exp = misp_stix2.AndObservationExpression([
        misp_stix2.ObservationExpression(exp1),
        misp_stix2.ObservationExpression(exp2),
        misp_stix2.ObservationExpression(exp3),
    ])
...
def test_or_observable_expression():
    ...
    exp = misp_stix2.OrObservationExpression([
        misp_stix2.ObservationExpression(exp1),
        misp_stix2.ObservationExpression(exp2),
        misp_stix2.ObservationExpression(exp3),
    ])
    ...
    with pytest.raises(ValueError):
        misp_stix2.AndBooleanExpression([
            ...
            misp_stix2.EqualityComparisonExpression(
                ...
                misp_stix2.StringConstant("admin"),
            ),
        ])
...
def test_hex():
    exp_and = misp_stix2.AndBooleanExpression([
        misp_stix2.EqualityComparisonExpression(
            "file:mime_type",
            "image/bmp",
        ),
        misp_stix2.EqualityComparisonExpression(
            ...
            misp_stix2.HexConstant("ffd8"),
        ),
    ])
    exp = misp_stix2.ObservationExpression(exp_and)
...
def test_multiple_qualifiers():
    ...
    exp_ob = misp_stix2.ObservationExpression(exp_and)
    qual_rep = misp_stix2.RepeatQualifier(5)
    qual_within = misp_stix2.WithinQualifier(misp_stix2.IntegerConstant(1800))
    exp = misp_stix2.QualifiedObservationExpression(misp_stix2.QualifiedObservationExpression(exp_ob, qual_rep), qual_within)
...
def test_set_op():
    exp = misp_stix2.ObservationExpression(
        misp_stix2.IsSubsetComparisonExpression(
            "network-traffic:dst_ref.value",
...
def test_timestamp():
    ts = misp_stix2.TimestampConstant('2014-01-13T07:03:17Z')
...
def test_binary():
    const = misp_stix2.BinaryConstant("dGhpcyBpcyBhIHRlc3Q=")
    exp = misp_stix2.EqualityComparisonExpression(
        "artifact:payload_bin",
        const,
    )
...
def test_list():
    exp = misp_stix2.InComparisonExpression(
        "process:name",
...
def test_invalid_integer_constant():
    with pytest.raises(ValueError):
        misp_stix2.IntegerConstant('foo')


def test_invalid_timestamp_constant():
    with pytest.raises(ValueError):
        misp_stix2.TimestampConstant('foo')


def test_invalid_float_constant():
    with pytest.raises(ValueError):
        misp_stix2.FloatConstant('foo')
...
def test_boolean_constant(data, result):
    boolean = misp_stix2.BooleanConstant(data)
    assert boolean.value == result


def test_invalid_boolean_constant():
    with pytest.raises(ValueError):
        misp_stix2.BooleanConstant('foo')
...
def test_invalid_hash_constant(hashtype, data):
    with pytest.raises(ValueError):
        misp_stix2.HashConstant(data, hashtype)


def test_invalid_hex_constant():
    with pytest.raises(ValueError):
        misp_stix2.HexConstant('mm')


def test_invalid_binary_constant():
    with pytest.raises(ValueError):
        misp_stix2.BinaryConstant('foo')


def test_escape_quotes_and_backslashes():
    exp = misp_stix2.MatchesComparisonExpression(
        "file:name",
        "^Final Report.+\\.exe$",
    )
...
def test_like():
    exp = misp_stix2.LikeComparisonExpression(
        "directory:path",
        "C:\\Windows\\%\\foo",
    )
...
def test_issuperset():
    exp = misp_stix2.IsSupersetComparisonExpression(
        "ipv4-addr:value",
        "198.51.100.0/24",
    )
...
def test_repeat_qualifier():
    qual = misp_stix2.RepeatQualifier(misp_stix2.IntegerConstant(5))
    assert str(qual) == 'REPEATS 5 TIMES'


def test_invalid_repeat_qualifier():
    with pytest.raises(ValueError):
        misp_stix2.RepeatQualifier('foo')


def test_invalid_within_qualifier():
    with pytest.raises(ValueError):
        misp_stix2.WithinQualifier('foo')


def test_startstop_qualifier():
    qual = misp_stix2.StartStopQualifier(
        misp_stix2.TimestampConstant('2016-06-01T00:00:00Z'),
        datetime.datetime(2017, 3, 12, 8, 30, 0),
    )
    assert str(qual) == "START t'2016-06-01T00:00:00Z' STOP t'2017-03-12T08:30:00Z'"

    qual2 = misp_stix2.StartStopQualifier(
        datetime.date(2016, 6, 1),
        misp_stix2.TimestampConstant('2016-07-01T00:00:00Z'),
    )
...
@pytest.mark.parametrize(
    "input_, expected_class, expected_value", [
        (1, misp_stix2.patterns.IntegerConstant, 1),
        (1.5, misp_stix2.patterns.FloatConstant, 1.5),
        ("abc", misp_stix2.patterns.StringConstant, "abc"),
        (True, misp_stix2.patterns.BooleanConstant, True),
        (
            "2001-02-10T21:36:15Z", misp_stix2.patterns.TimestampConstant,
            misp_stix2.utils.STIXdatetime(2001, 2, 10, 21, 36, 15, tzinfo=pytz.utc),
        ),
        (
            datetime.datetime(2001, 2, 10, 21, 36, 15, tzinfo=pytz.utc),
            misp_stix2.patterns.TimestampConstant,
            misp_stix2.utils.STIXdatetime(2001, 2, 10, 21, 36, 15, tzinfo=pytz.utc),
        ),
    ],
)
def test_make_constant_simple(input_, expected_class, expected_value):
    const = misp_stix2.patterns.make_constant(input_)
...
def test_make_constant_list():
    list_const = misp_stix2.patterns.make_constant([1, 2, 3])

    assert isinstance(list_const, misp_stix2.patterns.ListConstant)
    assert all(
        isinstance(elt, misp_stix2.patterns.IntegerConstant)
...
def test_make_constant_already_a_constant():
    str_const = misp_stix2.StringConstant('Foo')
    result = misp_stix2.patterns.make_constant(str_const)
...
def test_ast_class_override_comp_equals():
    ...
    assert isinstance(patt_ast, misp_stix2.patterns.ObservationExpression)
...
def test_ast_class_override_string_constant():
    ...
    assert isinstance(patt_ast, misp_stix2.patterns.ObservationExpression)
    assert isinstance(
        patt_ast.operand, misp_stix2.patterns.LessThanComparisonExpression,
    )
    assert isinstance(
...
def test_ast_class_override_startstop_qualifier():
    ...
    assert isinstance(patt_ast, misp_stix2.patterns.QualifiedObservationExpression)
    assert isinstance(
        patt_ast.observation_expression, misp_stix2.patterns.ObservationExpression,
    )
    assert isinstance(
