...
def test_is_sdo_dict(type_):
    ...
    assert misp_stix2.utils.is_sdo(d, "2.1")
...
def test_is_not_sdo_dict(dict_):
    assert not misp_stix2.utils.is_sdo(dict_, "2.1")
...
def test_is_sco_dict():
    ...
    assert misp_stix2.utils.is_sco(d, "2.1")
...
def test_is_not_sco_dict(dict_):
    assert not misp_stix2.utils.is_sco(dict_, "2.1")
...
def test_is_sro_dict(dict_):
    assert misp_stix2.utils.is_sro(dict_, "2.1")
...
def test_is_not_sro_dict(dict_):
    assert not misp_stix2.utils.is_sro(dict_, "2.1")
...
def test_is_object_dict(dict_):
    assert misp_stix2.utils.is_object(dict_, "2.1")
...
def test_is_not_object_dict(dict_):
    assert not misp_stix2.utils.is_object(dict_, "2.1")
