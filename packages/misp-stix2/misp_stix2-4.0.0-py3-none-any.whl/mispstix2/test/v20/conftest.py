...
def indicator(uuid4, clock):
    return mispstix2.v20.Indicator(**INDICATOR_KWARGS)


@pytest.fixture
def malware(uuid4, clock):
    return mispstix2.v20.Malware(**MALWARE_KWARGS)


@pytest.fixture
def relationship(uuid4, clock):
    return mispstix2.v20.Relationship(**RELATIONSHIP_KWARGS)
...
def real_stix_objs2(stix_objs2):
    return [mispstix2.parse(x, version="2.0") for x in stix_objs2]
