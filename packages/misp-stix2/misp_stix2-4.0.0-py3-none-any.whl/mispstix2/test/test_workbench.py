...
import mispstix2
from mispstix2.workbench import (
...
def test_default_created_timestamp():
    ...
    assert mispstix2.utils.format_datetime(campaign.created) == timestamp
    assert mispstix2.utils.format_datetime(campaign.modified) == timestamp
