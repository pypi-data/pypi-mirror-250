...
def test_timestamp():
    ts = mispstix2.StringConstant('2014-01-13T07:03:17Z')
...
def test_startstop_qualifier():
    qual = mispstix2.StartStopQualifier(
        mispstix2.StringConstant('2016-06-01T00:00:00Z'),
        mispstix2.StringConstant('2017-03-12T08:30:00Z'),
    )
    assert str(qual) == "START '2016-06-01T00:00:00Z' STOP '2017-03-12T08:30:00Z'"

    qual2 = mispstix2.StartStopQualifier(
        mispstix2.StringConstant("2016-06-01T00:00:00Z"),
        mispstix2.StringConstant('2016-07-01T00:00:00Z'),
    )
