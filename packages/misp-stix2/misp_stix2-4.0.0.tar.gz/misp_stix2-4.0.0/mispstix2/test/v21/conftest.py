...
def clock(monkeypatch):
    ...
    class mydatetime(mispstix2.utils.STIXdatetime):
        @classmethod
        def now(cls, tz=None):
            return FAKE_TIME

    monkeypatch.setattr(mispstix2.utils, 'STIXdatetime', mydatetime)
...
def indicator(uuid4, clock):
    return mispstix2.v21.Indicator(**INDICATOR_KWARGS)


@pytest.fixture
def infrastructure(uuid4, clock):
    return mispstix2.v21.Infrastructure(**INFRASTRUCTURE_KWARGS)


@pytest.fixture
def grouping(uuid4, clock):
    return mispstix2.v21.Grouping(**GROUPING_KWARGS)


@pytest.fixture
def malware(uuid4, clock):
    return mispstix2.v21.Malware(**MALWARE_KWARGS)


@pytest.fixture
def relationship(uuid4, clock):
    return mispstix2.v21.Relationship(**RELATIONSHIP_KWARGS)
...
def real_stix_objs2(stix_objs2):
    return [mispstix2.parse(x, version="2.1") for x in stix_objs2]
