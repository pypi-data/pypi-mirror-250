...
import mispstix2
from mispstix2.canonicalization.Canonicalize import canonicalize
...
class _STIXBase(collections.abc.Mapping):
    ...
    def __init__(self, allow_custom=False, interoperability=False, **kwargs):
        ...
        self.__INTEROPERABILITY_types = (
            mispstix2.properties.EmbeddedObjectProperty, mispstix2.properties.EnumProperty,
            mispstix2.properties.ExtensionsProperty, mispstix2.properties.DictionaryProperty,
            mispstix2.properties.HashesProperty, mispstix2.properties.IDProperty,
            mispstix2.properties.ListProperty, mispstix2.properties.OpenVocabProperty,
            mispstix2.properties.ReferenceProperty, mispstix2.properties.SelectorProperty,
        )
        ...
        if all_custom_prop_names:
            if not isinstance(self, mispstix2.v20._STIXBase20):
