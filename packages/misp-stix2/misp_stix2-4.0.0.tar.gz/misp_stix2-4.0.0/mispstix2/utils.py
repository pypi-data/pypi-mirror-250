...
import mispstix2.registry as mappings
import mispstix2.version
...
def is_sdo(value, stix_version=mispstix2.version.DEFAULT_VERSION):
    """
...
def is_sco(value, stix_version=mispstix2.version.DEFAULT_VERSION):
    """
...
def is_sro(value, stix_version=mispstix2.version.DEFAULT_VERSION):
    """
...
def is_object(value, stix_version=mispstix2.version.DEFAULT_VERSION):
    """
...
def is_marking(value, stix_version=mispstix2.version.DEFAULT_VERSION):
    """
...
def is_stix_type(value, stix_version=mispstix2.version.DEFAULT_VERSION, *types):
    """
