...
if __name__ == '__main__':
    attack_pattern = misp_stix2.v20.AttackPattern(**ATTACK_PATTERN_KWARGS, interoperability=True)
    campaign = misp_stix2.v20.Campaign(**CAMPAIGN_KWARGS, interoperability=True)
    course_of_action = misp_stix2.v20.CourseOfAction(**COURSE_OF_ACTION_KWARGS, interoperability=True)
    identity = misp_stix2.v20.Identity(**IDENTITY_KWARGS, interoperability=True)
    indicator = misp_stix2.v20.Indicator(**INDICATOR_KWARGS, interoperability=True)
    intrusion_set = misp_stix2.v20.IntrusionSet(**INTRUSION_SET_KWARGS, interoperability=True)
    malware = misp_stix2.v20.Malware(**MALWARE_KWARGS, interoperability=True)
    marking_definition = misp_stix2.v20.MarkingDefinition(**MARKING_DEFINITION_KWARGS, interoperability=True)
    observed_data = misp_stix2.v20.ObservedData(**OBSERVED_DATA_KWARGS, interoperability=True)
    relationship = misp_stix2.v20.Relationship(**RELATIONSHIP_KWARGS, interoperability=True)
    sighting = misp_stix2.v20.Sighting(**SIGHTING_KWARGS, interoperability=True)
    threat_actor = misp_stix2.v20.ThreatActor(**THREAT_ACTOR_KWARGS, interoperability=True)
    tool = misp_stix2.v20.Tool(**TOOL_KWARGS)
    vulnerability = misp_stix2.v20.Vulnerability(**VULNERABILITY_KWARGS, interoperability=True)
    report = misp_stix2.v20.Report(**REPORT_KWARGS, interoperability=True)
