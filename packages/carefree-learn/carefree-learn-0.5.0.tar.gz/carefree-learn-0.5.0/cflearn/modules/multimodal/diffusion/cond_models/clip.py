...
from .common import register_condition_model
...
@register_condition_model("multimodal/clip")
@register_condition_model("multimodal/clip.large")
@register_condition_model("multimodal/clip.chinese")
@register_condition_model("multimodal/clip.open_clip_ViT_H_14")
class CLIPTextConditionModel(Module):
    m: CLIP
