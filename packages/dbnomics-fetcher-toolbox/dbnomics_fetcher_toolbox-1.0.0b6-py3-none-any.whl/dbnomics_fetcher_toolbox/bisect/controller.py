...
class BisectionController(ABC, Generic[T, TBisectionPartition]):
    def __init__(self, *, resource_group: "ResourceGroup", root_partition: TBisectionPartition) -> None:
        downloader = resource_group._downloader  # noqa: SLF001
        ...
        self._report = resource_group._downloader._report  # noqa: SLF001
    ...
    def _load_previous_state(self) -> BisectionControllerState | None:
        ...
        state_json_data = load_json_file(self._state_file)
    ...
    def _process_partition(self, partition: TBisectionPartition, *, index: int) -> None:
        ...
        resource_full_id = ResourceFullId.from_group_and_resource(self._resource_group, resource)
    ...
    def _register_partition_resource_bisection(self, resource: Resource[T]) -> None:
        ...
        save_json_file(self._state_file, state_json_data)
    ...
    def _state_file(self) -> Path:
        return self._state_dir / f"{self._resource_group.id}.json"
