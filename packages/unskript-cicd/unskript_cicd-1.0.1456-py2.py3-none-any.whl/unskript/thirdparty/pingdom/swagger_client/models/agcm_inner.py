...
class AGCMInner(object):
    ...
    def __init__(self, severity=None, agcm_id=None):  # noqa: E501
        """AGCMInner - a model defined in Swagger"""  # noqa: E501
        self._severity = None
        self._agcm_id = None
        self.discriminator = None
        if severity is not None:
            self.severity = severity
        if agcm_id is not None:
            self.agcm_id = agcm_id

    @property
    def severity(self):
        """Gets the severity of this AGCMInner.  # noqa: E501

        Contact target's severity level  # noqa: E501

        :return: The severity of this AGCMInner.  # noqa: E501
        :rtype: str
        """
    ...
    def severity(self, severity):
        """Sets the severity of this AGCMInner.

        Contact target's severity level  # noqa: E501

        :param severity: The severity of this AGCMInner.  # noqa: E501
        :type: str
        """
    ...
    @property
    def agcm_id(self):
        """Gets the agcm_id of this AGCMInner.  # noqa: E501

        Contact target's agcm id  # noqa: E501

        :return: The agcm_id of this AGCMInner.  # noqa: E501
        :rtype: str
        """
        return self._agcm_id

    @agcm_id.setter
    def agcm_id(self, agcm_id):
        """Sets the agcm_id of this AGCMInner.

        Contact target's agcm id  # noqa: E501

        :param agcm_id: The agcm_id of this AGCMInner.  # noqa: E501
        :type: str
        """

        self._agcm_id = agcm_id
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AGCMInner):
            return False
