...
class SummaryOutageRespAttrsSummary(object):
    ...
    """
    swagger_types = {
        'states': 'list[SummaryOutageRespAttrsSummaryStates]'
    }
    ...
    def __init__(self, states=None):  # noqa: E501
        """SummaryOutageRespAttrsSummary - a model defined in Swagger"""  # noqa: E501
        self._states = None
    ...
    @property
    def states(self):
        """Gets the states of this SummaryOutageRespAttrsSummary.  # noqa: E501


        :return: The states of this SummaryOutageRespAttrsSummary.  # noqa: E501
        :rtype: list[SummaryOutageRespAttrsSummaryStates]
        """
        return self._states

    @states.setter
    def states(self, states):
        """Sets the states of this SummaryOutageRespAttrsSummary.


        :param states: The states of this SummaryOutageRespAttrsSummary.  # noqa: E501
        :type: list[SummaryOutageRespAttrsSummaryStates]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SummaryOutageRespAttrsSummary, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SummaryOutageRespAttrsSummary):
            return False
