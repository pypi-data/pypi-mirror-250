...
class DetailedCheckUdp(object):
    ...
    """
    swagger_types = {
        'check': 'AllOfDetailedCheckUdpCheck'
    }
    ...
    def __init__(self, check=None):  # noqa: E501
        """DetailedCheckUdp - a model defined in Swagger"""  # noqa: E501
        self._check = None
    ...
    @property
    def check(self):
        """Gets the check of this DetailedCheckUdp.  # noqa: E501


        :return: The check of this DetailedCheckUdp.  # noqa: E501
        :rtype: AllOfDetailedCheckUdpCheck
        """
        return self._check

    @check.setter
    def check(self, check):
        """Sets the check of this DetailedCheckUdp.


        :param check: The check of this DetailedCheckUdp.  # noqa: E501
        :type: AllOfDetailedCheckUdpCheck
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DetailedCheckUdp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetailedCheckUdp):
            return False
