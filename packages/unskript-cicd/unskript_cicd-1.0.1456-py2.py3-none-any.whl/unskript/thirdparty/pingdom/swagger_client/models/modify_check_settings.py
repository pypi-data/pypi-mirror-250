...
class ModifyCheckSettings(object):
    ...
    def __init__(self, name=None, host=None, paused=False, resolution="", userids=None, sendnotificationwhendown=2,
                 notifyagainevery=0, notifywhenbackup=True, checkids=None, tags=None, addtags=None, probe_filters=None,
                 ipv6=None, responsetime_threshold=30000, integrationids=None, teamids=None,
                 custom_message=None):  # noqa: E501
        """ModifyCheckSettings - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._host = None
        self._paused = None
        self._resolution = None
        self._userids = None
        self._sendnotificationwhendown = None
        self._notifyagainevery = None
        self._notifywhenbackup = None
        self._checkids = None
        self._tags = None
        self._addtags = None
        ...
        if sendnotificationwhendown is not None:
            self.sendnotificationwhendown = sendnotificationwhendown
        if notifyagainevery is not None:
            self.notifyagainevery = notifyagainevery
        if notifywhenbackup is not None:
            self.notifywhenbackup = notifywhenbackup
    ...
    @property
    def name(self):
        """Gets the name of this ModifyCheckSettings.  # noqa: E501

        Check name  # noqa: E501

        :return: The name of this ModifyCheckSettings.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ModifyCheckSettings.

        Check name  # noqa: E501

        :param name: The name of this ModifyCheckSettings.  # noqa: E501
        :type: str
        """
    ...
    @property
    def host(self):
        """Gets the host of this ModifyCheckSettings.  # noqa: E501

        Target host  # noqa: E501

        :return: The host of this ModifyCheckSettings.  # noqa: E501
        :rtype: str
        """
        return self._host
    ...
    @host.setter
    def host(self, host):
        """Sets the host of this ModifyCheckSettings.

        Target host  # noqa: E501

        :param host: The host of this ModifyCheckSettings.  # noqa: E501
        :type: str
        """
    ...
    @property
    def paused(self):
        """Gets the paused of this ModifyCheckSettings.  # noqa: E501


        :return: The paused of this ModifyCheckSettings.  # noqa: E501
        :rtype: bool
        """
        return self._paused
    ...
    def paused(self, paused):
        """Sets the paused of this ModifyCheckSettings.


        :param paused: The paused of this ModifyCheckSettings.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def resolution(self):
        """Gets the resolution of this ModifyCheckSettings.  # noqa: E501

        How often should the check be tested? (minutes)  # noqa: E501

        :return: The resolution of this ModifyCheckSettings.  # noqa: E501
        :rtype: int
        """
    ...
    def resolution(self, resolution):
        """Sets the resolution of this ModifyCheckSettings.

        How often should the check be tested? (minutes)  # noqa: E501

        :param resolution: The resolution of this ModifyCheckSettings.  # noqa: E501
        :type: int
        """
        allowed_values = [1, 5, 15, 30, 60]  # noqa: E501
    ...
    @property
    def userids(self):
        """Gets the userids of this ModifyCheckSettings.  # noqa: E501

        User identifiers. For example userids=154325,465231,765871  # noqa: E501

        :return: The userids of this ModifyCheckSettings.  # noqa: E501
        :rtype: str
        """
    ...
    def userids(self, userids):
        """Sets the userids of this ModifyCheckSettings.

        User identifiers. For example userids=154325,465231,765871  # noqa: E501

        :param userids: The userids of this ModifyCheckSettings.  # noqa: E501
        :type: str
        """
    ...
    @property
    def sendnotificationwhendown(self):
        """Gets the sendnotificationwhendown of this ModifyCheckSettings.  # noqa: E501

        Send notification when down X times  # noqa: E501

        :return: The sendnotificationwhendown of this ModifyCheckSettings.  # noqa: E501
        :rtype: int
        """
        return self._sendnotificationwhendown

    @sendnotificationwhendown.setter
    def sendnotificationwhendown(self, sendnotificationwhendown):
        """Sets the sendnotificationwhendown of this ModifyCheckSettings.

        Send notification when down X times  # noqa: E501

        :param sendnotificationwhendown: The sendnotificationwhendown of this ModifyCheckSettings.  # noqa: E501
        :type: int
        """

        self._sendnotificationwhendown = sendnotificationwhendown

    @property
    def notifyagainevery(self):
        """Gets the notifyagainevery of this ModifyCheckSettings.  # noqa: E501

        Notify again every n result. 0 means that no extra notifications will be sent.  # noqa: E501

        :return: The notifyagainevery of this ModifyCheckSettings.  # noqa: E501
        :rtype: int
        """
        return self._notifyagainevery

    @notifyagainevery.setter
    def notifyagainevery(self, notifyagainevery):
        """Sets the notifyagainevery of this ModifyCheckSettings.

        Notify again every n result. 0 means that no extra notifications will be sent.  # noqa: E501

        :param notifyagainevery: The notifyagainevery of this ModifyCheckSettings.  # noqa: E501
        :type: int
        """

        self._notifyagainevery = notifyagainevery

    @property
    def notifywhenbackup(self):
        """Gets the notifywhenbackup of this ModifyCheckSettings.  # noqa: E501

        Notify when back up again  # noqa: E501

        :return: The notifywhenbackup of this ModifyCheckSettings.  # noqa: E501
        :rtype: bool
        """
        return self._notifywhenbackup

    @notifywhenbackup.setter
    def notifywhenbackup(self, notifywhenbackup):
        """Sets the notifywhenbackup of this ModifyCheckSettings.

        Notify when back up again  # noqa: E501

        :param notifywhenbackup: The notifywhenbackup of this ModifyCheckSettings.  # noqa: E501
        :type: bool
        """

        self._notifywhenbackup = notifywhenbackup

    @property
    def checkids(self):
        """Gets the checkids of this ModifyCheckSettings.  # noqa: E501

        Identifiers of checks to modify in bulk. For example checkids=1234,5678  # noqa: E501

        :return: The checkids of this ModifyCheckSettings.  # noqa: E501
        :rtype: str
        """
        return self._checkids

    @checkids.setter
    def checkids(self, checkids):
        """Sets the checkids of this ModifyCheckSettings.

        Identifiers of checks to modify in bulk. For example checkids=1234,5678  # noqa: E501

        :param checkids: The checkids of this ModifyCheckSettings.  # noqa: E501
        :type: str
        """

        self._checkids = checkids

    @property
    def tags(self):
        """Gets the tags of this ModifyCheckSettings.  # noqa: E501

        List of tags for check. The maximum length of a tag is 64 characters.  # noqa: E501

        :return: The tags of this ModifyCheckSettings.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this ModifyCheckSettings.

        List of tags for check. The maximum length of a tag is 64 characters.  # noqa: E501

        :param tags: The tags of this ModifyCheckSettings.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def addtags(self):
        """Gets the addtags of this ModifyCheckSettings.  # noqa: E501

        Check tags to add in addition to current check tags  # noqa: E501

        :return: The addtags of this ModifyCheckSettings.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def addtags(self, addtags):
        """Sets the addtags of this ModifyCheckSettings.

        Check tags to add in addition to current check tags  # noqa: E501

        :param addtags: The addtags of this ModifyCheckSettings.  # noqa: E501
        :type: list[str]
        """
    ...
    def probe_filters(self):
        """Gets the probe_filters of this ModifyCheckSettings.  # noqa: E501

        Filters used for probe selections. Overwrites previous filters for check. To remove all filters from a check, use an empty value. Comma separated key:value pairs. Currently only region is supported. Possible values are 'EU', 'NA', 'APAC' and 'LATAM'. For example, \"region: NA\".  # noqa: E501

        :return: The probe_filters of this ModifyCheckSettings.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def probe_filters(self, probe_filters):
        """Sets the probe_filters of this ModifyCheckSettings.

        Filters used for probe selections. Overwrites previous filters for check. To remove all filters from a check, use an empty value. Comma separated key:value pairs. Currently only region is supported. Possible values are 'EU', 'NA', 'APAC' and 'LATAM'. For example, \"region: NA\".  # noqa: E501

        :param probe_filters: The probe_filters of this ModifyCheckSettings.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def ipv6(self):
        """Gets the ipv6 of this ModifyCheckSettings.  # noqa: E501

        Use ipv6 instead of ipv4, if an IP address is provided as host this will be overrided by the IP address version  # noqa: E501

        :return: The ipv6 of this ModifyCheckSettings.  # noqa: E501
        :rtype: bool
        """
        return self._ipv6
    ...
    @ipv6.setter
    def ipv6(self, ipv6):
        """Sets the ipv6 of this ModifyCheckSettings.

        Use ipv6 instead of ipv4, if an IP address is provided as host this will be overrided by the IP address version  # noqa: E501

        :param ipv6: The ipv6 of this ModifyCheckSettings.  # noqa: E501
        :type: bool
        """
    ...
    def responsetime_threshold(self):
        """Gets the responsetime_threshold of this ModifyCheckSettings.  # noqa: E501
        ...
        :return: The responsetime_threshold of this ModifyCheckSettings.  # noqa: E501
        :rtype: int
        """
    ...
    def responsetime_threshold(self, responsetime_threshold):
        """Sets the responsetime_threshold of this ModifyCheckSettings.

        Triggers a down alert if the response time exceeds threshold specified in ms (Not available for Starter and Free plans.)  # noqa: E501

        :param responsetime_threshold: The responsetime_threshold of this ModifyCheckSettings.  # noqa: E501
        :type: int
        """
    ...
    @property
    def integrationids(self):
        """Gets the integrationids of this ModifyCheckSettings.  # noqa: E501

        Integration identifiers. For example integrationids:[1,2,3].  # noqa: E501

        :return: The integrationids of this ModifyCheckSettings.  # noqa: E501
        :rtype: list[int]
        """
        return self._integrationids

    @integrationids.setter
    def integrationids(self, integrationids):
        """Sets the integrationids of this ModifyCheckSettings.

        Integration identifiers. For example integrationids:[1,2,3].  # noqa: E501

        :param integrationids: The integrationids of this ModifyCheckSettings.  # noqa: E501
        :type: list[int]
        """

        self._integrationids = integrationids

    @property
    def teamids(self):
        """Gets the teamids of this ModifyCheckSettings.  # noqa: E501

        Teams to alert. Comma separated Integers.  # noqa: E501

        :return: The teamids of this ModifyCheckSettings.  # noqa: E501
        :rtype: str
        """
    ...
    def teamids(self, teamids):
        """Sets the teamids of this ModifyCheckSettings.

        Teams to alert. Comma separated Integers.  # noqa: E501

        :param teamids: The teamids of this ModifyCheckSettings.  # noqa: E501
        :type: str
        """
    ...
    def custom_message(self):
        """Gets the custom_message of this ModifyCheckSettings.  # noqa: E501

        Custom message that will be added to email and webhook alerts.  # noqa: E501

        :return: The custom_message of this ModifyCheckSettings.  # noqa: E501
        :rtype: str
        """
    ...
    def custom_message(self, custom_message):
        """Sets the custom_message of this ModifyCheckSettings.

        Custom message that will be added to email and webhook alerts.  # noqa: E501

        :param custom_message: The custom_message of this ModifyCheckSettings.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModifyCheckSettings, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifyCheckSettings):
            return False
