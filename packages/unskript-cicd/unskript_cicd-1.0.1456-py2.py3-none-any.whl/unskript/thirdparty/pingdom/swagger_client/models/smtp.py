...
class SMTP(object):
    ...
    attribute_map = {
        ...
        'port': 'port',
        'auth': 'auth',
        'stringtoexpect': 'stringtoexpect',
        'encryption': 'encryption'
    }

    def __init__(self, host=None, type=None, probeid=None, probe_filters=None, ipv6=None, responsetime_threshold=30000, port=25, auth=None, stringtoexpect=None, encryption=False):  # noqa: E501
        ...
        if auth is not None:
            self.auth = auth
        if stringtoexpect is not None:
            self.stringtoexpect = stringtoexpect
        if encryption is not None:
            self.encryption = encryption

    @property
    def host(self):
        """Gets the host of this SMTP.  # noqa: E501

        Target host  # noqa: E501

        :return: The host of this SMTP.  # noqa: E501
        :rtype: str
        """
        return self._host
    ...
    @host.setter
    def host(self, host):
        """Sets the host of this SMTP.

        Target host  # noqa: E501

        :param host: The host of this SMTP.  # noqa: E501
        :type: str
        """
        if host is None:
    ...
    @property
    def type(self):
        """Gets the type of this SMTP.  # noqa: E501


        :return: The type of this SMTP.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this SMTP.


        :param type: The type of this SMTP.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def probeid(self):
        """Gets the probeid of this SMTP.  # noqa: E501

        Probe identifier  # noqa: E501

        :return: The probeid of this SMTP.  # noqa: E501
        :rtype: int
        """
    ...
    def probeid(self, probeid):
        """Sets the probeid of this SMTP.

        Probe identifier  # noqa: E501

        :param probeid: The probeid of this SMTP.  # noqa: E501
        :type: int
        """
    ...
    def probe_filters(self):
        """Gets the probe_filters of this SMTP.  # noqa: E501
        ...
        :return: The probe_filters of this SMTP.  # noqa: E501
        :rtype: int
        """
    ...
    def probe_filters(self, probe_filters):
        """Sets the probe_filters of this SMTP.

        Filters used for probe selections. Comma separated key:value pairs. Currently only region is supported. Possible values are 'EU', 'NA', 'APAC' and 'LATAM'.  # noqa: E501

        :param probe_filters: The probe_filters of this SMTP.  # noqa: E501
        :type: int
        """
    ...
    @property
    def ipv6(self):
        """Gets the ipv6 of this SMTP.  # noqa: E501

        Use ipv6 instead of ipv4  # noqa: E501

        :return: The ipv6 of this SMTP.  # noqa: E501
        :rtype: bool
        """
        return self._ipv6
    ...
    @ipv6.setter
    def ipv6(self, ipv6):
        """Sets the ipv6 of this SMTP.

        Use ipv6 instead of ipv4  # noqa: E501

        :param ipv6: The ipv6 of this SMTP.  # noqa: E501
        :type: bool
        """
    ...
    def responsetime_threshold(self):
        """Gets the responsetime_threshold of this SMTP.  # noqa: E501
        ...
        :return: The responsetime_threshold of this SMTP.  # noqa: E501
        :rtype: int
        """
    ...
    def responsetime_threshold(self, responsetime_threshold):
        """Sets the responsetime_threshold of this SMTP.

        Triggers a down alert if the response time exceeds threshold specified in ms (Not available for Starter and Free plans.)  # noqa: E501

        :param responsetime_threshold: The responsetime_threshold of this SMTP.  # noqa: E501
        :type: int
        """
    ...
    @property
    def port(self):
        """Gets the port of this SMTP.  # noqa: E501

        (smtp specific) Target port  # noqa: E501

        :return: The port of this SMTP.  # noqa: E501
        :rtype: int
        """
        return self._port
    ...
    @port.setter
    def port(self, port):
        """Sets the port of this SMTP.

        (smtp specific) Target port  # noqa: E501

        :param port: The port of this SMTP.  # noqa: E501
        :type: int
        """
    ...
    @property
    def auth(self):
        """Gets the auth of this SMTP.  # noqa: E501

        (smtp specific) Username and password for target HTTP authentication.  # noqa: E501

        :return: The auth of this SMTP.  # noqa: E501
        :rtype: str
        """
        return self._auth
    ...
    @auth.setter
    def auth(self, auth):
        """Sets the auth of this SMTP.

        (smtp specific) Username and password for target HTTP authentication.  # noqa: E501

        :param auth: The auth of this SMTP.  # noqa: E501
        :type: str
        """
    ...
    @property
    def stringtoexpect(self):
        """Gets the stringtoexpect of this SMTP.  # noqa: E501

        (smtp specific) String to expect in response  # noqa: E501

        :return: The stringtoexpect of this SMTP.  # noqa: E501
        :rtype: str
        """
        return self._stringtoexpect

    @stringtoexpect.setter
    def stringtoexpect(self, stringtoexpect):
        """Sets the stringtoexpect of this SMTP.

        (smtp specific) String to expect in response  # noqa: E501

        :param stringtoexpect: The stringtoexpect of this SMTP.  # noqa: E501
        :type: str
        """

        self._stringtoexpect = stringtoexpect

    @property
    def encryption(self):
        """Gets the encryption of this SMTP.  # noqa: E501

        (smtp specific) Connection encryption  # noqa: E501

        :return: The encryption of this SMTP.  # noqa: E501
        :rtype: bool
        """
    ...
    def encryption(self, encryption):
        """Sets the encryption of this SMTP.

        (smtp specific) Connection encryption  # noqa: E501

        :param encryption: The encryption of this SMTP.  # noqa: E501
        :type: bool
        """
