...
class MaintenanceIdPutRespAttrs(object):
    ...
    def __init__(self, message=None):  # noqa: E501
        """MaintenanceIdPutRespAttrs - a model defined in Swagger"""  # noqa: E501
        self._message = None
    ...
    @property
    def message(self):
        """Gets the message of this MaintenanceIdPutRespAttrs.  # noqa: E501

        Modification result description  # noqa: E501

        :return: The message of this MaintenanceIdPutRespAttrs.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this MaintenanceIdPutRespAttrs.

        Modification result description  # noqa: E501

        :param message: The message of this MaintenanceIdPutRespAttrs.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MaintenanceIdPutRespAttrs, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MaintenanceIdPutRespAttrs):
            return False
