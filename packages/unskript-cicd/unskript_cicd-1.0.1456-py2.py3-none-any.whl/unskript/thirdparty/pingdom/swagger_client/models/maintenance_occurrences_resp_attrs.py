...
class MaintenanceOccurrencesRespAttrs(object):
    ...
    """
    swagger_types = {
        'occurrences': 'list[MaintenanceOccurrencesRespAttrsOccurrences]'
    }
    ...
    def __init__(self, occurrences=None):  # noqa: E501
        """MaintenanceOccurrencesRespAttrs - a model defined in Swagger"""  # noqa: E501
    ...
    def occurrences(self):
        """Gets the occurrences of this MaintenanceOccurrencesRespAttrs.  # noqa: E501

        A list of maintenance occurrences.  # noqa: E501

        :return: The occurrences of this MaintenanceOccurrencesRespAttrs.  # noqa: E501
        :rtype: list[MaintenanceOccurrencesRespAttrsOccurrences]
        """
        return self._occurrences

    @occurrences.setter
    def occurrences(self, occurrences):
        """Sets the occurrences of this MaintenanceOccurrencesRespAttrs.

        A list of maintenance occurrences.  # noqa: E501

        :param occurrences: The occurrences of this MaintenanceOccurrencesRespAttrs.  # noqa: E501
        :type: list[MaintenanceOccurrencesRespAttrsOccurrences]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MaintenanceOccurrencesRespAttrs, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MaintenanceOccurrencesRespAttrs):
            return False
