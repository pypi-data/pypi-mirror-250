...
class SummaryHoursofdayApi(object):
    ...
    def summary_hoursofday_checkid_get(self, checkid, **kwargs):  # noqa: E501
        """Returns the average response time for each hour.  # noqa: E501

        Returns the average response time for each hour of the day (0-23) for a specific check over a selected time period. I.e. it shows you what an average day looks like during that time period.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.summary_hoursofday_checkid_get(checkid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SummaryHoursofdayCheckid checkid: (required)
        :param SummaryHoursofdayFrom _from: Start time of period. Format is UNIX timestamp. Default value is one week eariler than `to`.
        :param SummaryHoursofdayTo to: End time of period. Format is UNIX timestamp. Default value is current time.
        :param SummaryHoursofdayProbes probes: Filter to only use results from a list of probes. Format is a comma separated list of probe identifiers. By default all probes results are returned.
        :param SummaryHoursofdayUselocaltime uselocaltime: If true, use the user's local time zone for results (from and to parameters should still be specified in UTC). If false, use UTC for results.
        ...
        if kwargs.get('async_req'):
            return self.summary_hoursofday_checkid_get_with_http_info(checkid, **kwargs)  # noqa: E501
        else:
            (data) = self.summary_hoursofday_checkid_get_with_http_info(checkid, **kwargs)  # noqa: E501
            return data

    def summary_hoursofday_checkid_get_with_http_info(self, checkid, **kwargs):  # noqa: E501
        """Returns the average response time for each hour.  # noqa: E501

        Returns the average response time for each hour of the day (0-23) for a specific check over a selected time period. I.e. it shows you what an average day looks like during that time period.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.summary_hoursofday_checkid_get_with_http_info(checkid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['checkid', '_from', 'to', 'probes', 'uselocaltime']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method summary_hoursofday_checkid_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('checkid' not in params or
            ...
            raise ValueError("Missing the required parameter `checkid` when calling `summary_hoursofday_checkid_get`")  # noqa: E501
        ...
        if 'uselocaltime' in params:
            query_params.append(('uselocaltime', params['uselocaltime']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/summary.hoursofday/{checkid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='SummaryHoursofdayRespAttrs',  # noqa: E501
