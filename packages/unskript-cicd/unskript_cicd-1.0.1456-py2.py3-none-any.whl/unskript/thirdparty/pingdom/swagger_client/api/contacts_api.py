...
class ContactsApi(object):
    ...
    def alerting_contacts_contactid_delete(self, contactid, **kwargs):  # noqa: E501
        """Deletes a contact with its contact methods  # noqa: E501

        Deletes a contact with its contact methods (notification targets)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_contacts_contactid_delete(contactid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int contactid: ID of contact to be deleted (required)
        ...
        if kwargs.get('async_req'):
            return self.alerting_contacts_contactid_delete_with_http_info(contactid, **kwargs)  # noqa: E501
        else:
            (data) = self.alerting_contacts_contactid_delete_with_http_info(contactid, **kwargs)  # noqa: E501
            return data

    def alerting_contacts_contactid_delete_with_http_info(self, contactid, **kwargs):  # noqa: E501
        """Deletes a contact with its contact methods  # noqa: E501

        Deletes a contact with its contact methods (notification targets)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_contacts_contactid_delete_with_http_info(contactid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['contactid']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method alerting_contacts_contactid_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('contactid' not in params or
            ...
            raise ValueError("Missing the required parameter `contactid` when calling `alerting_contacts_contactid_delete`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/alerting/contacts/{contactid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def alerting_contacts_contactid_get(self, contactid, **kwargs):  # noqa: E501
        """Returns a contact with its contact methods  # noqa: E501

        Returns a contact with its contact methods (notification targets)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_contacts_contactid_get(contactid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int contactid: ID of contact to be retrieved (required)
        :return: Contact
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.alerting_contacts_contactid_get_with_http_info(contactid, **kwargs)  # noqa: E501
        else:
            (data) = self.alerting_contacts_contactid_get_with_http_info(contactid, **kwargs)  # noqa: E501
            return data

    def alerting_contacts_contactid_get_with_http_info(self, contactid, **kwargs):  # noqa: E501
        """Returns a contact with its contact methods  # noqa: E501

        Returns a contact with its contact methods (notification targets)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_contacts_contactid_get_with_http_info(contactid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method alerting_contacts_contactid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'contactid' is set
        if ('contactid' not in params or
                params['contactid'] is None):
            raise ValueError("Missing the required parameter `contactid` when calling `alerting_contacts_contactid_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/alerting/contacts/{contactid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def alerting_contacts_contactid_put(self, body, contactid, **kwargs):  # noqa: E501
        """Update a contact  # noqa: E501

        Update a contact with at least one contact method (notification target)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_contacts_contactid_put(body, contactid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UpdateContact body: (required)
        :param int contactid: ID of contact to be updated (required)
        :return: Contact
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.alerting_contacts_contactid_put_with_http_info(body, contactid, **kwargs)  # noqa: E501
        else:
            (data) = self.alerting_contacts_contactid_put_with_http_info(body, contactid, **kwargs)  # noqa: E501
            return data

    def alerting_contacts_contactid_put_with_http_info(self, body, contactid, **kwargs):  # noqa: E501
        """Update a contact  # noqa: E501

        Update a contact with at least one contact method (notification target)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_contacts_contactid_put_with_http_info(body, contactid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'contactid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method alerting_contacts_contactid_put" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `alerting_contacts_contactid_put`")  # noqa: E501
        # verify the required parameter 'contactid' is set
        if ('contactid' not in params or
                params['contactid'] is None):
            raise ValueError("Missing the required parameter `contactid` when calling `alerting_contacts_contactid_put`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/alerting/contacts/{contactid}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def alerting_contacts_get(self, **kwargs):  # noqa: E501
        """Returns a list of all contacts  # noqa: E501

        Returns a list of all contacts with their contact methods (notification targets)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_contacts_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.alerting_contacts_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.alerting_contacts_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def alerting_contacts_get_with_http_info(self, **kwargs):  # noqa: E501
        """Returns a list of all contacts  # noqa: E501

        Returns a list of all contacts with their contact methods (notification targets)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_contacts_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method alerting_contacts_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ContactsList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def alerting_contacts_post(self, body, **kwargs):  # noqa: E501
        """Creates a new contact  # noqa: E501

        Creates a new contact with at least one contact method (notification target)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_contacts_post(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CreateContact body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.alerting_contacts_post_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.alerting_contacts_post_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def alerting_contacts_post_with_http_info(self, body, **kwargs):  # noqa: E501
        """Creates a new contact  # noqa: E501

        Creates a new contact with at least one contact method (notification target)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_contacts_post_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method alerting_contacts_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `alerting_contacts_post`")  # noqa: E501
