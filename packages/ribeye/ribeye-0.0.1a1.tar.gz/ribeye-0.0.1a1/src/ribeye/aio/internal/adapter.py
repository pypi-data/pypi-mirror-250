...
from typing import Any, Mapping, Optional, Sequence, get_args, get_origin

from typing_extensions import Callable, Protocol
from aiohttp import ClientResponse
from beef.aio import Response
from beef.internal.types import T
...
def get_adapter(value_type: Any) -> TypeAdapter[T]:
