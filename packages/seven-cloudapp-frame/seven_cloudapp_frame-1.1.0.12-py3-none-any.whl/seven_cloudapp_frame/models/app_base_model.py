...
class AppBaseModel():
    ...
    def get_left_navigation(self, user_nick, access_token, app_key, app_secret, app_id="", is_instantiate_relation_app=False):
        """
        :description: 获取左侧导航
        ...
        :param app_id: 应用标识
        :param is_instantiate_relation_app: 是否同时实例化多个模板
        :return
        :last_editors: HuangJianYi
        """
        invoke_result_data = InvokeResultData()
        ...
        if is_instantiate_relation_app == True:
