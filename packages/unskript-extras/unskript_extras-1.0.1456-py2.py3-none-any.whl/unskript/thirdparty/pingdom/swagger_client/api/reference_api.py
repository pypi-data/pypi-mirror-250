...
class ReferenceApi(object):
    ...
    def reference_get(self, **kwargs):  # noqa: E501
        """Get regions, timezone and date/time/number references  # noqa: E501

        Get a reference of regions, timezones and date/time/number formats and their identifiers.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reference_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.reference_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.reference_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def reference_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get regions, timezone and date/time/number references  # noqa: E501

        Get a reference of regions, timezones and date/time/number formats and their identifiers.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reference_get_with_http_info(async_req=True)
        >>> result = thread.get()
