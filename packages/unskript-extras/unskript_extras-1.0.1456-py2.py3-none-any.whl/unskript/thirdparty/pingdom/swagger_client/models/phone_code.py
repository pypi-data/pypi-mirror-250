...
class PhoneCode(object):
    ...
    def __init__(self, countryid=None, name=None, phonecode=None):  # noqa: E501
        """PhoneCode - a model defined in Swagger"""  # noqa: E501
        ...
        if name is not None:
            self.name = name
        if phonecode is not None:
            self.phonecode = phonecode

    @property
    def countryid(self):
        """Gets the countryid of this PhoneCode.  # noqa: E501

        Country id (Can be mapped against countries.id)  # noqa: E501

        :return: The countryid of this PhoneCode.  # noqa: E501
        :rtype: int
        """
    ...
    def countryid(self, countryid):
        """Sets the countryid of this PhoneCode.

        Country id (Can be mapped against countries.id)  # noqa: E501

        :param countryid: The countryid of this PhoneCode.  # noqa: E501
        :type: int
        """
    ...
    @property
    def name(self):
        """Gets the name of this PhoneCode.  # noqa: E501

        Country name  # noqa: E501

        :return: The name of this PhoneCode.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PhoneCode.

        Country name  # noqa: E501

        :param name: The name of this PhoneCode.  # noqa: E501
        :type: str
        """
    ...
    @property
    def phonecode(self):
        """Gets the phonecode of this PhoneCode.  # noqa: E501

        Area phone code  # noqa: E501

        :return: The phonecode of this PhoneCode.  # noqa: E501
        :rtype: str
        """
        return self._phonecode

    @phonecode.setter
    def phonecode(self, phonecode):
        """Sets the phonecode of this PhoneCode.

        Area phone code  # noqa: E501

        :param phonecode: The phonecode of this PhoneCode.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PhoneCode):
            return False
