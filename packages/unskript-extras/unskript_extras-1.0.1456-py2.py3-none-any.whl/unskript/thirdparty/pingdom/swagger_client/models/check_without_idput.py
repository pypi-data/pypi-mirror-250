...
class CheckWithoutIDPUT(object):
    ...
    def __init__(self, active=None, contact_ids=None, custom_message=None, interval=None, name=None, region=None, send_notification_when_down=None, severity_level=None, steps=None, team_ids=None, metadata=None, tags=None, integration_ids=None):  # noqa: E501
        """CheckWithoutIDPUT - a model defined in Swagger"""  # noqa: E501
        self._active = None
    ...
    @property
    def active(self):
        """Gets the active of this CheckWithoutIDPUT.  # noqa: E501

        Check status: active or inactive  # noqa: E501

        :return: The active of this CheckWithoutIDPUT.  # noqa: E501
        :rtype: bool
        """
        return self._active
    ...
    def active(self, active):
        """Sets the active of this CheckWithoutIDPUT.

        Check status: active or inactive  # noqa: E501

        :param active: The active of this CheckWithoutIDPUT.  # noqa: E501
        :type: bool
        """
    ...
    def contact_ids(self):
        """Gets the contact_ids of this CheckWithoutIDPUT.  # noqa: E501

        Contacts to alert  # noqa: E501

        :return: The contact_ids of this CheckWithoutIDPUT.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def contact_ids(self, contact_ids):
        """Sets the contact_ids of this CheckWithoutIDPUT.

        Contacts to alert  # noqa: E501

        :param contact_ids: The contact_ids of this CheckWithoutIDPUT.  # noqa: E501
        :type: list[int]
        """
    ...
    def custom_message(self):
        """Gets the custom_message of this CheckWithoutIDPUT.  # noqa: E501

        Custom message that is part of the email and webhook alerts  # noqa: E501

        :return: The custom_message of this CheckWithoutIDPUT.  # noqa: E501
        :rtype: str
        """
    ...
    def custom_message(self, custom_message):
        """Sets the custom_message of this CheckWithoutIDPUT.

        Custom message that is part of the email and webhook alerts  # noqa: E501

        :param custom_message: The custom_message of this CheckWithoutIDPUT.  # noqa: E501
        :type: str
        """
    ...
    @property
    def interval(self):
        """Gets the interval of this CheckWithoutIDPUT.  # noqa: E501
        ...
        :return: The interval of this CheckWithoutIDPUT.  # noqa: E501
        :rtype: int
        """
    ...
    def interval(self, interval):
        """Sets the interval of this CheckWithoutIDPUT.

        TMS test intervals in minutes. Allowed intervals: 5,10,20,60,720,1440. The interval you're allowed to set may vary depending on your current plan.  # noqa: E501

        :param interval: The interval of this CheckWithoutIDPUT.  # noqa: E501
        :type: int
        """
    ...
    @property
    def name(self):
        """Gets the name of this CheckWithoutIDPUT.  # noqa: E501

        Name of the check  # noqa: E501

        :return: The name of this CheckWithoutIDPUT.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CheckWithoutIDPUT.

        Name of the check  # noqa: E501

        :param name: The name of this CheckWithoutIDPUT.  # noqa: E501
        :type: str
        """
    ...
    @property
    def region(self):
        """Gets the region of this CheckWithoutIDPUT.  # noqa: E501

        Name of the region where the check is executed. Supported regions: us-east, us-west, eu, au  # noqa: E501

        :return: The region of this CheckWithoutIDPUT.  # noqa: E501
        :rtype: str
        """
        return self._region
    ...
    def region(self, region):
        """Sets the region of this CheckWithoutIDPUT.

        Name of the region where the check is executed. Supported regions: us-east, us-west, eu, au  # noqa: E501

        :param region: The region of this CheckWithoutIDPUT.  # noqa: E501
        :type: str
        """
    ...
    def send_notification_when_down(self):
        """Gets the send_notification_when_down of this CheckWithoutIDPUT.  # noqa: E501

        Send notification when down X times  # noqa: E501

        :return: The send_notification_when_down of this CheckWithoutIDPUT.  # noqa: E501
        :rtype: int
        """
    ...
    def send_notification_when_down(self, send_notification_when_down):
        """Sets the send_notification_when_down of this CheckWithoutIDPUT.

        Send notification when down X times  # noqa: E501

        :param send_notification_when_down: The send_notification_when_down of this CheckWithoutIDPUT.  # noqa: E501
        :type: int
        """
    ...
    def severity_level(self):
        """Gets the severity_level of this CheckWithoutIDPUT.  # noqa: E501

        Check importance- how important are the alerts when the check fails. Allowed values: low, high  # noqa: E501

        :return: The severity_level of this CheckWithoutIDPUT.  # noqa: E501
        :rtype: str
        """
    ...
    def severity_level(self, severity_level):
        """Sets the severity_level of this CheckWithoutIDPUT.

        Check importance- how important are the alerts when the check fails. Allowed values: low, high  # noqa: E501

        :param severity_level: The severity_level of this CheckWithoutIDPUT.  # noqa: E501
        :type: str
        """
    ...
    @property
    def steps(self):
        """Gets the steps of this CheckWithoutIDPUT.  # noqa: E501

        steps to be executed as part of the check  # noqa: E501

        :return: The steps of this CheckWithoutIDPUT.  # noqa: E501
        :rtype: list[Step]
        """
        return self._steps
    ...
    def steps(self, steps):
        """Sets the steps of this CheckWithoutIDPUT.

        steps to be executed as part of the check  # noqa: E501

        :param steps: The steps of this CheckWithoutIDPUT.  # noqa: E501
        :type: list[Step]
        """
    ...
    @property
    def team_ids(self):
        """Gets the team_ids of this CheckWithoutIDPUT.  # noqa: E501

        Teams to alert  # noqa: E501

        :return: The team_ids of this CheckWithoutIDPUT.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def team_ids(self, team_ids):
        """Sets the team_ids of this CheckWithoutIDPUT.

        Teams to alert  # noqa: E501

        :param team_ids: The team_ids of this CheckWithoutIDPUT.  # noqa: E501
        :type: list[int]
        """
    ...
    @property
    def metadata(self):
        """Gets the metadata of this CheckWithoutIDPUT.  # noqa: E501


        :return: The metadata of this CheckWithoutIDPUT.  # noqa: E501
        :rtype: Metadata
        """
    ...
    def metadata(self, metadata):
        """Sets the metadata of this CheckWithoutIDPUT.


        :param metadata: The metadata of this CheckWithoutIDPUT.  # noqa: E501
        :type: Metadata
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this CheckWithoutIDPUT.  # noqa: E501
        ...
        :return: The tags of this CheckWithoutIDPUT.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this CheckWithoutIDPUT.

        List of tags for a check. The tag name may contain the characters 'A-Z', 'a-z', '0-9', '_' and '-'. The maximum length of a tag is 64 characters.  # noqa: E501

        :param tags: The tags of this CheckWithoutIDPUT.  # noqa: E501
        :type: list[str]
        """
    ...
    def integration_ids(self):
        """Gets the integration_ids of this CheckWithoutIDPUT.  # noqa: E501

        Integration identifiers as a list of integers.  # noqa: E501

        :return: The integration_ids of this CheckWithoutIDPUT.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def integration_ids(self, integration_ids):
        """Sets the integration_ids of this CheckWithoutIDPUT.

        Integration identifiers as a list of integers.  # noqa: E501

        :param integration_ids: The integration_ids of this CheckWithoutIDPUT.  # noqa: E501
        :type: list[int]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CheckWithoutIDPUT, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckWithoutIDPUT):
            return False
