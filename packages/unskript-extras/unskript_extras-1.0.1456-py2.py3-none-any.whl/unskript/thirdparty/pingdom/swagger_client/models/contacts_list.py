...
class ContactsList(object):
    ...
    def __init__(self, contacts=None):  # noqa: E501
        """ContactsList - a model defined in Swagger"""  # noqa: E501
        self._contacts = None
    ...
    @property
    def contacts(self):
        """Gets the contacts of this ContactsList.  # noqa: E501

        List of all contacts targets  # noqa: E501

        :return: The contacts of this ContactsList.  # noqa: E501
        :rtype: list[ContactTargets]
        """
        return self._contacts

    @contacts.setter
    def contacts(self, contacts):
        """Sets the contacts of this ContactsList.

        List of all contacts targets  # noqa: E501

        :param contacts: The contacts of this ContactsList.  # noqa: E501
        :type: list[ContactTargets]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ContactsList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContactsList):
            return False
