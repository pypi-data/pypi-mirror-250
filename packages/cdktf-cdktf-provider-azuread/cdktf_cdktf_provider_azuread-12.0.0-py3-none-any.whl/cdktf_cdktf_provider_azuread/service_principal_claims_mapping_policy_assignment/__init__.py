...
Refer to the Terraform Registry for docs: [`azuread_service_principal_claims_mapping_policy_assignment`](https://registry.terraform.io/providers/hashicorp/azuread/2.47.0/docs/resources/service_principal_claims_mapping_policy_assignment).
'''
import abc
import builtins
import datetime
