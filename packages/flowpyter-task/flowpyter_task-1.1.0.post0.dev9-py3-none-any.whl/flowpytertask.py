...
class PapermillOperator(DockerOperator):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._reserved_param_check(
            nb_params, host_dagrun_data_dir, host_shared_data_dir, read_only_mounts
        )
    ...
    @staticmethod
    def _reserved_param_check(
        nb_params, dagrun_data_dir, shared_data_dir, read_only_mounts
    ):
