...
class DocumentDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "index", "pageCount", "contentLength", "mediaType", "pagesProperties", "pdfVisualId", "signaturePlacementAnnotations", "signatureTags", "sealTags", "detachedSignatures", "embeddedSignatureInfos", "deletable", "isMainDocument", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "index", "pageCount", "contentLength", "mediaType", "pagesProperties", "pdfVisualId", "signaturePlacementAnnotations", "signatureTags", "sealTags", "detachedSignatures", "embeddedSignatureInfos", "deletable", "isMainDocument", ], str]):
        return super().get_item_oapg(name)
