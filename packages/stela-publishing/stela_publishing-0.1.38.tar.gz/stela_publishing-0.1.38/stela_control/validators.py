...
from .forms import (
    ...
    PwdResetConfirmForm, ValuesForm, LoginForm, JobApplicationForm, CatalogForm, StaffGalleryForm
)
form_mapping = {
    #Content
...
#         self.bs = 16
#         _hash = self.createHash(key)
#         _hash = self.fixKey(_hash)
#         self.cipher = AES.new(_hash, AES.MODE_ECB)
...
#         #return str.encode(str(encoded, 'utf-8'))
#         return encoded
...
#         return str.encode(str(self._unpad(decrypted), 'utf-8'))
