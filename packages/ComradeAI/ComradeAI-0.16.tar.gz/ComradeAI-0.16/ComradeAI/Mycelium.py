############## Mycelium Version 0.16 of 2024.01.13 ##############
...
class Dialog:
    def __init__(self, dialog_id = str(uuid.uuid4()), messages=None, context=None, reply_to = None, lastMessageDiagnosticData = None, requestAgentConfig = None,
                 ...
                 endUserCommunicationID = None, myceliumVersion = "0.16"):
...
# Mycelium class
class Mycelium:
    def __init__(self, host="65.109.141.56", vhost="myceliumVersion015", username=None, password=None, input_chanel=None, output_chanel=None, ComradeAIToken=None, dialogs=None, message_received_callback=None, myceliumVersion = "0.16"):
        self.myceliumVersion = myceliumVersion
