...
class image(itemBase):
    def __init__(self, screenID: str = "/default/", imgPath: str = None, x: int = 0, y: int = 0, url: str = None):
        super().__init__(screenID)
        ...
        self.UrlImg: sdl2.surface.SDL_Surface | None = None
        ...
        if self.url is not None:
            if self.url in imgCatch:
                self.UrlImg = imgCatch[self.url]
