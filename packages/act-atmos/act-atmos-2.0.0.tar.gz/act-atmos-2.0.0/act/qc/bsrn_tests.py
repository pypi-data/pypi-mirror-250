...
class QCTests:
    ...
    def bsrn_limits_test(
        ...
        if gbl_SW_dn_name is not None:
            ...
            index_min, index_max = _find_indexes(self._ds, gbl_SW_dn_name, sw_min_limit, sw_max_limit, use_dask)
        ...
        if glb_diffuse_SW_dn_name is not None:
            ...
            index_min, index_max = _find_indexes(self._ds, glb_diffuse_SW_dn_name, sw_min_limit,
        ...
        if direct_normal_SW_dn_name is not None:
            ...
            index_min, index_max = _find_indexes(self._ds, direct_normal_SW_dn_name,
        ...
        if direct_SW_dn_name is not None:
            ...
            index_min, index_max = _find_indexes(self._ds, direct_SW_dn_name,
                                                 sw_min_limit, sw_max_limit, use_dask)
        ...
        if glb_SW_up_name is not None:
            ...
            index_min, index_max = _find_indexes(self._ds, glb_SW_up_name,
                                                 sw_min_limit, sw_max_limit, use_dask)
        ...
        if glb_LW_dn_name is not None:
            index_min, index_max = _find_indexes(self._ds, glb_LW_dn_name,
        ...
        if glb_LW_up_name is not None:
            index_min, index_max = _find_indexes(self._ds, glb_LW_up_name,
    ...
    def bsrn_comparison_tests(
        ...
        if test_options[1] in test:
            ...
            with warnings.catch_warnings():
                ...
                if use_dask and isinstance(self._ds[glb_diffuse_SW_dn_name].data, da.Array):
                    ...
                    ratio = self._ds[glb_diffuse_SW_dn_name].values / self._ds[gbl_SW_dn_name].values
        ...
        if test_options[3] in test:
            ...
            air_temp = convert_units(self._ds[air_temp_name].values,
                                     self._ds[air_temp_name].attrs['units'], 'degK')
            if use_dask and isinstance(self._ds[glb_LW_dn_name].data, da.Array):
                ...
                index_2 = (conversion + 25.) < self._ds[glb_LW_dn_name].data
                index = (index_1 | index_2).compute()
            else:
                conversion = Stefan_Boltzmann * air_temp**4
                index_1 = (0.4 * conversion) > self._ds[glb_LW_dn_name].values
                index_2 = (conversion + 25.) < self._ds[glb_LW_dn_name].values
                index = index_1 | index_2
        ...
        if test_options[4] in test:
            ...
            if use_dask and isinstance(self._ds[glb_LW_up_name].data, da.Array):
                ...
                index_1 = (Stefan_Boltzmann * (air_temp - 15)**4) > self._ds[glb_LW_up_name].values
                index_2 = (Stefan_Boltzmann * (air_temp + 25)**4) < self._ds[glb_LW_up_name].values
                index = index_1 | index_2
        ...
        if test_options[5] in test:
            ...
            if use_dask and isinstance(self._ds[glb_LW_dn_name].data, da.Array):
                ...
                index_2 = self._ds[glb_LW_dn_name].values < (self._ds[glb_LW_up_name].values - LWdn_gt_LWup_component)
                index = index_1 | index_2
