...
class DeviceBooking(Entity):
    ...
    def edit(self, started_at=UNSPECIFIED, ended_at=UNSPECIFIED, extraParams={}):
        """
        ...
        return deviceBookingRepository.editDeviceBooking(
            self, 
            started_at=handleDate(started_at) if started_at != UNSPECIFIED else UNSPECIFIED, 
            ended_at=handleDate(ended_at) if ended_at != UNSPECIFIED else UNSPECIFIED, 
