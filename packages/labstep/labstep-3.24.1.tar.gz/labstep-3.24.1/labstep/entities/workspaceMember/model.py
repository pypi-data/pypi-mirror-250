...
class WorkspaceMember(Entity):
    ...
    def setPermissionRole(self, role_name):
        """
        Set an existing Permission Role to a Workspace Member.
        ...
        ::
            ...
            workspace_members[0].setPermissionRole('edit')
        """
        import labstep.entities.workspaceMember.repository as workspaceMemberRepository

        return workspaceMemberRepository.setMemberPermissionRole(self, role_name)
