...
class Publication(
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Publication that should be imported. Refer to the {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.21.0/docs/resources/publication#import import section} in the documentation of this resource for the id to use
