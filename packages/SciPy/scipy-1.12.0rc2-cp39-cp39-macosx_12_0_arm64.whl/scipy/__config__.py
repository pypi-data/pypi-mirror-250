...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": "0.15.0",
                "include directory": r"../../pip-build-env-535f1uan/overlay/lib/python3.9/site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"/private/var/folders/76/zy5ktkns50v6gt5g8r0sf6sc0000gn/T/cibw-run-_yogk8xs/cp39-macosx_arm64/build/venv/bin/python",
            "version": "3.9",
        },
    }
)
