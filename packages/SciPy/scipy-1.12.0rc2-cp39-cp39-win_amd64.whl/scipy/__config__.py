...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": "0.15.0",
                "include directory": r"C:\Users\runneradmin\AppData\Local\Temp\pip-build-env-wfr0b_bc\overlay\Lib\site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"C:\Users\runneradmin\AppData\Local\Temp\cibw-run-46pzx_6i\cp39-win_amd64\build\venv\Scripts\python.exe",
            "version": "3.9",
        },
    }
)
