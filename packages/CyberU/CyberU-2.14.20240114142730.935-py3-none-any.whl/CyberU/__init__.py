...
retrylist = [
    Exception, ConnectionRefusedError,  # pyautogui.FailSafeException,
]
if 'selenium' in sys.modules:
    import selenium

    retrylist += [
        selenium.common.exceptions.ElementClickInterceptedException, selenium.common.exceptions.WebDriverException,
        selenium.common.exceptions.NoSuchElementException, selenium.common.exceptions.StaleElementReferenceException,
        selenium.common.exceptions.InvalidSessionIdException, selenium.common.exceptions.UnexpectedAlertPresentException,

        urllib3.exceptions.NewConnectionError, urllib3.exceptions.MaxRetryError, selenium.common.exceptions.TimeoutException,
...
set_root_path = set_root = set_work_dir = setworkdir = change_root = chdir
...
class Node():
    ...
    def recieve(self, func=None, **leak) -> str:
        ...
        if not self.is_server():
            ...
            return self.socket.recv(max_byte).decode('utf-8')
        else:
            self.establish_socket()
...
def useDisk(dname=None, d=None, sepration=True,
            b=None, **leak
            ):
    """
    动态更改操作盘
...
useDisk = usedisk = use_disk = change_disk = switch_disk = useDisk
