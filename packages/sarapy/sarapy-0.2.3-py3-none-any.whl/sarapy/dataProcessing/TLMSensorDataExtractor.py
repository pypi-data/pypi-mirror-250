...
class TLMSensorDataExtractor(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X, y=None):
        ...
        self._FIX = np.vectorize(self.getFIXData)(X)
        self._SIV = np.vectorize(self.getSIVData)(X)
    ...
    @property
    def FIXData(self):
        return self._FIXData
    
    @property
    def SIVData(self):
        return self._SIVData
