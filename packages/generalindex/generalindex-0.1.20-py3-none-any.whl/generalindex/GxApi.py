...
class GxApi:
    @staticmethod
    def get_symbols(search_for: str = None, group_name: str = None, _size=1000, _from=0):
        '''
        Returns a list of the symbols available on a given group or symbols within search
        '''
        query_url = PathFormatter().get_symbol_queried_path(_from, _size, group_name,
                                                            search_for)
    ...
    def index(self, code: list = None, period: list = None, period_type: list = None,
        ...
        :param _from: Start date (default beginning of the day) Accepted values:
            today
    ...
    def catalogue(self, code: list = None, group: str = None, no_module: bool = None,
                  fields: dict = None, limit_fields: list = None):
        """
        The method retrieves the data from Gx Api based on provided parameters.

        :param code: Symbol code (default '*' )
        :param group: Name of the group (default Meta_DataCatalogue_Indexes)
