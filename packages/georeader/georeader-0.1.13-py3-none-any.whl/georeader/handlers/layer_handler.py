class LayerHandler:
    ...
    def get_dataframe(self):
        return self.handler.get_dataframe(self.layer_or_file_name)

    def get_feature_count(self):
        return self.handler.get_feature_count(self.layer_or_file_name)
    ...
    def get_crs_code(self):
        return self.handler.get_crs_code(self.layer_or_file_name)

    def get_geom_type(self):
        return self.handler.get_geom_type(self.layer_or_file_name)
