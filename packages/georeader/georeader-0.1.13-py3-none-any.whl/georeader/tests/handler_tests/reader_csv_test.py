...
csv_file_1 = str(Path.joinpath(root_dir, "test_files/UK_Historical_Earthquakes.csv"))
csv_file_2 = str(Path.joinpath(root_dir, "test_files/UK_Modern_Earthquakes.csv"))


class TestGeoreader_CSV(TestCase):
    def test_data_type(self):
        geo_reader_1 = GeoReader(csv_file_1)
        self.assertEqual(geo_reader_1.data_type["name"], "csv")
