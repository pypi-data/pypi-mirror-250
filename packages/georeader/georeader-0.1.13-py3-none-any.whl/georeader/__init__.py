...
from georeader.handlers.helpers.handlers import (
    valid_file_types,
    valid_zip_types,
    valid_service_types,
    valid_db_types,
...
class GeoReader:
    def __init__(self, source: str, data_type: str = None):
        ...
        if self.handler_set is False:
            self.handler = self.get_handler()(source, self.data_type["name"])
    ...
    @staticmethod
    def create_pg_connection_str(
        db_name: str, db_user: str, db_pass: str, db_host: str = "localhost"
    ):
