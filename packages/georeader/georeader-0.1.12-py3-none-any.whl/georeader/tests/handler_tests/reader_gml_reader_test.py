...
gml_file_1 = str(Path.joinpath(root_dir, "test_files/UK_Historical_Earthquakes.gml"))


class TestGeoreader_EsriRest(TestCase):
    def test_data_type(self):
        geo_reader_1 = GeoReader(gml_file_1)
        self.assertEqual(geo_reader_1.data_type["name"], "gml")
