...
class ResponseManager:
    ...
    def get_prompt_as_previous(self):
        admin_bool_values = self.prompt_mgr.instruction_data[self.chunk_token_distribution_number]['bool_values']
        prompt_as_previous = admin_bool_values['prompt_as_previous']
        return self.api_response if prompt_as_previous else prompt_as_previous 
    ...
    def send_query(self)->None:
        ...
        self.prompt = self.prompt_mgr.create_prompt(chunk_token_distribution_number=self.chunk_token_distribution_number,
                                                    ...
                                                    prompt_as_previous=self.get_prompt_as_previous())
    ...
    def initial_query(self)->list[dict]:
        ...
        """
        self.api_response='api_response_default'
        self.query_done=False
        self.i_query = 0
        self.total_dists = 0
