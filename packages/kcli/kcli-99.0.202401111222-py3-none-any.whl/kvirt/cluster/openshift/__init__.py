...
def create(config, plandir, cluster, overrides, dnsconfig=None):
    ...
    ctlplane_localhost_fix = data.get('ctlplane_localhost_fix')
    worker_localhost_fix = data.get('worker_localhost_fix')
    ...
    if sno:
        ...
        if sno_files:
            ...
            with open(f"{clusterdir}/openshift/99-sno.yaml", 'w') as f:
                f.write(rendered)
        ctlplane_localhost_fix = ctlplane_localhost_fix or localhost_fix
        worker_localhost_fix = worker_localhost_fix or localhost_fix
