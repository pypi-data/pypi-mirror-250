...
def add_heatmap_layer(f_map, data):
    """
    Add a heatmap layer to the map.
    """
    heatmap_layer = HeatMap(data, min_opacity=0.5, radius=25, blur=15, max_zoom=1, name='Population HeatMap')
    heatmap_layer.add_to(f_map)


def add_chloropleth_layer(f_map, shapefile_gdf, pop_density_df):
    """
    Add a chloropleth layer to map.
    """
    ...
    folium.Choropleth(
        ...
        fill_color='YlOrRd').add_to(f_map)
