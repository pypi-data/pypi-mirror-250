class compoundLexemeController:
        ...
        Returns:
            {
              ...
              "response": {
                ...
                "references": {
                  "example": [],
                  "items": {
                    "$ref": "#/components/schemas/CompoundLexemeReference"
                  },
                  "type": "array"
                },
                "valid": {
    ...
    def edit(self, id, **kwargs):
        ...
        all_api_parameters = {'id': {'name': 'id', 'required': True, 'in': 'query'}, 'languageId': {'name': 'languageId', 'required': False, 'in': 'query'}, 'name': {'name': 'name', 'required': False, 'in': 'query'}, 'enabled': {'name': 'enabled', 'required': False, 'in': 'query'}, 'body': {'name': 'body', 'required': 'false', 'in': 'body'}}
        parameters_names_map = {}
    ...
    def clone(self, sourceId, **kwargs):
        """
        ...
        all_api_parameters = {'sourceId': {'name': 'sourceId', 'required': True, 'in': 'query'}, 'targetId': {'name': 'targetId', 'required': False, 'in': 'query'}, 'includeLabels': {'name': 'includeLabels', 'required': False, 'in': 'query'}}
        parameters_names_map = {}
        api = '/compoundLexeme/clone'
        actions = ['post']
        consumes = ['[]']
        params, data = self._gracie._format_params_for_api(locals(), all_api_parameters, parameters_names_map)
        return self._gracie._process_api(self._controller_name, api, actions, params, data, consumes)
    ...
    def add(self, name, **kwargs):
        ...
        all_api_parameters = {'name': {'name': 'name', 'required': True, 'in': 'query'}, 'languageId': {'name': 'languageId', 'required': False, 'in': 'query'}, 'enabled': {'name': 'enabled', 'required': False, 'in': 'query'}, 'body': {'name': 'body', 'required': 'true', 'in': 'body'}}
        parameters_names_map = {}
