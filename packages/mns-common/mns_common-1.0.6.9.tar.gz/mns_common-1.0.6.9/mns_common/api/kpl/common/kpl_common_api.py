...
def get_plate_index(index_type):
    url = (
            f"https://apphq.longhuvip.com/w1/api/index.php?Index=0"
            f"&Order=1&PhoneOSNew=2&Type=1&VerSion=5.11.0.3"
            f"&ZSType=" + str(index_type) +
            f"&a=RealRankingInfo&apiv=w33&c=ZhiShuRanking"
            f"&st=" + str(PLATE_COUNT))
    headers = {
