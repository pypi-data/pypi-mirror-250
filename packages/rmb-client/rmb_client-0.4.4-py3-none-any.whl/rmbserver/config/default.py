...
# 用户上传文件的存储位置
oss_ugc_access_key_id = os.environ.get("OSS_UGC_ACCESS_KEY_ID", oss_access_key_id)
oss_ugc_access_key_secret = os.environ.get("OSS_UGC_ACCESS_KEY_SECRET", oss_access_key_secret)
oss_ugc_endpoint = os.environ.get("OSS_UGC_ENDPOINT", '')
oss_ugc_bucket_name = os.environ.get("OSS_UGC_BUCKET_NAME", '')
