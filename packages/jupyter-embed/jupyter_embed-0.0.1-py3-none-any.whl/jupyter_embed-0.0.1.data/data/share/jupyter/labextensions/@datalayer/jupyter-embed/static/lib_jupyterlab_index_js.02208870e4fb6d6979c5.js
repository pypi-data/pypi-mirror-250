"use strict";
(self["webpackChunk_datalayer_jupyter_embed"] = self["webpackChunk_datalayer_jupyter_embed"] || []).push([["lib_jupyterlab_index_js"],{
...
/* harmony import */ var _datalayer_icons_react__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @datalayer/icons-react */ "../../../node_modules/@datalayer/icons-react/data2/esm/WhaleSpoutingIcon.js");
...
const JupyterEmbed = (props) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
        (0,_jupyterlab_handler__WEBPACK_IMPORTED_MODULE_3__.requestAPI)('config')
            ...
            .catch(reason => {
            console.error(`Error while accessing the jupyter server jupyter_embed extension.\n${reason}`);
        });
    }, []);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (JupyterEmbed);
...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, 'jupyter_embed', // API Namespace
    endPoint);
    let response;
    try {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "IJupyterEmbed": () => (/* binding */ IJupyterEmbed),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
/* harmony import */ var _datalayer_icons_react_data2_WhaleSpoutingIconJupyterLab__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @datalayer/icons-react/data2/WhaleSpoutingIconJupyterLab */ "../../../node_modules/@datalayer/icons-react/data2/esm/WhaleSpoutingIconJupyterLab.js");
...
const IJupyterEmbed = new _lumino_coreutils__WEBPACK_IMPORTED_MODULE_0__.Token('@datalayer/jupyter-embed:plugin');
/**
 * The command IDs used by the plugin.
 */
var CommandIDs;
(function (CommandIDs) {
    CommandIDs.create = 'create-jupyter-embed-widget';
})(CommandIDs || (CommandIDs = {}));
/**
 * Initialization data for the @datalayer/jupyter-embed extension.
 */
const plugin = {
    id: '@datalayer/jupyter-embed:plugin',
    autoStart: true,
    ...
    activate: (app, palette, settingRegistry, launcher, restorer) => {
        ...
        commands.addCommand(command, {
            caption: 'Show Jupyter Embed',
            label: 'Jupyter Embed',
            icon: _datalayer_icons_react_data2_WhaleSpoutingIconJupyterLab__WEBPACK_IMPORTED_MODULE_9__["default"],
            execute: () => {
                const content = new _widget__WEBPACK_IMPORTED_MODULE_10__.JupyterEmbedWidget(app, jupyterDocker);
                const widget = new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.MainAreaWidget({ content });
                widget.title.label = 'Jupyter Embed';
                widget.title.icon = _datalayer_icons_react_data2_WhaleSpoutingIconJupyterLab__WEBPACK_IMPORTED_MODULE_9__["default"];
        ...
        if (settingRegistry) {
            settingRegistry
                .load(plugin.id)
                .then(settings => {
                console.log('@datalayer/jupyter-embed settings loaded:', settings.composite);
            })
                .catch(reason => {
                console.error('Failed to load settings for @datalayer/jupyter-embed.', reason);
            });
        }
        ...
        console.log('JupyterLab plugin @datalayer/jupyter-embed:plugin is activated.');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "JupyterEmbedWidget": () => (/* binding */ JupyterEmbedWidget)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ "../../../node_modules/react/jsx-runtime.js");
...
/* harmony import */ var _Docker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../Docker */ "./lib/Docker.js");




class JupyterEmbedWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    _app;
    //  private _jupyterDocker: IJupyterEmbed;
    constructor(app, jupyterDocker) {
        super();
        this._app = app;
    ...
    render() {
        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_Docker__WEBPACK_IMPORTED_MODULE_3__["default"], { adapter: _datalayer_jupyter_react__WEBPACK_IMPORTED_MODULE_2__.JupyterLabAppAdapter.create(this._app) }) }));
    }
}
...
const MobxTimerView = (0,mobx_react__WEBPACK_IMPORTED_MODULE_2__.observer)(({ mobxTimer }) => ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("button", { onClick: () => mobxTimer.reset(), children: ["Jupyter Embed Mobx: ", mobxTimer.secondsPassed] })));
...
const AboutTab = (props) => {
    ...
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_primer_react__WEBPACK_IMPORTED_MODULE_2__["default"], { as: "h2", children: ["\uD83E\uDE90 \uD83C\uDF81 Jupyter Embed", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_3__["default"], { sx: { marginLeft: 1 }, children: version })] }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_4__["default"], { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_5__["default"], { children: "Manage Docker from Jupyter." }) }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_4__["default"], { mt: 3, style: { width: 350 }, children: !egg ?
                    (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("img", { src: "https://assets.datalayer.tech/releases/datalayer-0.3.0-black-snake_1024.png", onClick: e => setEgg(true) })
                    :
                        (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_datalayer_icons_react_eggs__WEBPACK_IMPORTED_MODULE_6__["default"], { size: 300, onClick: e => setEgg(false) }) }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_4__["default"], { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_7__["default"], { href: "https://datalayer.tech/docs/releases/0.3.0-black-snake", target: "_blank", children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_5__["default"], { as: "h4", children: "Datalayer 0.3.0 Black Snake Release" }) }) }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_4__["default"], { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_7__["default"], { href: "https://github.com/datalayer/jupyter-embed", target: "_blank", children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_5__["default"], { as: "h4", children: "Source code" }) }) })] }));
};
...
/* harmony import */ var _datalayer_icons_react__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @datalayer/icons-react */ "../../../node_modules/@datalayer/icons-react/data1/esm/TerminalIcon.js");
...
const Images = () => {
    ...
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_4__["default"], { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_5__.Table.Container, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_5__.Table.Title, { as: "h2", id: "images", children: "Docker images" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_5__.Table.Subtitle, { as: "p", id: "images-subtitle", children: "List of Docker images." }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_6__.DataTable, { "aria-labelledby": "images", "aria-describedby": "images-subtitle", data: images, columns: [
                            {
                                header: 'Image Name',
                                field: 'RepoTags',
...
const Networks = () => {
    ...
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_3__["default"], { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_4__.Table.Container, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_4__.Table.Title, { as: "h2", id: "networks", children: "Docker networks" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_4__.Table.Subtitle, { as: "p", id: "networks-subtitle", children: "List of Docker networks." }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_5__.DataTable, { "aria-labelledby": "networks", "aria-describedby": "networks-subtitle", data: networks, columns: [
                            {
                                header: 'Name',
                                field: 'Name',
...
const Secrets = () => {
    ...
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_3__["default"], { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_4__.Table.Container, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_4__.Table.Title, { as: "h2", id: "secrets", children: "Docker secrets" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_4__.Table.Subtitle, { as: "p", id: "secrets-subtitle", children: "List of Docker secrets." }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_5__.DataTable, { "aria-labelledby": "secrets", "aria-describedby": "secrets-subtitle", data: secrets, columns: [
                            {
                                header: 'Name',
                                field: 'Spec.Name',
...
const Volumes = () => {
    ...
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_3__["default"], { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_4__.Table.Container, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_4__.Table.Title, { as: "h2", id: "volumes", children: "Docker volumes" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_4__.Table.Subtitle, { as: "p", id: "volumes-subtitle", children: "List of Docker volumes." }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react_drafts__WEBPACK_IMPORTED_MODULE_5__.DataTable, { "aria-labelledby": "volumes", "aria-describedby": "volumes-subtitle", data: volumes, columns: [
                            {
                                header: 'Name',
                                field: 'Name',
                                renderCell: row => (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_primer_react__WEBPACK_IMPORTED_MODULE_6__["default"], { children: row.Name })
...
const TimerView = () => {
    ...
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("button", { onClick: () => timer.reset(), children: ["Jupyter Embed: ", secondsPassed] }));
};
...
//# sourceMappingURL=lib_jupyterlab_index_js.02208870e4fb6d6979c5.js.map