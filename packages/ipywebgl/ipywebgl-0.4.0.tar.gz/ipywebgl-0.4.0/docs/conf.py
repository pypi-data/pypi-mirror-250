...
# -*- coding: utf-8 -*-
#
# ipywebgl documentation build configuration file
#
...
latex_documents = [
    (master_doc, 'ipywebgl.tex', 'ipywebgl Documentation',
     'Jerome Eippers', 'manual'),
]
