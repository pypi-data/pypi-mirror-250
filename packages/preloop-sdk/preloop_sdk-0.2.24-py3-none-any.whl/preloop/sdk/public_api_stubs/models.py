...
class SQLDataSourceDetails(DataSourceDetails):
    connection_params: ConnectionParamsSQL
    auth_params: AuthParamsSQL
    schema_and_types: Dict[Any, Any]


class S3DataSourceDetails(DataSourceDetails):
    bucket_name: str
    object_key: str


class ListDatasourcesResult(BaseModel):
    datasources: List[SQLDataSourceDetails | S3DataSourceDetails]
