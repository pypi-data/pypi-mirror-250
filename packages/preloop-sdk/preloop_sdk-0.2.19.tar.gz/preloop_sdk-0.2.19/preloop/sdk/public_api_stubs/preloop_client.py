...
class PreloopClient:
    ...
    def list_datasources(self, request: Optional[ListDatasourcesRequest] = None) -> List[ListDatasourcesResult]:
        """
        ...
        response_validation = _ListDatasourcesResultArray(array_list=json.loads(response.text))
        return response_validation.array_list
