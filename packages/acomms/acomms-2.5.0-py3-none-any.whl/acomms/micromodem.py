...
class Micromodem(object):
    ...
    def on_snnst(self, snnst: NavStatistics, msg: Message) -> None:
        self._daemon_log.debug(f"/Micromodem.on_snnst.MSG {msg}")
        self._daemon_log.debug(f"/Micromodem.on_snnst.NST {snnst}")
    ...
    def on_snpdt(self, snpdt: NavPingDigitalTransponder, msg: Message) -> None:
        self._daemon_log.debug(f"/Micromodem.on_snpdt.MSG {msg}")
        self._daemon_log.debug(f"/Micromodem.on_snpdt.PDT {snpdt}")
    ...
    def on_snpgt(self, snpgt: NavPingGenericTransponder, msg: Message) -> None:
        self._daemon_log.debug(f"/Micromodem.on_snpgt.MSG {msg}")
        self._daemon_log.debug(f"/Micromodem.on_snpgt.PGT {snpgt}")
    ...
    def on_sntta(self, sntta: NavTurnTimes, msg: Message) -> None:
        self._daemon_log.debug(f"/Micromodem.on_sntta.MSG {msg}")
        self._daemon_log.debug(f"/Micromodem.on_sntta.TTA {sntta}")
