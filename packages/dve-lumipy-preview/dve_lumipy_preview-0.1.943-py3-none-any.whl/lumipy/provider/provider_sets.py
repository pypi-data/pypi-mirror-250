...
from lumipy.provider.implementation.test_providers import TestProvider, TestFilterProvider, TestTableParamProvider
...
def int_test():
    ...
    return [titanic, TestProvider.variant1(), TestFilterProvider(), TestTableParamProvider()]
