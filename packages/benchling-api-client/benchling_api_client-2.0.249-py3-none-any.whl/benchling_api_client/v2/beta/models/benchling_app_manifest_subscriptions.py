...
class BenchlingAppManifestSubscriptions:
    ...
    _messages: List[EventCreatedMessageSubscriptionV0Alpha]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_messages() -> List[EventCreatedMessageSubscriptionV0Alpha]:
            messages = []
        ...
        try:
            ...
            if strict:
                raise
            messages = cast(List[EventCreatedMessageSubscriptionV0Alpha], UNSET)
    ...
    @property
    def messages(self) -> List[EventCreatedMessageSubscriptionV0Alpha]:
        if isinstance(self._messages, Unset):
            raise NotPresentError(self, "messages")
        return self._messages

    @messages.setter
    def messages(self, value: List[EventCreatedMessageSubscriptionV0Alpha]) -> None:
