...
import PhrameServer
from PhrameServer.models.phrame_ui_configuration import PhrameUIConfiguration  # noqa: E501
from PhrameServer.rest import ApiException

class TestPhrameUIConfiguration(unittest.TestCase):
    """PhrameUIConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PhrameUIConfiguration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = PhrameServer.models.phrame_ui_configuration.PhrameUIConfiguration()  # noqa: E501
        if include_optional :
            return PhrameUIConfiguration(
                id = '', 
                description = '', 
                target_resolutions = [
    ...
    def testPhrameUIConfiguration(self):
        """Test PhrameUIConfiguration"""
