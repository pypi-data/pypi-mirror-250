...
from .tool import (
    ...
    keep_writing_if_over_max_length,
    parse_args,
    pip_install,
...
class OpenAI:
    ...
    def set_browser_functions(self):
        search_on_web_by_duckduckgo, visit_page = get_browser_functions(self)
        self.set_function(search_on_web_by_duckduckgo)
    ...
    def set_utility_functions(self):
        self.set_function(keep_writing_if_over_max_length)
