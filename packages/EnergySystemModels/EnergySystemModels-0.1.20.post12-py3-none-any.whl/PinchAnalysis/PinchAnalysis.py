...
class Object:
    ...
    def below_above_stream(self):
        ...
        for index, row in self.stream_list.iterrows():
            ...
            if self.stream_list.loc[index, 'StreamType']=='HS':
                row_below = row.copy()
                #print('row_below_copie=====================================================',row_below)
                if self.Pinch_Temperature<=row_below['STi']:
                    row_below['STi'] = self.Pinch_Temperature
             
                new_rows.append(row_below)
                #print("new_row_below generated==============================================")
                #print(new_rows)

            if self.stream_list.loc[index, 'StreamType']=='CS':
                row_below = row.copy()
                #print('row_below_copie=====================================================',row_below)
...
###################################################################################
            if self.stream_list.loc[index, 'StreamType']=='HS':
                row_above = row.copy()
                #print('row_above_copie=====================================================',row_above)
                if self.Pinch_Temperature<=row_above['STi']:
                    row_above['STi'] = self.Pinch_Temperature
             
                new_rows.append(row_above)
                #print("new_row_above generated==============================================")
                #print(new_rows)

            if self.stream_list.loc[index, 'StreamType']=='CS':
                row_above = row.copy()
                #print('row_below_copie=====================================================',row_above)
            ...
            # if self.Pinch_Temperature<=self.stream_list.loc[index, 'STi']-1222222:
            #     row_above = row.copy()
            #     #if self.Pinch_Temperature<=row_above['STi']:
            #     row_above['STi'] = self.Pinch_Temperature
