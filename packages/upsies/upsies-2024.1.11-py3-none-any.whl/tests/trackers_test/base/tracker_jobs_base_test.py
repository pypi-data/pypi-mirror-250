...
@pytest.fixture
def mocks_for_get_poster_from_user(make_TestTrackerJobs, mocker):
    jobs = make_TestTrackerJobs()
    mocks = Mock()
...
@pytest.mark.asyncio
async def test_get_poster_from_webdb__no_poster_webdb_job(mocks_for_get_poster_from_user, mocker):
    tracker_jobs, mocks = mocks_for_get_poster_from_user
...
@pytest.mark.asyncio
async def test_get_poster_from_webdb__webdb_cannot_find_poster(mocks_for_get_poster_from_user):
    tracker_jobs, mocks = mocks_for_get_poster_from_user
...
@pytest.mark.asyncio
async def test_get_poster_from_webdb__returns_poster(mocks_for_get_poster_from_user):
    tracker_jobs, mocks = mocks_for_get_poster_from_user
...
@pytest.mark.asyncio
async def test_get_poster_from_webdb__ignores_RequestError(mocks_for_get_poster_from_user):
    tracker_jobs, mocks = mocks_for_get_poster_from_user
