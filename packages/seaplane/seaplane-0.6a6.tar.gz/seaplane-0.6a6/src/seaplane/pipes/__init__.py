...
EdgeFrom = Union[Task, Subscription]
EdgeTo = Union[Task, Subject]
...
class App:
    ...
    def task(
        ...
        if prefixed_name in self.task_registry:
            raise SeaplaneError(
        ...
        subject = _TaskSubject(self.name, prefixed_name)
        ret = Task(self, work, prefixed_name, subject, replicas, ack_wait_secs)
        self.task_registry[ret.instance_name] = ret
        return ret
