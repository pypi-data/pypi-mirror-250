...
class Result:
    """
    a Result is a package that allows tasks to return metadata along with
    their primary payload.

    Get one of these by calling TaskContext.result(), like this:
    ...
    def __init__(self, body: bytes, context: "TaskContext"):
        self.body = body
...
def execute_task(task_name: str, work: Callable[..., Any]) -> None:
    ...
    while True:
        try:
            ...
            log.logger.error(f"Error running Task {task_name}, sleeping", exc_info=e)
