"""
PrefRef - A basic config package that reads a JSON config file, environment variables, and console arguments (prioritized in that order)
"""

# from .prefref import *
# from prefref.prefref import *
from prefref import *
