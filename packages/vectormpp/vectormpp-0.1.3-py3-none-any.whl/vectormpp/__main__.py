import os, sys, yaml, shutil, dotenv, argparse, logging, traceback, multiprocessing
...
def main():
    ...
    if len(sys.argv) == 1 or not (args.install_or_upgrade or args.uninstall or args.graph):
        parser.print_help()
        parser.exit()
    ...
    try:
        ...
        manifest = Manifest(args.workdir, args.rundir)
