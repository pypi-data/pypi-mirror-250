  ...
  'syms': { 'nanorag.base': { 'nanorag.base.BaseNode': ('base.html#basenode', 'nanorag/base.py'),
            ...
            'nanorag.context': { 'nanorag.context.ModelContext': ('context.html#modelcontext', 'nanorag/context.py'),
                                 ...
                                 'nanorag.context.ModelContext.set_default': ( 'context.html#modelcontext.set_default',
                                                                               'nanorag/context.py')},
            'nanorag.indexing': { 'nanorag.indexing.VectorIndex': ('indexing.html#vectorindex', 'nanorag/indexing.py'),
                                  'nanorag.indexing.VectorIndex.__init__': ('indexing.html#vectorindex.__init__', 'nanorag/indexing.py'),
                                  'nanorag.indexing.VectorIndex.add': ('indexing.html#vectorindex.add', 'nanorag/indexing.py'),
                                  'nanorag.indexing.VectorIndex.get_embedding': ( 'indexing.html#vectorindex.get_embedding',
                                                                                  'nanorag/indexing.py')},
