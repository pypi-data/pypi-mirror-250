...
apt install -y --no-install-recommends make gcc clang git python3 \
    ...
    binutils-mips64-linux-gnuabi64 binutils-powerpc64le-linux-gnu \
    binutils-powerpc64-linux-gnu binutils-riscv64-linux-gnu \
    binutils-sparc64-linux-gnu binutils-s390x-linux-gnu libc6-dev-arm64-cross \
    ...
    libc6-dev libc6-dev-sparc64-cross > /dev/null 2>&1;
