...
def getGaiaOverlay(plot,ra,dec,sizeAS,mjd,border,pmra=None,pmdec=None):
	...
	# if pmra and pmdec are provided, scale detection radius to include possible proper motion of objects
	...
	if isinstance(nearby,pd.DataFrame):
		...
		print('No Gaia detections found. This will limit accuracy of other detection overlays.')
		return plot, detections_made
