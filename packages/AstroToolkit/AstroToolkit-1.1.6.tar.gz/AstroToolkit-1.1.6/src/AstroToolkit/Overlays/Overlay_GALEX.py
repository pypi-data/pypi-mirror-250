...
'''
Functionality is essentially the same in all overlay functions, so refer to Overlay_Gaia for further comments
'''

'''
Functionality of all overlays other than Gaia follows this process:
1. Get Gaia detections for proper motions
2. Proper motion correct these Gaia detections back to the time of any other overlay (e.g. GALEX)
3. do a radius search around this new corrected gaia location and see if it picks up any detections in the selected overlays
4. use proper motions obtained from Gaia to correct these and any picked up detections to the image time
'''
