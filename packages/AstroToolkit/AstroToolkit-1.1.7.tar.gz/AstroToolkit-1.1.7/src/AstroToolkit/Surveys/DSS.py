...
def get_image(ra,dec,size=30):
	...
	# reads the resulting .fits data and gets its header, sets any nan values to zero and applies a contrast filter to improve readability
	try:
...
def get_info(ra,dec,size=30):
	...
	# converts time into required format
	...
	# converts time into a supported format by Time object
...
'''
Sets up axes and places image on them
'''
