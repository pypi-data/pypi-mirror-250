...
def overlaySelection(plot,ra,dec,overlay,mjd,sizeAS,border,pmra=None,pmdec=None):
	...
	# check which overlays are required
	...
	# if adaptive_correction is true, passes pmra and pmdec of object to the detection overlays which scales the search radius
	adaptive_correction=True
	if pmra==None and pmdec==None:
		adaptive_correction=False

	# applies required overlays
	if 'gaia' in overlay:
