...
class ChessBoard:
    ...
    ASSUME_NO_PIECE_DROPS: ClassVar[bool] = True
    """Assume that pieces cannot be dropped on the board, as in Crazyhouse."""
    ...
    def __init__(
        ...
        *,
        ...
        self._hashes: Counter[int] = Counter()
    ...
    def alternate_turn(
        ...
        if self.ASSUME_NO_PIECE_DROPS and reset_hashes:
            self._hashes = Counter()
        else:
