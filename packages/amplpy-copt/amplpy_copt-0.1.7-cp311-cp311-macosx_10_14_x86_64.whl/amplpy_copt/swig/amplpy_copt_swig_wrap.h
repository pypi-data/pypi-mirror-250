...
#ifndef SWIG_amplpy_copt_swig_WRAP_H_
#define SWIG_amplpy_copt_swig_WRAP_H_
...
class SwigDirector_CoptCallback : public ampls::CoptCallback, public Swig::Director {

public:
    SwigDirector_CoptCallback(PyObject *self);
    virtual int doAddCut(ampls::Constraint const &c,int type);
    virtual int doAddCutSwigPublic(ampls::Constraint const &c,int type) {
      return ampls::CoptCallback::doAddCut(c,type);
    }
    virtual ampls::Variant getValueImpl(ampls::Value::CBValue v);
    virtual ampls::Variant getValueImplSwigPublic(ampls::Value::CBValue v) {
    ...
    virtual bool canDo(ampls::CanDo::Functionality f);
    virtual int run();
    virtual ~SwigDirector_CoptCallback();
    virtual int setHeuristicSolution(int nvars,int const *indices,double const *values);
    virtual std::vector< double,std::allocator< double > > getSolutionVector();
    virtual int getSolution(int len,double *sol);
    virtual double getObj();
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (!method) {
          std::string msg = "Method in class CoptCallback doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
