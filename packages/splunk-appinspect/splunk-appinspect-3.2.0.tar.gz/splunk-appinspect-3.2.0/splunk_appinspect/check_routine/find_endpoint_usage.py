...
def find_endpoint_usage(
...
) -> typing.Generator[tuple[Path, int], typing.Any, None]:
    """
    ...
    Args:
        app: app to search for endpoint usages.
        kws: List of endpoint patterns (regex) to find in app.
        regex_file_types: List of regex patters for file listing for search.

    Yields:
        File path and a line number of found match.
