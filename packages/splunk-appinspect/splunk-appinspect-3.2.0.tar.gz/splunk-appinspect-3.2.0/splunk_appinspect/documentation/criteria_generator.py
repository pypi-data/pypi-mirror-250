...
def generate_criteria_as_html(
    included_tags: Optional[list[Tags]] = None,
    excluded_tags: Optional[list[Tags]] = None,
    custom_checks_dir: Optional[str] = None,
) -> str:
    """
    Generates an HTML page that lists the criteria required for certification.
    See: http://dev.splunk.com/view/app-cert/SP-CAAAE3H

    Returns:
        A string that is the HTML markup that is the criteria page used for Splunk AppInspect releases.
