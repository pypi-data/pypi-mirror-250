...
class Binomial(Distribution):
    ...
    def __init__(self, prob=.5, size=20):
        ...
        #
        #       Then in the init function initialize the Distribution class with the
    ...
    def replace_stats_with_data(self):
        ...
        #       a distribution. Hence you are going to write a method that calculates:
        #            n, p, mean and standard deviation 
        #       from a data set and then updates the n, p, mean and stdev attributes.
        ...
        #           defined previously.
        # file_name = "/Volumes/Elements/python_practice/bertelsmann/OOP/3a_python_package/numbers_binomial.txt"
        # self.read_data_file(file_name)
        # print("SelfData:", self.data)


        self.n = len(self.data)
        # use the sample mean as the probability of success
    ...
    def pdf(self, k):
        ...
        # prob_density = math.comb(self.n, k) * (self.p ** k) * (1 - self.p) ** (self.n - k)
    ...
    def plot_bar_pdf(self):
        ...
        #   density function for every value of k (k should be the number of successfull trials).
