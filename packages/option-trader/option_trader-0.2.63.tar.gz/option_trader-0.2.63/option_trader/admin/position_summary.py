schema = "symbol TEXT,strategy TEXT, credit TEXT, status TEXT, exp_date TEXT,\
        ...
        ib_p_status TEXT, ib_t_status TEXT, ib_s_status TEXT,\
        ib_filled INTEGER, ib_remaining INTEGER, ib_lastFillPrice REAL,\
        ib_p_orderId INTEGER, ib_t_orderId INTEGER, ib_s_orderId INTEGER, ib_clientId INTEGER,\
        primary key(uuid)"
...
class position_summary_col_name():
    ...
    IB_P_STATUS       = 'ib_p_status'
    IB_T_STATUS       = 'ib_t_status'
    IB_S_STATUS       = 'ib_s_status' 
    IB_P_ORDER_ID     = 'ib_p_orderId'
    IB_T_ORDER_ID     = 'ib_t_orderId'
    IB_S_ORDER_ID     = 'ib_s_orderId'   
