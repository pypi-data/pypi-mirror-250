...
BioSAK hpc3  -c "blastp -h" -n blastp -q cpu-share -conda mybase
BioSAK hpc3  -c "blastp -h" -n test -q cpu -conda gtdbtk
...
if __name__ == '__main__':
    ...
    hpc3_parser.add_argument('-a',        required=False, default='oces',         help='-A, boqianpy or oces, default: oces')
