...
# row2=[{'annotatorType': 'chunk', 'begin': 0, 'end': 4, 'result': 'Peter', 'metadata': [('entity', 'PERSON'), ('sentence', '0'), ('chunk', '0'), ('confidence', '0.9987')], 'embeddings': array([], dtype=float32)}
#       {'annotatorType': 'chunk', 'begin': 12, 'end': 18, 'result': 'Germany', 'metadata': [('entity', 'GPE'), ('sentence', '0'), ('chunk', '1'), ('confidence', '0.9606')], 'embeddings': array([], dtype=float32)}]
