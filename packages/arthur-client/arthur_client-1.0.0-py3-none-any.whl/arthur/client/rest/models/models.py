...
#   timestamp: 2024-01-09T15:45:35+00:00
...
class ModelDefaultColumns(BaseModel):
    columns: List[str]
    """
    The default columns to be displayed to the user for the model's "Inferences Deep Dive" page. Each item in the "columns" section of the response corresponds to either a model attribute name or a pre-defined column name for non-attribute columns such as inference_id, partner_inference_id, inference_timestamp, anomaly_score, or raw_anomaly_score.
    """


class ModelDefaultColumnsPatchRequest(BaseModel):
    columns_to_add: Optional[List[str]] = None
    """
    The default columns to append to the end of the list of default columns for the specified model. Each item in the "columns_to_add" section of the response corresponds to either a model attribute name or a pre-defined column name for non-attribute columns such as inference_id, partner_inference_id, inference_timestamp, anomaly_score, or raw_anomaly_score.
    """
    columns_to_remove: Optional[List[str]] = None
    """
    A list of columns to remove from the existing model default columns. All columns specified must exist in the list of default columns for this model.
    """
