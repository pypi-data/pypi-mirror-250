...
class Forms2OleControl(aspose.words.drawing.ole.OleControl):
    ...
    def as_text_box_control(self) -> aspose.words.forms2.TextBoxControl:
        """Casts Forms2OleControl to :class:`aspose.words.forms2.TextBoxControl`, otherwise returns null."""
        ...
