...
class DetailedCheckDns(object):
    ...
    """
    swagger_types = {
        'check': 'AllOfDetailedCheckDnsCheck'
    }
    ...
    def __init__(self, check=None):  # noqa: E501
        """DetailedCheckDns - a model defined in Swagger"""  # noqa: E501
        self._check = None
    ...
    @property
    def check(self):
        """Gets the check of this DetailedCheckDns.  # noqa: E501


        :return: The check of this DetailedCheckDns.  # noqa: E501
        :rtype: AllOfDetailedCheckDnsCheck
        """
        return self._check

    @check.setter
    def check(self, check):
        """Sets the check of this DetailedCheckDns.


        :param check: The check of this DetailedCheckDns.  # noqa: E501
        :type: AllOfDetailedCheckDnsCheck
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DetailedCheckDns, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetailedCheckDns):
            return False
