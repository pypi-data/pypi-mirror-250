...
class AnalysisRespAttrsAnalysis(object):
    ...
    attribute_map = {
        'id': 'id',
        'timefirsttest': 'timefirsttest',
        'timeconfirmtest': 'timeconfirmtest'
    }

    def __init__(self, id=None, timefirsttest=None, timeconfirmtest=None):  # noqa: E501
        """AnalysisRespAttrsAnalysis - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._timefirsttest = None
        self._timeconfirmtest = None
        self.discriminator = None
        if id is not None:
            self.id = id
        if timefirsttest is not None:
            self.timefirsttest = timefirsttest
        if timeconfirmtest is not None:
            self.timeconfirmtest = timeconfirmtest

    @property
    def id(self):
        """Gets the id of this AnalysisRespAttrsAnalysis.  # noqa: E501

        Analysis id  # noqa: E501

        :return: The id of this AnalysisRespAttrsAnalysis.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this AnalysisRespAttrsAnalysis.

        Analysis id  # noqa: E501

        :param id: The id of this AnalysisRespAttrsAnalysis.  # noqa: E501
        :type: int
        """
    ...
    @property
    def timefirsttest(self):
        """Gets the timefirsttest of this AnalysisRespAttrsAnalysis.  # noqa: E501

        Time of test that initiated the confirmation test  # noqa: E501

        :return: The timefirsttest of this AnalysisRespAttrsAnalysis.  # noqa: E501
        :rtype: int
        """
        return self._timefirsttest

    @timefirsttest.setter
    def timefirsttest(self, timefirsttest):
        """Sets the timefirsttest of this AnalysisRespAttrsAnalysis.

        Time of test that initiated the confirmation test  # noqa: E501

        :param timefirsttest: The timefirsttest of this AnalysisRespAttrsAnalysis.  # noqa: E501
        :type: int
        """

        self._timefirsttest = timefirsttest

    @property
    def timeconfirmtest(self):
        """Gets the timeconfirmtest of this AnalysisRespAttrsAnalysis.  # noqa: E501

        Time of the confirmation test that performed the error analysis  # noqa: E501

        :return: The timeconfirmtest of this AnalysisRespAttrsAnalysis.  # noqa: E501
        :rtype: int
        """
        return self._timeconfirmtest

    @timeconfirmtest.setter
    def timeconfirmtest(self, timeconfirmtest):
        """Sets the timeconfirmtest of this AnalysisRespAttrsAnalysis.

        Time of the confirmation test that performed the error analysis  # noqa: E501

        :param timeconfirmtest: The timeconfirmtest of this AnalysisRespAttrsAnalysis.  # noqa: E501
        :type: int
        """

        self._timeconfirmtest = timeconfirmtest
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AnalysisRespAttrsAnalysis, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnalysisRespAttrsAnalysis):
            return False
