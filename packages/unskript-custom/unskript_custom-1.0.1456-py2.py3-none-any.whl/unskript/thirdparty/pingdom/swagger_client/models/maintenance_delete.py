...
class MaintenanceDelete(object):
    ...
    def __init__(self, maintenanceids=None):  # noqa: E501
        """MaintenanceDelete - a model defined in Swagger"""  # noqa: E501
        self._maintenanceids = None
        self.discriminator = None
        self.maintenanceids = maintenanceids

    @property
    def maintenanceids(self):
        """Gets the maintenanceids of this MaintenanceDelete.  # noqa: E501

        Comma-separated list of identifiers of maintenance windows to be deleted.  # noqa: E501

        :return: The maintenanceids of this MaintenanceDelete.  # noqa: E501
        :rtype: list[int]
        """
        return self._maintenanceids

    @maintenanceids.setter
    def maintenanceids(self, maintenanceids):
        """Sets the maintenanceids of this MaintenanceDelete.

        Comma-separated list of identifiers of maintenance windows to be deleted.  # noqa: E501

        :param maintenanceids: The maintenanceids of this MaintenanceDelete.  # noqa: E501
        :type: list[int]
        """
        if maintenanceids is None:
            raise ValueError("Invalid value for `maintenanceids`, must not be `None`")  # noqa: E501

        self._maintenanceids = maintenanceids
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MaintenanceDelete, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MaintenanceDelete):
            return False
