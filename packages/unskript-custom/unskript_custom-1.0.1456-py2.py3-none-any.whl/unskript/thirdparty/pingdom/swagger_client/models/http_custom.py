...
class HTTPCustom(object):
    ...
    def __init__(self, host=None, type=None, probeid=None, probe_filters=None, ipv6=None, responsetime_threshold=30000, url=None, encryption=False, port=80, auth=None, additionalurls=None):  # noqa: E501
        """HTTPCustom - a model defined in Swagger"""  # noqa: E501
        self._host = None
        self._type = None
        self._probeid = None
    ...
    @property
    def host(self):
        """Gets the host of this HTTPCustom.  # noqa: E501

        Target host  # noqa: E501

        :return: The host of this HTTPCustom.  # noqa: E501
        :rtype: str
        """
        return self._host
    ...
    @host.setter
    def host(self, host):
        """Sets the host of this HTTPCustom.

        Target host  # noqa: E501

        :param host: The host of this HTTPCustom.  # noqa: E501
        :type: str
        """
        if host is None:
    ...
    @property
    def type(self):
        """Gets the type of this HTTPCustom.  # noqa: E501


        :return: The type of this HTTPCustom.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this HTTPCustom.


        :param type: The type of this HTTPCustom.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["httpcustom"]  # noqa: E501
    ...
    @property
    def probeid(self):
        """Gets the probeid of this HTTPCustom.  # noqa: E501

        Probe identifier  # noqa: E501

        :return: The probeid of this HTTPCustom.  # noqa: E501
        :rtype: int
        """
    ...
    def probeid(self, probeid):
        """Sets the probeid of this HTTPCustom.

        Probe identifier  # noqa: E501

        :param probeid: The probeid of this HTTPCustom.  # noqa: E501
        :type: int
        """
    ...
    def probe_filters(self):
        """Gets the probe_filters of this HTTPCustom.  # noqa: E501
        ...
        :return: The probe_filters of this HTTPCustom.  # noqa: E501
        :rtype: int
        """
    ...
    def probe_filters(self, probe_filters):
        """Sets the probe_filters of this HTTPCustom.

        Filters used for probe selections. Comma separated key:value pairs. Currently only region is supported. Possible values are 'EU', 'NA', 'APAC' and 'LATAM'.  # noqa: E501

        :param probe_filters: The probe_filters of this HTTPCustom.  # noqa: E501
        :type: int
        """
    ...
    @property
    def ipv6(self):
        """Gets the ipv6 of this HTTPCustom.  # noqa: E501

        Use ipv6 instead of ipv4  # noqa: E501

        :return: The ipv6 of this HTTPCustom.  # noqa: E501
        :rtype: bool
        """
        return self._ipv6
    ...
    @ipv6.setter
    def ipv6(self, ipv6):
        """Sets the ipv6 of this HTTPCustom.

        Use ipv6 instead of ipv4  # noqa: E501

        :param ipv6: The ipv6 of this HTTPCustom.  # noqa: E501
        :type: bool
        """
    ...
    def responsetime_threshold(self):
        """Gets the responsetime_threshold of this HTTPCustom.  # noqa: E501
        ...
        :return: The responsetime_threshold of this HTTPCustom.  # noqa: E501
        :rtype: int
        """
    ...
    def responsetime_threshold(self, responsetime_threshold):
        """Sets the responsetime_threshold of this HTTPCustom.

        Triggers a down alert if the response time exceeds threshold specified in ms (Not available for Starter and Free plans.)  # noqa: E501

        :param responsetime_threshold: The responsetime_threshold of this HTTPCustom.  # noqa: E501
        :type: int
        """
    ...
    @property
    def url(self):
        """Gets the url of this HTTPCustom.  # noqa: E501

        (httpcustom specific) Target path to XML file on server  # noqa: E501

        :return: The url of this HTTPCustom.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this HTTPCustom.

        (httpcustom specific) Target path to XML file on server  # noqa: E501

        :param url: The url of this HTTPCustom.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    @property
    def encryption(self):
        """Gets the encryption of this HTTPCustom.  # noqa: E501

        (httpcustom specific) Connection encryption  # noqa: E501

        :return: The encryption of this HTTPCustom.  # noqa: E501
        :rtype: bool
        """
    ...
    def encryption(self, encryption):
        """Sets the encryption of this HTTPCustom.

        (httpcustom specific) Connection encryption  # noqa: E501

        :param encryption: The encryption of this HTTPCustom.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def port(self):
        """Gets the port of this HTTPCustom.  # noqa: E501

        (httpcustom specific) Target port  # noqa: E501

        :return: The port of this HTTPCustom.  # noqa: E501
        :rtype: int
        """
        return self._port
    ...
    @port.setter
    def port(self, port):
        """Sets the port of this HTTPCustom.

        (httpcustom specific) Target port  # noqa: E501

        :param port: The port of this HTTPCustom.  # noqa: E501
        :type: int
        """
    ...
    @property
    def auth(self):
        """Gets the auth of this HTTPCustom.  # noqa: E501

        (httpcustom specific) Username and password for target HTTP authentication.  # noqa: E501

        :return: The auth of this HTTPCustom.  # noqa: E501
        :rtype: str
        """
        return self._auth
    ...
    @auth.setter
    def auth(self, auth):
        """Sets the auth of this HTTPCustom.

        (httpcustom specific) Username and password for target HTTP authentication.  # noqa: E501

        :param auth: The auth of this HTTPCustom.  # noqa: E501
        :type: str
        """
    ...
    def additionalurls(self):
        """Gets the additionalurls of this HTTPCustom.  # noqa: E501

        (httpcustom specific) ;-separated list of addidional URLs with hostname included.  # noqa: E501

        :return: The additionalurls of this HTTPCustom.  # noqa: E501
        :rtype: str
        """
        return self._additionalurls

    @additionalurls.setter
    def additionalurls(self, additionalurls):
        """Sets the additionalurls of this HTTPCustom.

        (httpcustom specific) ;-separated list of addidional URLs with hostname included.  # noqa: E501

        :param additionalurls: The additionalurls of this HTTPCustom.  # noqa: E501
        :type: str
        """

        self._additionalurls = additionalurls
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HTTPCustom):
            return False
