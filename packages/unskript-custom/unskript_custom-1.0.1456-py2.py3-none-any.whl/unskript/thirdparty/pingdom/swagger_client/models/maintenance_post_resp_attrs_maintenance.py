...
class MaintenancePostRespAttrsMaintenance(object):
    ...
    def __init__(self, id=None):  # noqa: E501
        """MaintenancePostRespAttrsMaintenance - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this MaintenancePostRespAttrsMaintenance.  # noqa: E501

        Unique id of the new maintenance window  # noqa: E501

        :return: The id of this MaintenancePostRespAttrsMaintenance.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this MaintenancePostRespAttrsMaintenance.

        Unique id of the new maintenance window  # noqa: E501

        :param id: The id of this MaintenancePostRespAttrsMaintenance.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MaintenancePostRespAttrsMaintenance, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MaintenancePostRespAttrsMaintenance):
            return False
