...
class MaintenancePost(object):
    ...
    def __init__(self, description=None, _from=None, to=None, recurrencetype='none', repeatevery=0, effectiveto=None, uptimeids=None, tmsids=None):  # noqa: E501
        """MaintenancePost - a model defined in Swagger"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this MaintenancePost.  # noqa: E501

        Description  # noqa: E501

        :return: The description of this MaintenancePost.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this MaintenancePost.

        Description  # noqa: E501

        :param description: The description of this MaintenancePost.  # noqa: E501
        :type: str
        """
    ...
    def _from(self, _from):
        """Sets the _from of this MaintenancePost.

        Initial maintenance window start. Format UNIX time. (Only future allowed. Use 1 for the current timestamp.)  # noqa: E501

        :param _from: The _from of this MaintenancePost.  # noqa: E501
        :type: int
        """
        if _from is None:
    ...
    @to.setter
    def to(self, to):
        """Sets the to of this MaintenancePost.

        Initial maintenance window end. Format UNIX time. (Only future allowed. Use 1 for the current timestamp.)  # noqa: E501

        :param to: The to of this MaintenancePost.  # noqa: E501
        :type: int
        """
        if to is None:
    ...
    def recurrencetype(self):
        """Gets the recurrencetype of this MaintenancePost.  # noqa: E501

        Type of recurrence.  # noqa: E501

        :return: The recurrencetype of this MaintenancePost.  # noqa: E501
        :rtype: str
        """
    ...
    def recurrencetype(self, recurrencetype):
        """Sets the recurrencetype of this MaintenancePost.

        Type of recurrence.  # noqa: E501

        :param recurrencetype: The recurrencetype of this MaintenancePost.  # noqa: E501
        :type: str
        """
    ...
    def repeatevery(self):
        """Gets the repeatevery of this MaintenancePost.  # noqa: E501

        Repeat every n-th day/week/month  # noqa: E501

        :return: The repeatevery of this MaintenancePost.  # noqa: E501
        :rtype: int
        """
    ...
    def repeatevery(self, repeatevery):
        """Sets the repeatevery of this MaintenancePost.

        Repeat every n-th day/week/month  # noqa: E501

        :param repeatevery: The repeatevery of this MaintenancePost.  # noqa: E501
        :type: int
        """
    ...
    def effectiveto(self, effectiveto):
        """Sets the effectiveto of this MaintenancePost.

        Recurrence end. Format UNIX time. Default: equal to `to`. (Only future allowed. Use 1 for the current timestamp.)  # noqa: E501

        :param effectiveto: The effectiveto of this MaintenancePost.  # noqa: E501
        :type: int
        """
    ...
    @property
    def uptimeids(self):
        """Gets the uptimeids of this MaintenancePost.  # noqa: E501

        Identifiers of uptime checks to assign to the maintenance window - Comma separated Integers  # noqa: E501

        :return: The uptimeids of this MaintenancePost.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def uptimeids(self, uptimeids):
        """Sets the uptimeids of this MaintenancePost.

        Identifiers of uptime checks to assign to the maintenance window - Comma separated Integers  # noqa: E501

        :param uptimeids: The uptimeids of this MaintenancePost.  # noqa: E501
        :type: list[int]
        """
    ...
    def tmsids(self, tmsids):
        """Sets the tmsids of this MaintenancePost.

        Identifiers of transaction checks to assign to the maintenance window - Comma separated Integers  # noqa: E501

        :param tmsids: The tmsids of this MaintenancePost.  # noqa: E501
        :type: list[int]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MaintenancePost, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MaintenancePost):
            return False
