...
class SummaryPerformanceApi(object):
    ...
    def summary_performance_checkid_get(self, checkid, **kwargs):  # noqa: E501
        """For a given interval return a list of subintervals  # noqa: E501

        For a given interval in time, return a list of sub intervals with the given resolution. Useful for generating graphs. A sub interval may be a week, a day or an hour depending on the choosen resolution.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.summary_performance_checkid_get(checkid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SummaryPerformanceCheckid checkid: (required)
        :param SummaryPerformanceFrom _from: Start time of period. Format is UNIX timestamp. Default value is 10 intervals earlier than `to`.
        :param SummaryPerformanceTo to: End time of period. Format is UNIX timestamp. Default value is the current time.
        :param SummaryPerformanceResolution resolution: Interval size
        :param SummaryPerformanceIncludeuptime includeuptime: Include uptime information.
        :param SummaryPerformanceProbes probes: Filter to only use results from a list of probes. Format is a comma separated list of probe identifiers. Can not be used if includeuptime is set to true. Also note that this can cause intervals to be omitted, since there may be no results from the desired probes in them. By deafult results from all probes are returned.
        :param SummaryPerformanceOrder order: Sorting order of sub intervals. Ascending or descending.
        ...
        if kwargs.get('async_req'):
            return self.summary_performance_checkid_get_with_http_info(checkid, **kwargs)  # noqa: E501
        else:
            (data) = self.summary_performance_checkid_get_with_http_info(checkid, **kwargs)  # noqa: E501
            return data

    def summary_performance_checkid_get_with_http_info(self, checkid, **kwargs):  # noqa: E501
        """For a given interval return a list of subintervals  # noqa: E501

        For a given interval in time, return a list of sub intervals with the given resolution. Useful for generating graphs. A sub interval may be a week, a day or an hour depending on the choosen resolution.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.summary_performance_checkid_get_with_http_info(checkid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['checkid', '_from', 'to', 'resolution', 'includeuptime', 'probes', 'order']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method summary_performance_checkid_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('checkid' not in params or
            ...
            raise ValueError("Missing the required parameter `checkid` when calling `summary_performance_checkid_get`")  # noqa: E501
        ...
        if 'includeuptime' in params:
            query_params.append(('includeuptime', params['includeuptime']))  # noqa: E501
        if 'probes' in params:
        ...
        return self.api_client.call_api(
            '/summary.performance/{checkid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='SummaryPerformanceRespAttrs',  # noqa: E501
