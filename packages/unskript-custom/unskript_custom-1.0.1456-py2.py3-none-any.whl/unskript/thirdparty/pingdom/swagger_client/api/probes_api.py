...
class ProbesApi(object):
    ...
    def probes_get(self, **kwargs):  # noqa: E501
        """Returns a list of Pingdom probe servers  # noqa: E501

        Returns a list of all Pingdom probe servers for Uptime and Transaction checks.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.probes_get(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int limit: Limits the number of returned probes to the specified quantity.
        :param int offset: Offset for listing. (Requires limit.)
        :param bool onlyactive: Return only active probes.
        :param bool includedeleted: Include old probes that are no longer in use.
        :return: Probes
        ...
        if kwargs.get('async_req'):
            return self.probes_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.probes_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def probes_get_with_http_info(self, **kwargs):  # noqa: E501
        """Returns a list of Pingdom probe servers  # noqa: E501

        Returns a list of all Pingdom probe servers for Uptime and Transaction checks.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.probes_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['limit', 'offset', 'onlyactive', 'includedeleted']  # noqa: E501
        ...
        if 'onlyactive' in params:
            query_params.append(('onlyactive', params['onlyactive']))  # noqa: E501
        if 'includedeleted' in params:
            query_params.append(('includedeleted', params['includedeleted']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='Probes',  # noqa: E501
