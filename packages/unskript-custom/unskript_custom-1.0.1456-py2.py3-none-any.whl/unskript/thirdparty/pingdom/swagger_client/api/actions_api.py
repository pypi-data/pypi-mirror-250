...
class ActionsApi(object):
    ...
    def actions_get(self, **kwargs):  # noqa: E501
        """Returns a list of actions alerts.  # noqa: E501

        Returns a list of actions (alerts) that have been generated for your account.  # noqa: E501
        ...
        :param ActionsFrom _from: Only include actions generated later than this timestamp. Format is UNIX time.
        :param ActionsTo to: Only include actions generated prior to this timestamp. Format is UNIX time.
        :param ActionsLimit limit: Limits the number of returned results to the specified quantity.
        :param ActionsOffset offset: Offset for listing.
        :param ActionsCheckids checkids: Comma-separated list of check identifiers. Limit results to actions generated from these checks. Default: all checks.
        :param ActionsUserids userids: Comma-separated list of user identifiers. Limit results to actions sent to these users. Default: all users.
        :param ActionsStatus status: Comma-separated list of statuses. Limit results to actions with these statuses. Default: all statuses.
        :param ActionsVia via: Comma-separated list of via mediums. Limit results to actions with these mediums. Default: all mediums.
    ...
    def actions_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['_from', 'to', 'limit', 'offset', 'checkids', 'userids', 'status', 'via']  # noqa: E501
        ...
        if 'checkids' in params:
            query_params.append(('checkids', params['checkids']))  # noqa: E501
        if 'userids' in params:
            query_params.append(('userids', params['userids']))  # noqa: E501
        if 'status' in params:
        ...
        return self.api_client.call_api(
            ...
            response_type='ActionsAlertsEntry',  # noqa: E501
