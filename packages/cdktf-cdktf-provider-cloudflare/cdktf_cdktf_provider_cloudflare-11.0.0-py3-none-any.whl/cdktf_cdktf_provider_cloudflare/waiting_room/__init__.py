...
Refer to the Terraform Registry for docs: [`cloudflare_waiting_room`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.22.0/docs/resources/waiting_room).
'''
import abc
import builtins
import datetime
