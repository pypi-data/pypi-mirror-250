        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from api.core.client import HuggingFaceLLM
                llm = HuggingFaceLLM(
                    model_name="/name/to/model"
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                llm.call_as_openai("This is a prompt.")
        """
        if stream:
...
class ChatHuggingFace(BaseChatModel):
    ...
    prompt_adapter: BaseTemplate = Llama2Template()
    ...
    def _create_openai_chat_stream_completion(
        ...
        **kwargs: Any,
        ...
        Yields:
            Iterator[ChatCompletion]: A stream of completion objects.
        """
        llm_input = self._apply_chat_template(messages)
        params = self._get_parameters(llm_input, stop, **kwargs)
        result = self.llm.inference_fn(self.llm.model, self.llm.tokenizer, params)
...
if __name__ == "__main__":
    ...
    chat_model.call_as_openai([{"role": "user", "content": "你是谁"}])
