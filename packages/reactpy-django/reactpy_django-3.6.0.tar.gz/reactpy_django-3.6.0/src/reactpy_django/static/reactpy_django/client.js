...
function createImportSourceElement(props) {
    ...
    return props.binding.create(type, createAttributes(props.model, props.client), createChildren(props.model, (child) => createImportSourceElement(Object.assign(Object.assign({}, props), { model: child }))));
}
...
function createAttributes(model, client) {
    return Object.fromEntries(Object.entries(Object.assign(Object.assign({}, model.attributes), Object.fromEntries(Object.entries(model.eventHandlers || {}).map(([name, handler]) => createEventHandler(client, name, handler))))).map(normalizeAttribute));
}
...
function UserInputElement({ model }) {
    ...
    // having keys. Warning about this must now be the responsibility of the client
    // providing the models instead of the client rendering them.
    return reactExports.createElement(model.tagName, Object.assign(Object.assign({}, props), { value }), ...createChildren(model, (child) => (React.createElement(Element, { model: child, key: child.key }))));
}
function ScriptElement({ model }) {
    ...
    React.useEffect(() => {
        ...
        const scriptContent = (_a = model === null || model === void 0 ? void 0 : model.children) === null || _a === void 0 ? void 0 : _a.filter((value) => typeof value == "string")[0];
        let scriptElement;
        if (model.attributes) {
