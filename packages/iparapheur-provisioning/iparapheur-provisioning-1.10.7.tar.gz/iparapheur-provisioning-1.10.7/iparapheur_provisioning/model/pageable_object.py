...
class PageableObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["unpaged", "pageNumber", "paged", "pageSize", "offset", "sort", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["unpaged", "pageNumber", "paged", "pageSize", "offset", "sort", ], str]):
