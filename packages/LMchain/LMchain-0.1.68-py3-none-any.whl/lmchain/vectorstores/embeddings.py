...
class GLMEmbedding(Embeddings):
    ...
    # 这里实现了并发embedding获取
    def aembed_documents(self, texts: List[str], thread_num=3, wait_sec=0.51) -> List[List[float]]:
        import threading
...
if __name__ == '__main__':
    ...
    (GLMEmbedding().aembed_documents(texts))
    # for text in texts:
    #     print(text)
    #     embedding_tool.aembed_query(text)
