...
class Init:
    ...
    def menu():
        ...
        selection = int(input("= "))
        if selection not in Selections: #this is the code below and this code can be written by another way like this => "if not any(selection == value for value in Selections):"
    ...
    class NumberGuessingGame:
        ...
        def __init__(self) -> None:
            ...
            #And using another self starting function.
