...
requires = ["pycryptodome==3.16.0","aiohttp==3.8.3","asyncio==3.4.3","tinytag==1.10.1","mutagen==1.47.0","Pillow==9.4.0"]
_long_description = """
...
<p align="center">
    <img src="s6.uupload.ir/files/img_20240112_192419_987_dgdy.jpg" alt="ArseinRubika" width="128">
    <br>
...
``` bash
pip install ArseinRubika==7.0.0
```
...
https://rubika.ir/LibraryArseinRubika
