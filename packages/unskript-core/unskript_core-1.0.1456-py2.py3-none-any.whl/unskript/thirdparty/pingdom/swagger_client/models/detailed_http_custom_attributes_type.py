...
class DetailedHttpCustomAttributesType(object):
    ...
    def __init__(self, httpcustom=None):  # noqa: E501
        """DetailedHttpCustomAttributesType - a model defined in Swagger"""  # noqa: E501
        self._httpcustom = None
        self.discriminator = None
        if httpcustom is not None:
            self.httpcustom = httpcustom

    @property
    def httpcustom(self):
        """Gets the httpcustom of this DetailedHttpCustomAttributesType.  # noqa: E501


        :return: The httpcustom of this DetailedHttpCustomAttributesType.  # noqa: E501
        :rtype: HttpCustomAttributes
        """
        return self._httpcustom

    @httpcustom.setter
    def httpcustom(self, httpcustom):
        """Sets the httpcustom of this DetailedHttpCustomAttributesType.


        :param httpcustom: The httpcustom of this DetailedHttpCustomAttributesType.  # noqa: E501
        :type: HttpCustomAttributes
        """

        self._httpcustom = httpcustom
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DetailedHttpCustomAttributesType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetailedHttpCustomAttributesType):
            return False
