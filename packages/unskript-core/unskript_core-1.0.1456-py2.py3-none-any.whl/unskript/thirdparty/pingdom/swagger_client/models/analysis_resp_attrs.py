...
class AnalysisRespAttrs(object):
    ...
    """
    swagger_types = {
        'analysis': 'list[AnalysisRespAttrsAnalysis]'
    }
    ...
    def __init__(self, analysis=None):  # noqa: E501
        """AnalysisRespAttrs - a model defined in Swagger"""  # noqa: E501
        self._analysis = None
    ...
    @property
    def analysis(self):
        """Gets the analysis of this AnalysisRespAttrs.  # noqa: E501


        :return: The analysis of this AnalysisRespAttrs.  # noqa: E501
        :rtype: list[AnalysisRespAttrsAnalysis]
        """
        return self._analysis

    @analysis.setter
    def analysis(self, analysis):
        """Sets the analysis of this AnalysisRespAttrs.


        :param analysis: The analysis of this AnalysisRespAttrs.  # noqa: E501
        :type: list[AnalysisRespAttrsAnalysis]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AnalysisRespAttrs, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnalysisRespAttrs):
            return False
