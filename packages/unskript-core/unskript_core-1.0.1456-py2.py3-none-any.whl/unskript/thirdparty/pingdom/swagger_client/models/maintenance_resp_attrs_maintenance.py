...
class MaintenanceRespAttrsMaintenance(object):
    ...
    swagger_types = {
        ...
        'repeatevery': 'int',
        'effectiveto': 'int',
        'checks': 'MaintenanceRespAttrsChecks'
    }
    ...
    def __init__(self, id=None, description=None, _from=None, to=None, recurrencetype=None, repeatevery=None, effectiveto=None, checks=None):  # noqa: E501
        """MaintenanceRespAttrsMaintenance - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._description = None
        self.__from = None
        self._to = None
        self._recurrencetype = None
        self._repeatevery = None
        self._effectiveto = None
        self._checks = None
    ...
    @property
    def id(self):
        """Gets the id of this MaintenanceRespAttrsMaintenance.  # noqa: E501

        Maintenance window identifier  # noqa: E501

        :return: The id of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this MaintenanceRespAttrsMaintenance.

        Maintenance window identifier  # noqa: E501

        :param id: The id of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :type: int
        """
    ...
    def description(self):
        """Gets the description of this MaintenanceRespAttrsMaintenance.  # noqa: E501

        Description  # noqa: E501

        :return: The description of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this MaintenanceRespAttrsMaintenance.

        Description  # noqa: E501

        :param description: The description of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :type: str
        """
    ...
    @property
    def _from(self):
        """Gets the _from of this MaintenanceRespAttrsMaintenance.  # noqa: E501

        Initial maintenance window start. Format UNIX time.  # noqa: E501

        :return: The _from of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :rtype: int
        """
        return self.__from
    ...
    def _from(self, _from):
        """Sets the _from of this MaintenanceRespAttrsMaintenance.

        Initial maintenance window start. Format UNIX time.  # noqa: E501

        :param _from: The _from of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :type: int
        """
    ...
    @property
    def to(self):
        """Gets the to of this MaintenanceRespAttrsMaintenance.  # noqa: E501

        Initial maintenance window end. Format UNIX time.  # noqa: E501

        :return: The to of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :rtype: int
        """
        return self._to
    ...
    @to.setter
    def to(self, to):
        """Sets the to of this MaintenanceRespAttrsMaintenance.

        Initial maintenance window end. Format UNIX time.  # noqa: E501

        :param to: The to of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :type: int
        """
    ...
    def recurrencetype(self):
        """Gets the recurrencetype of this MaintenanceRespAttrsMaintenance.  # noqa: E501

        Type of recurrence.  # noqa: E501

        :return: The recurrencetype of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :rtype: str
        """
    ...
    def recurrencetype(self, recurrencetype):
        """Sets the recurrencetype of this MaintenanceRespAttrsMaintenance.

        Type of recurrence.  # noqa: E501

        :param recurrencetype: The recurrencetype of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :type: str
        """
        allowed_values = ["none", "day", "week", "month"]  # noqa: E501
        if recurrencetype not in allowed_values:
            raise ValueError(
                "Invalid value for `recurrencetype` ({0}), must be one of {1}"  # noqa: E501
                .format(recurrencetype, allowed_values)
            )
    ...
    def repeatevery(self):
        """Gets the repeatevery of this MaintenanceRespAttrsMaintenance.  # noqa: E501

        Repeat every n-th day/week/month  # noqa: E501

        :return: The repeatevery of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :rtype: int
        """
        return self._repeatevery

    @repeatevery.setter
    def repeatevery(self, repeatevery):
        """Sets the repeatevery of this MaintenanceRespAttrsMaintenance.

        Repeat every n-th day/week/month  # noqa: E501

        :param repeatevery: The repeatevery of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :type: int
        """

        self._repeatevery = repeatevery

    @property
    def effectiveto(self):
        """Gets the effectiveto of this MaintenanceRespAttrsMaintenance.  # noqa: E501

        Recurrence end. Format UNIX time.  # noqa: E501

        :return: The effectiveto of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :rtype: int
        """
        return self._effectiveto

    @effectiveto.setter
    def effectiveto(self, effectiveto):
        """Sets the effectiveto of this MaintenanceRespAttrsMaintenance.

        Recurrence end. Format UNIX time.  # noqa: E501

        :param effectiveto: The effectiveto of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :type: int
        """

        self._effectiveto = effectiveto

    @property
    def checks(self):
        """Gets the checks of this MaintenanceRespAttrsMaintenance.  # noqa: E501


        :return: The checks of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :rtype: MaintenanceRespAttrsChecks
        """
        return self._checks

    @checks.setter
    def checks(self, checks):
        """Sets the checks of this MaintenanceRespAttrsMaintenance.


        :param checks: The checks of this MaintenanceRespAttrsMaintenance.  # noqa: E501
        :type: MaintenanceRespAttrsChecks
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MaintenanceRespAttrsMaintenance, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MaintenanceRespAttrsMaintenance):
            return False
