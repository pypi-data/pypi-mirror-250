...
class ChecksBody1(object):
    ...
    def __init__(self, paused=None, resolution=None, checkids=None):  # noqa: E501
        """ChecksBody1 - a model defined in Swagger"""  # noqa: E501
        self._paused = None
    ...
    @property
    def paused(self):
        """Gets the paused of this ChecksBody1.  # noqa: E501

        Use value: true to pause the check(s) and value: false to unpause it(them).  # noqa: E501

        :return: The paused of this ChecksBody1.  # noqa: E501
        :rtype: bool
        """
        return self._paused
    ...
    def paused(self, paused):
        """Sets the paused of this ChecksBody1.

        Use value: true to pause the check(s) and value: false to unpause it(them).  # noqa: E501

        :param paused: The paused of this ChecksBody1.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def resolution(self):
        """Gets the resolution of this ChecksBody1.  # noqa: E501


        :return: The resolution of this ChecksBody1.  # noqa: E501
        :rtype: int
        """
    ...
    def resolution(self, resolution):
        """Sets the resolution of this ChecksBody1.


        :param resolution: The resolution of this ChecksBody1.  # noqa: E501
        :type: int
        """
    ...
    @property
    def checkids(self):
        """Gets the checkids of this ChecksBody1.  # noqa: E501

        Comma-separated list of identifiers for checks to be modified. Invalid check identifiers will be ignored. Default: all checks   # noqa: E501

        :return: The checkids of this ChecksBody1.  # noqa: E501
        :rtype: str
        """
    ...
    def checkids(self, checkids):
        """Sets the checkids of this ChecksBody1.

        Comma-separated list of identifiers for checks to be modified. Invalid check identifiers will be ignored. Default: all checks   # noqa: E501

        :param checkids: The checkids of this ChecksBody1.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ChecksBody1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChecksBody1):
            return False
