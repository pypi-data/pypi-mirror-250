...
class MaintenanceIdPut(object):
    ...
    def __init__(self, description=None, _from=None, to=None, recurrencetype=None, repeatevery=0, effectiveto=None, uptimeids=None, tmsids=None):  # noqa: E501
        """MaintenanceIdPut - a model defined in Swagger"""  # noqa: E501
        ...
        if uptimeids is not None:
            self.uptimeids = uptimeids
        if tmsids is not None:
            self.tmsids = tmsids

    @property
    def description(self):
        """Gets the description of this MaintenanceIdPut.  # noqa: E501

        Description  # noqa: E501

        :return: The description of this MaintenanceIdPut.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this MaintenanceIdPut.

        Description  # noqa: E501

        :param description: The description of this MaintenanceIdPut.  # noqa: E501
        :type: str
        """
    ...
    @property
    def _from(self):
        """Gets the _from of this MaintenanceIdPut.  # noqa: E501

        Initial maintenance window start. Format UNIX time. (Only future allowed. Use 1 for the current timestamp.)  # noqa: E501

        :return: The _from of this MaintenanceIdPut.  # noqa: E501
        :rtype: int
        """
        return self.__from
    ...
    def _from(self, _from):
        """Sets the _from of this MaintenanceIdPut.

        Initial maintenance window start. Format UNIX time. (Only future allowed. Use 1 for the current timestamp.)  # noqa: E501

        :param _from: The _from of this MaintenanceIdPut.  # noqa: E501
        :type: int
        """
    ...
    @property
    def to(self):
        """Gets the to of this MaintenanceIdPut.  # noqa: E501

        Initial maintenance window end. Format UNIX time. (Only future allowed. Use 1 for the current timestamp.)  # noqa: E501

        :return: The to of this MaintenanceIdPut.  # noqa: E501
        :rtype: int
        """
        return self._to
    ...
    @to.setter
    def to(self, to):
        """Sets the to of this MaintenanceIdPut.

        Initial maintenance window end. Format UNIX time. (Only future allowed. Use 1 for the current timestamp.)  # noqa: E501

        :param to: The to of this MaintenanceIdPut.  # noqa: E501
        :type: int
        """
    ...
    def recurrencetype(self):
        """Gets the recurrencetype of this MaintenanceIdPut.  # noqa: E501

        Type of recurrence  # noqa: E501

        :return: The recurrencetype of this MaintenanceIdPut.  # noqa: E501
        :rtype: str
        """
    ...
    def recurrencetype(self, recurrencetype):
        """Sets the recurrencetype of this MaintenanceIdPut.

        Type of recurrence  # noqa: E501

        :param recurrencetype: The recurrencetype of this MaintenanceIdPut.  # noqa: E501
        :type: str
        """
    ...
    def repeatevery(self):
        """Gets the repeatevery of this MaintenanceIdPut.  # noqa: E501

        Repeat every n-th day/week/month  # noqa: E501

        :return: The repeatevery of this MaintenanceIdPut.  # noqa: E501
        :rtype: int
        """
    ...
    def repeatevery(self, repeatevery):
        """Sets the repeatevery of this MaintenanceIdPut.

        Repeat every n-th day/week/month  # noqa: E501

        :param repeatevery: The repeatevery of this MaintenanceIdPut.  # noqa: E501
        :type: int
        """
    ...
    def effectiveto(self):
        """Gets the effectiveto of this MaintenanceIdPut.  # noqa: E501

        Recurrence end. Format UNIX time. Default: equal to `to`. (Only future allowed. Use 1 for the current timestamp.)  # noqa: E501

        :return: The effectiveto of this MaintenanceIdPut.  # noqa: E501
        :rtype: int
        """
    ...
    def effectiveto(self, effectiveto):
        """Sets the effectiveto of this MaintenanceIdPut.

        Recurrence end. Format UNIX time. Default: equal to `to`. (Only future allowed. Use 1 for the current timestamp.)  # noqa: E501

        :param effectiveto: The effectiveto of this MaintenanceIdPut.  # noqa: E501
        :type: int
        """
    ...
    @property
    def uptimeids(self):
        """Gets the uptimeids of this MaintenanceIdPut.  # noqa: E501

        Identifiers of uptime checks to assign to the maintenance window - Comma separated Integers  # noqa: E501

        :return: The uptimeids of this MaintenanceIdPut.  # noqa: E501
        :rtype: list[int]
        """
        return self._uptimeids

    @uptimeids.setter
    def uptimeids(self, uptimeids):
        """Sets the uptimeids of this MaintenanceIdPut.

        Identifiers of uptime checks to assign to the maintenance window - Comma separated Integers  # noqa: E501

        :param uptimeids: The uptimeids of this MaintenanceIdPut.  # noqa: E501
        :type: list[int]
        """

        self._uptimeids = uptimeids

    @property
    def tmsids(self):
        """Gets the tmsids of this MaintenanceIdPut.  # noqa: E501

        Identifiers of transaction checks to assign to the maintenance window - Comma separated Integers  # noqa: E501

        :return: The tmsids of this MaintenanceIdPut.  # noqa: E501
        :rtype: list[int]
        """
        return self._tmsids

    @tmsids.setter
    def tmsids(self, tmsids):
        """Sets the tmsids of this MaintenanceIdPut.

        Identifiers of transaction checks to assign to the maintenance window - Comma separated Integers  # noqa: E501

        :param tmsids: The tmsids of this MaintenanceIdPut.  # noqa: E501
        :type: list[int]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MaintenanceIdPut, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MaintenanceIdPut):
            return False
