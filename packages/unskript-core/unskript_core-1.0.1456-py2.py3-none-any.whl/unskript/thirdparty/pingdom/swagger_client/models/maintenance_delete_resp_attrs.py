...
class MaintenanceDeleteRespAttrs(object):
    ...
    def __init__(self, message=None):  # noqa: E501
        """MaintenanceDeleteRespAttrs - a model defined in Swagger"""  # noqa: E501
        self._message = None
    ...
    @property
    def message(self):
        """Gets the message of this MaintenanceDeleteRespAttrs.  # noqa: E501

        Result description  # noqa: E501

        :return: The message of this MaintenanceDeleteRespAttrs.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this MaintenanceDeleteRespAttrs.

        Result description  # noqa: E501

        :param message: The message of this MaintenanceDeleteRespAttrs.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MaintenanceDeleteRespAttrs, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MaintenanceDeleteRespAttrs):
            return False
