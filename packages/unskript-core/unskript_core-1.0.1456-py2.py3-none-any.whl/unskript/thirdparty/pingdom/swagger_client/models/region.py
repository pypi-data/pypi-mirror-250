...
class Region(object):
    ...
    def __init__(self, id=None, description=None, countryid=None, datetimeformatid=None, numberformatid=None, timezoneid=None):  # noqa: E501
        """Region - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._description = None
        self._countryid = None
        self._datetimeformatid = None
        self._numberformatid = None
        ...
        if datetimeformatid is not None:
            self.datetimeformatid = datetimeformatid
        if numberformatid is not None:
    ...
    @property
    def countryid(self):
        """Gets the countryid of this Region.  # noqa: E501

        Corresponding country identifier  # noqa: E501

        :return: The countryid of this Region.  # noqa: E501
        :rtype: int
        """
    ...
    def countryid(self, countryid):
        """Sets the countryid of this Region.

        Corresponding country identifier  # noqa: E501

        :param countryid: The countryid of this Region.  # noqa: E501
        :type: int
        """
    ...
    @property
    def datetimeformatid(self):
        """Gets the datetimeformatid of this Region.  # noqa: E501

        Corresponding datetimeformat identifier  # noqa: E501

        :return: The datetimeformatid of this Region.  # noqa: E501
        :rtype: int
        """
        return self._datetimeformatid

    @datetimeformatid.setter
    def datetimeformatid(self, datetimeformatid):
        """Sets the datetimeformatid of this Region.

        Corresponding datetimeformat identifier  # noqa: E501

        :param datetimeformatid: The datetimeformatid of this Region.  # noqa: E501
        :type: int
        """

        self._datetimeformatid = datetimeformatid

    @property
    def numberformatid(self):
        """Gets the numberformatid of this Region.  # noqa: E501

        Corresponding numberformat identifier  # noqa: E501

        :return: The numberformatid of this Region.  # noqa: E501
        :rtype: int
        """
        return self._numberformatid

    @numberformatid.setter
    def numberformatid(self, numberformatid):
        """Sets the numberformatid of this Region.

        Corresponding numberformat identifier  # noqa: E501

        :param numberformatid: The numberformatid of this Region.  # noqa: E501
        :type: int
        """

        self._numberformatid = numberformatid

    @property
    def timezoneid(self):
        """Gets the timezoneid of this Region.  # noqa: E501

        Corresponding timezon identifier  # noqa: E501

        :return: The timezoneid of this Region.  # noqa: E501
        :rtype: int
        """
    ...
    def timezoneid(self, timezoneid):
        """Sets the timezoneid of this Region.

        Corresponding timezon identifier  # noqa: E501

        :param timezoneid: The timezoneid of this Region.  # noqa: E501
        :type: int
        """
