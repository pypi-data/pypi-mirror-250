...
class SummaryRespAttrsSummary(object):
    ...
    """
    swagger_types = {
        'responsetime': 'SummaryRespAttrsSummaryResponsetime',
        'status': 'SummaryRespAttrsSummaryStatus'
    }
    ...
    def __init__(self, responsetime=None, status=None):  # noqa: E501
        """SummaryRespAttrsSummary - a model defined in Swagger"""  # noqa: E501
    ...
    def responsetime(self):
        """Gets the responsetime of this SummaryRespAttrsSummary.  # noqa: E501


        :return: The responsetime of this SummaryRespAttrsSummary.  # noqa: E501
        :rtype: SummaryRespAttrsSummaryResponsetime
        """
        return self._responsetime

    @responsetime.setter
    def responsetime(self, responsetime):
        """Sets the responsetime of this SummaryRespAttrsSummary.


        :param responsetime: The responsetime of this SummaryRespAttrsSummary.  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this SummaryRespAttrsSummary.  # noqa: E501


        :return: The status of this SummaryRespAttrsSummary.  # noqa: E501
        :rtype: SummaryRespAttrsSummaryStatus
        """
        return self._status

    @status.setter
    def status(self, status):
        """Sets the status of this SummaryRespAttrsSummary.


        :param status: The status of this SummaryRespAttrsSummary.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SummaryRespAttrsSummary, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SummaryRespAttrsSummary):
            return False
