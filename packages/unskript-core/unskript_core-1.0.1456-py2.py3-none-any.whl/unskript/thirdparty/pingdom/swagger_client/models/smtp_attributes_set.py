...
class SmtpAttributesSet(SmtpAttributesBase):
    ...
    def __init__(self, auth=None, *args, **kwargs):  # noqa: E501
        """SmtpAttributesSet - a model defined in Swagger"""  # noqa: E501
        self._auth = None
    ...
    @property
    def auth(self):
        """Gets the auth of this SmtpAttributesSet.  # noqa: E501

        Username and password colon separated for target SMTP authentication  # noqa: E501

        :return: The auth of this SmtpAttributesSet.  # noqa: E501
        :rtype: str
        """
        return self._auth
    ...
    @auth.setter
    def auth(self, auth):
        """Sets the auth of this SmtpAttributesSet.

        Username and password colon separated for target SMTP authentication  # noqa: E501

        :param auth: The auth of this SmtpAttributesSet.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SmtpAttributesSet, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SmtpAttributesSet):
            return False
