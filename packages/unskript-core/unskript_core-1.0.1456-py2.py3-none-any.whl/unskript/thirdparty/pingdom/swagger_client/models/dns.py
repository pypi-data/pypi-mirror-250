...
class DNS(object):
    ...
    def __init__(self, host=None, type=None, probeid=None, probe_filters=None, ipv6=None, responsetime_threshold=30000, expectedip=None, nameserver=None):  # noqa: E501
    ...
    @property
    def host(self):
        """Gets the host of this DNS.  # noqa: E501

        Target host  # noqa: E501

        :return: The host of this DNS.  # noqa: E501
        :rtype: str
        """
        return self._host
    ...
    @host.setter
    def host(self, host):
        """Sets the host of this DNS.

        Target host  # noqa: E501

        :param host: The host of this DNS.  # noqa: E501
        :type: str
        """
        if host is None:
    ...
    @property
    def type(self):
        """Gets the type of this DNS.  # noqa: E501


        :return: The type of this DNS.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this DNS.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def probeid(self):
        """Gets the probeid of this DNS.  # noqa: E501

        Probe identifier  # noqa: E501

        :return: The probeid of this DNS.  # noqa: E501
        :rtype: int
        """
    ...
    def probeid(self, probeid):
        """Sets the probeid of this DNS.

        Probe identifier  # noqa: E501

        :param probeid: The probeid of this DNS.  # noqa: E501
        :type: int
        """
    ...
    def probe_filters(self):
        """Gets the probe_filters of this DNS.  # noqa: E501

        Filters used for probe selections. Comma separated key:value pairs. Currently only region is supported. Possible values are 'EU', 'NA', 'APAC' and 'LATAM'. For example, \"region: NA\".  # noqa: E501

        :return: The probe_filters of this DNS.  # noqa: E501
        :rtype: int
        """
    ...
    def probe_filters(self, probe_filters):
        """Sets the probe_filters of this DNS.

        Filters used for probe selections. Comma separated key:value pairs. Currently only region is supported. Possible values are 'EU', 'NA', 'APAC' and 'LATAM'. For example, \"region: NA\".  # noqa: E501

        :param probe_filters: The probe_filters of this DNS.  # noqa: E501
        :type: int
        """
    ...
    @property
    def ipv6(self):
        """Gets the ipv6 of this DNS.  # noqa: E501

        Use ipv6 instead of ipv4  # noqa: E501

        :return: The ipv6 of this DNS.  # noqa: E501
        :rtype: bool
        """
        return self._ipv6
    ...
    @ipv6.setter
    def ipv6(self, ipv6):
        """Sets the ipv6 of this DNS.

        Use ipv6 instead of ipv4  # noqa: E501

        :param ipv6: The ipv6 of this DNS.  # noqa: E501
        :type: bool
        """
    ...
    def responsetime_threshold(self):
        """Gets the responsetime_threshold of this DNS.  # noqa: E501
        ...
        :return: The responsetime_threshold of this DNS.  # noqa: E501
        :rtype: int
        """
    ...
    def responsetime_threshold(self, responsetime_threshold):
        """Sets the responsetime_threshold of this DNS.

        Triggers a down alert if the response time exceeds threshold specified in ms (Not available for Starter and Free plans.)  # noqa: E501

        :param responsetime_threshold: The responsetime_threshold of this DNS.  # noqa: E501
        :type: int
        """
    ...
    @property
    def expectedip(self):
        """Gets the expectedip of this DNS.  # noqa: E501

        (dns specific) Expected ip  # noqa: E501

        :return: The expectedip of this DNS.  # noqa: E501
        :rtype: str
        """
        return self._expectedip

    @expectedip.setter
    def expectedip(self, expectedip):
        """Sets the expectedip of this DNS.

        (dns specific) Expected ip  # noqa: E501

        :param expectedip: The expectedip of this DNS.  # noqa: E501
        :type: str
        """
        if expectedip is None:
            raise ValueError("Invalid value for `expectedip`, must not be `None`")  # noqa: E501

        self._expectedip = expectedip

    @property
    def nameserver(self):
        """Gets the nameserver of this DNS.  # noqa: E501

        (dns specific) Nameserver  # noqa: E501

        :return: The nameserver of this DNS.  # noqa: E501
        :rtype: str
        """
    ...
    def nameserver(self, nameserver):
        """Sets the nameserver of this DNS.

        (dns specific) Nameserver  # noqa: E501

        :param nameserver: The nameserver of this DNS.  # noqa: E501
        :type: str
        """
