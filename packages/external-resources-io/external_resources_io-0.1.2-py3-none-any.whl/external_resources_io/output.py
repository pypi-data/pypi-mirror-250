...
class OutputAnnotations(BaseModel):
    ...
    provision_provider: str = Field(..., serialization_alias="external-resources/provision-provider") # aws
    provisioner: str = Field(..., serialization_alias="external-resources/provisioner") # ter-int-dev
    provider: str = Field(..., serialization_alias="external-resources/provider") # aws-iam-role
    identifier: str = Field(..., serialization_alias="external-resources/identifier")

    target_cluster: str = Field(..., serialization_alias="external-resources/target-cluster")
    target_namespace: str = Field(..., serialization_alias="external-resources/target-namespace")
    target_secret_name: str = Field(..., serialization_alias="external-resources/target-secret-name")
