...
def compliance_section_by_policy(prismasession, complianceStandard, accountId = None, accountGroup = None, return_json=False):
    ...
    failed_resources = {}
    policies = list_policies(prismasession, complianceStandard)[['policyId', 'name', 'severity']]
    section_req = {}
            ...
            for comp in pol_comp:
                if comp['standardName'] == complianceStandard and comp['sectionId'] == section['name']:
                    ...
                    try:
                        ...
                        try:
                            failed_resources[comp['sectionId']][polname]['failed'] = 0
                            failed_resources[comp['sectionId']][polname]['total'] = section['totalResources']
                            failed_resources[comp['sectionId']][polname]["severity"] = \
                            policies[policies['policyId'] == comp['policyId']]['severity'].item()

                        except:
                            try:
                                failed_resources[comp['sectionId']][polname] = {}
                                failed_resources[comp['sectionId']][polname]['failed'] = 0
                                failed_resources[comp['sectionId']][polname]['total'] = section['totalResources']
                                ...
                                failed_resources[comp['sectionId']] = {}
                                failed_resources[comp['sectionId']][polname] = {}
                                failed_resources[comp['sectionId']][polname]['failed'] = 0
                                failed_resources[comp['sectionId']][polname]['total'] = section['totalResources']

                                failed_resources[comp['sectionId']][polname]["severity"] = policies[policies['policyId'] == comp['policyId']]['severity'].item()
