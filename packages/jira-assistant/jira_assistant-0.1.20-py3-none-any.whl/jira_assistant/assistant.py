        ...
        for required_field in required_fields:
            ...
            if allowed_values:
                ...
                if (
                    ...
                    print(
                        f"""{excel_column_name} has not allowed value: {current_value}.
                    ...
                    break
            if required_field["isArray"]:
                new_story_fields[excel_column["jira_field_mapping"]["path"]] = [
                    story[excel_column_name]
                ]
            else:
