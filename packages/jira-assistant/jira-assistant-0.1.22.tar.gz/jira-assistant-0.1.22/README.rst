...
.. |ProjectLogo| image:: https://raw.githubusercontent.com/SharryXu/jira-assistant/main/logo.png
    :target: https://github.com/SharryXu/jira-assistant
    :alt: Jira Assistant

|PyPI| |SupportedVersions| |Download| |Package Size| |CodeFactor| |GithubIssues| |Linux| |Windows| |Mac OS| |Pylint| |CodeQL| |Documentation| |Codecov| |CodeClimate| |License|
...
.. |GitHubIssues| image:: https://img.shields.io/github/issues/sharryxu/jira-assistant
   :target: https://github.com/SharryXu/jira-assistant/issues
   :alt: GitHub issues
