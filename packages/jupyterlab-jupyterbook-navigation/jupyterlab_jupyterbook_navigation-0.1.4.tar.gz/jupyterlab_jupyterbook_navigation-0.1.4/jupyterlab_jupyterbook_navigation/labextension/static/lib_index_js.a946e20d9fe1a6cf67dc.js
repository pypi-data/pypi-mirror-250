...
function combinePaths(fullPath, relativePath) {
        ...
        button.addEventListener("click", (event) => {
            ...
            if (typeof filePath === "string") {
                ...
                if (filePath.includes(".md")) {
                    docManager.openOrReveal(relativePath + "/" + filePath, "Markdown Preview");
                }
                else {
...
//# sourceMappingURL=lib_index_js.a946e20d9fe1a6cf67dc.js.map