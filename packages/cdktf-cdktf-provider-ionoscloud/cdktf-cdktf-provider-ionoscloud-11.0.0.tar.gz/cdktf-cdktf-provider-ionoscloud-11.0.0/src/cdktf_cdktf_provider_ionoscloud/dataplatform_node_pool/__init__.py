...
Refer to the Terraform Registry for docs: [`ionoscloud_dataplatform_node_pool`](https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.4.12/docs/resources/dataplatform_node_pool).
'''
import abc
import builtins
import datetime
