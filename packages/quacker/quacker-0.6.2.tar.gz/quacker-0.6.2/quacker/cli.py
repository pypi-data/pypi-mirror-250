...
def main():
    ...
    if args.command == 'sync':
        ...
        # Define directory where the duckdb database files will be stored
        duckdb_folder = 'data_duckdb'
        ...
        print(f"warehouse_connection_details: {warehouse_connection_details}") # TODO remove

        # Create instances of connectors to avoid doing this over and over again during the table loop below
        duckdb_connector = DuckDBConnector.ClassDuckDBConnector(duckdb_folder)
        ...
        list_table_identifiers_with_sample_queries = query_generator.generate_queries()
