...
def cobra(host,delay=0):
    ...
    mal_python = ["__import__('time').sleep(60)", "__import__('os').system('sleep 60')",eval("__import__('time').sleep(15)"),eval("__import__('os').system('sleep 60')"),exec("__import__('time').sleep(15)"),exec("__import__('os').system('sleep 60')")]
